 ...
 */const D=function(e){let t=T(e);return C.encodeByteArray(t,!0)},A=function(e){// Use base64url encoding and remove padding in the end (dot characters).
return D(e).replace(/\./g,"")},N=function(e){try{return C.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null},k=()=>/**
 * @license
...
return}let t=e&&N(e[1]);return t&&JSON.parse(t)},x=()=>{try{return k()||L()||R()}catch(e){/**
         ...
         */console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},O=e=>{var t,i;return null===(i=null===(t=x())||void 0===t?void 0:t.emulatorHosts)||void 0===i?void 0:i[e]},P=e=>{let t=O(e);if(!t)return;let i=t.lastIndexOf(":");// Finding the last since IPv6 addr also has colons.
 ...
 * provider.
 */function(e){let t=e.getComponent();return(null==t?void 0:t.type)==="VERSION"/* ComponentType.VERSION */}(e))return null;{let t=e.getImmediate();return`${t.library}/${t.version}`}}).filter(e=>e).join(" ")}}const em="@firebase/app",ep="0.9.18",eg=new Z("@firebase/app"),ey="[DEFAULT]",ev={[em]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},ew=new Map,eb=new Map;/**
 *
...
n=n.slice(1)}return{heartbeatsToSend:i,unsentEntries:n}}(this._heartbeatsCache.heartbeats),n=A(JSON.stringify({version:2,heartbeats:t}));return(// Store last sent date to prevent another being logged/sent for the same day.
...
return A(JSON.stringify({version:2,heartbeats:e})).length}eE(new z("platform-logger",e=>new ef(e),"PRIVATE"/* ComponentType.PRIVATE */)),eE(new z("heartbeat",e=>new eR(e),"PRIVATE"/* ComponentType.PRIVATE */)),// Register `app` package.
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rc=new Z("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const rv={// Causes are copied from:
...
e.enqueueRetryable(()=>t(ru.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class rD{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class rA{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){let i=e=>{null!=e.error&&rf("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${e.error.message}`);let i=e.token!==this.R;return this.R=e.token,rf("FirebaseAppCheckTokenProvider",`Received ${i?"new":"existing"} token.`),i?t(e.token):Promise.resolve()};this.o=t=>{e.enqueueRetryable(()=>i(t))};let n=e=>{rf("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=e,this.appCheck.addTokenListener(this.o)};this.A.onInit(e=>n(e)),// a chance to register itself with the component framework.
setTimeout(()=>{if(!this.appCheck){let e=this.A.getImmediate({optional:!0});e?n(e):rf("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){let e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(e=>e?("string"==typeof e.token||ry(),this.R=e.token,new rD(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
t.push(...i.split("/").filter(e=>e.length>0))}return new rP(t)}static emptyPath(){return new rP([])}}const rM=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
 * A dot-separated path for navigating sub-objects within a document.
 * @internal
 */class rF extends rO{construct(e,t,i){return new rF(e,t,i)}/**
 ...
 */function(e){let t="";for(let i=0;i<e.length;++i)t+=String.fromCharCode(e[i]);return t}(e);return new r2(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return btoa(this.binaryString)}toUint8Array(){return function(e){let t=new Uint8Array(e.length);for(let i=0;i<e.length;i++)t[i]=e.charCodeAt(i);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return rk(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}r2.EMPTY_BYTE_STRING=new r2("");const r9=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);/**
 ...
 */class s_{}class sT extends s_{constructor(e,t,i){super(),this.field=e,this.op=t,this.value=i}/**
     ...
     */static create(e,t,i){return e.isKeyField()?"in"/* Operator.IN */===t||"not-in"/* Operator.NOT_IN */===t?this.createKeyFieldInFilter(e,t,i):new sD(e,t,i):"array-contains"/* Operator.ARRAY_CONTAINS */===t?new sL(e,i):"in"/* Operator.IN */===t?new sR(e,i):"not-in"/* Operator.NOT_IN */===t?new sx(e,i):"array-contains-any"/* Operator.ARRAY_CONTAINS_ANY */===t?new sO(e,i):new sT(e,t,i)}static createKeyFieldInFilter(e,t,i){return"in"/* Operator.IN */===t?new sA(e,i):new sN(e,i)}matches(e){let t=e.data.field(this.field);// Types do not have to match in NOT_EQUAL filters.
 ...
 * property.
 */function sM(e,t=null,i=[],n=[],r=null,s=null,a=null){return new sP(e,t,i,n,r,s,a)}function sF(e){if(null===e.he){let t=e.path.canonicalString();null!==e.collectionGroup&&(t+="|cg:"+e.collectionGroup),t+="|f:"+e.filters.map(e=>(function e(t){if(t instanceof sT)// the same description, such as the int 3 and the string "3". So we should
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sX=new rW(rV.comparator),sJ=new rW(rV.comparator);function sZ(...e){let t=sJ;for(let i of e)t=t.insert(i.key,i);return t}function s0(e){let t=sJ;return e.forEach((e,i)=>t=t.insert(e,i.overlayedDocument)),t}function s1(){return new sY(e=>e.toString(),(e,t)=>e.isEqual(t))}const s2=new rW(rV.comparator),s9=new rJ(rV.comparator);function s4(...e){let t=s9;for(let i of e)t=t.add(i);return t}const s6=new rJ(rk);/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const aD=new ro([4294967295,4294967295],0);// Hash a string using md5 hashing algorithm.
function aA(e){let t=(new TextEncoder).encode(e),i=new ra;return i.update(t),new Uint8Array(i.digest())}// Interpret the 16 bytes array as two 64-bit unsigned integers, encoded using
...
return 1===n.compare(aD)&&(n=new ro([n.getBits(0),n.getBits(1)],0)),n.modulo(this.Re).toNumber()}// Return whether the bit on the given index in the bitmap is set to 1.
...
if(0===this.Ae)return!1;let t=aA(e),[i,n]=aN(t);for(let e=0;e<this.hashCount;e++){let t=this.Ve(i,n,e);if(!this.me(t))return!1}return!0}/** Create bloom filter for testing purposes only. */static create(e,t,i){let n=new Uint8Array(Math.ceil(e/8)),r=new ak(n,e%8==0?0:8-e%8,t);return i.forEach(e=>r.insert(e)),r}insert(e){if(0===this.Ae)return;let t=aA(e),[i,n]=aN(t);for(let e=0;e<this.hashCount;e++){let t=this.Ve(i,n,e);this.fe(t)}}fe(e){this.bitmap[Math.floor(e/8)]|=1<<e%8}}class aL extends Error{constructor(){super(...arguments),this.name="BloomFilterError"}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class aO{constructor(/** The new document applies to all of these targets. */e,/** The new document is removed from all of these targets. */t,/** The key of the document for this change. */i,/**
     * The new document or NoDocument if it was deleted. Is null if the
     * document went out of view without the server sending a new document.
     */n){this.ge=e,this.removedTargetIds=t,this.key=i,this.pe=n}}class aP{constructor(e,t){this.targetId=e,this.ye=t}}class aM{constructor(/** What kind of change occurred to the watch target. */e,/** The target IDs that were added/removed/set. */t,/**
...
n.Be(t),this.Ue=this.Ue.insert(t,this.ct(t).delete(e)),i&&(this.$e=this.$e.insert(t,i))}removeTarget(e){this.Ke.delete(e)}/**
     ...
     * specified target.
     */ut(e,t){return this.Qe.getRemoteKeysForTarget(e).has(t)}}function aU(){return new rW(rV.comparator)}function aB(){return new rW(rV.comparator)}const aj={asc:"ASCENDING",desc:"DESCENDING"},aq={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},a$={and:"AND",or:"OR"};/**
...
this.Ir=new rJ(ou.dr),this.Tr=new rJ(ou.Er)}/** Returns true if the reference set contains no references. */isEmpty(){return this.Ir.isEmpty()}/** Adds a reference to the given document key for the given ID. */addReference(e,t){let i=new ou(e,t);this.Ir=this.Ir.add(i),this.Tr=this.Tr.add(i)}/** Add references to the given document keys for the given ID. */Ar(e,t){e.forEach(e=>this.addReference(e,t))}/**
     ...
     * removed.
     */mr(e){let t=new rV(new rP([])),i=new ou(t,e),n=new ou(t,e+1),r=[];return this.Tr.forEachInRange([i,n],e=>{this.Rr(e),r.push(e.key)}),r}gr(){this.Ir.forEach(e=>this.Rr(e))}Rr(e){this.Ir=this.Ir.delete(e),this.Tr=this.Tr.delete(e)}pr(e){let t=new rV(new rP([])),i=new ou(t,e),n=new ou(t,e+1),r=s4();return this.Tr.forEachInRange([i,n],e=>{r=r.add(e.key)}),r}containsKey(e){let t=new ou(e,0),i=this.Ir.firstAfterOrEqual(t);return null!==i&&e.isEqual(i.key)}}class ou{constructor(e,t){this.key=e,this.yr=t}/** Compare by key then by ID */static dr(e,t){return rV.comparator(e.key,t.key)||rk(e.yr,t.yr)}/** Compare by ID then by key */static Er(e,t){return rk(e.yr,t.yr)||rV.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
m.Vo()},0),m}}/** The Platform's 'document' implementation or null if not available. */function oP(){// `document` is not always available, e.g. in ReactNative and WebWorkers.
...
// if unset
let s="NO_CHANGE"===(n=t.targetChange.targetChangeType||"NO_CHANGE")?0/* WatchTargetChangeState.NoChange */:"ADD"===n?1/* WatchTargetChangeState.Added */:"REMOVE"===n?2/* WatchTargetChangeState.Removed */:"CURRENT"===n?3/* WatchTargetChangeState.Current */:"RESET"===n?4/* WatchTargetChangeState.Reset */:ry(),a=t.targetChange.targetIds||[],o=(r=t.targetChange.resumeToken,e.useProto3Json?(void 0===r||"string"==typeof r||ry(),r2.fromBase64String(r||"")):(void 0===r||r instanceof Uint8Array||ry(),r2.fromUint8Array(r||new Uint8Array))),l=t.targetChange.cause,u=l&&function(e){let t=void 0===e.code?rv.UNKNOWN:aS(e.code);return new rw(t,e.message||"")}(l);i=new aM(s,a,o,u||null)}else if("documentChange"in t){t.documentChange;let n=t.documentChange;n.document,n.document.name,n.document.updateTime;let r=aJ(e,n.document.name),s=aQ(n.document.updateTime),a=n.document.createTime?aQ(n.document.createTime):rx.min(),o=new sg({mapValue:{fields:n.document.fields}}),l=sy.newFoundDocument(r,s,a,o),u=n.targetIds||[],h=n.removedTargetIds||[];i=new aO(u,h,l.key,l)}else if("documentDelete"in t){t.documentDelete;let n=t.documentDelete;n.document;let r=aJ(e,n.document),s=n.readTime?aQ(n.readTime):rx.min(),a=sy.newNoDocument(r,s),o=n.removedTargetIds||[];i=new aO([],o,a.key,a)}else if("documentRemove"in t){t.documentRemove;let n=t.documentRemove;n.document;let r=aJ(e,n.document),s=n.removedTargetIds||[];i=new aO([],s,r,null)}else{if(!("filter"in t))return ry();{t.filter;let e=t.filter;e.targetId;let{count:n=0,unchangedNames:r}=e,s=new aC(n,r),a=e.targetId;i=new aP(a,s)}}return i}(this.serializer,e),i=function(e){// We have only reached a consistent snapshot for the entire stream if there
 ...
 */async function lI(e,t){var i,n;let r,s;let a=(e.remoteStore.remoteSyncer.applyRemoteEvent=lA.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=lj.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=lk.bind(null,e),e.fa.c_=lm.bind(null,e.eventManager),e.fa.xa=lp.bind(null,e.eventManager),e),o=a.ga.get(t);if(o)// already exists when EventManager calls us for the first time. This
 ...
 */async function lA(e,t){try{let i=await /**
 ...
 * network.
 */class l${async initialize(e,t){this.localStore||(this.localStore=e.localStore,this.sharedClientState=e.sharedClientState,this.datastore=this.createDatastore(t),this.remoteStore=this.createRemoteStore(t),this.eventManager=this.createEventManager(t),this.syncEngine=this.createSyncEngine(t,/* startAsPrimary=*/!e.synchronizeTabs),this.sharedClientState.onlineStateHandler=e=>lN(this.syncEngine,e,1/* OnlineStateSource.SharedClientState */),this.remoteStore.remoteSyncer.handleCredentialChange=lB.bind(null,this.syncEngine),await li(this.remoteStore,this.syncEngine.isPrimaryClient))}createEventManager(e){return new lc}createDatastore(e){var t,i,n;let r=oM(e.databaseInfo.databaseId),s=(t=e.databaseInfo,new oO(t));return i=e.authCredentials,n=e.appCheckCredentials,new oj(i,n,s,r)}createRemoteStore(e){var t,i,n,r;return t=this.localStore,i=this.datastore,n=e.asyncQueue,r=oA.C()?new oA:new oD,new o$(t,i,n,e=>lN(this.syncEngine,e,0/* OnlineStateSource.RemoteStore */),r)}createSyncEngine(e,t){return function(e,t,i,n,r,s,a){let o=new lT(e,t,i,n,r,s);return a&&(o.Fa=!0),o}(this.localStore,this.remoteStore,this.eventManager,this.sharedClientState,e.initialUser,e.maxConcurrentLimboResolutions,t)}terminate(){return async function(e){rf("RemoteStore","RemoteStore shutting down."),e.F_.add(5/* OfflineCause.Shutdown */),await oK(e),e.x_.shutdown(),// triggering spurious listener events with cached data, etc.
...
1==arguments.length&&(t=rN.V()),lZ("doc","path",t),e instanceof l6){let n=rP.fromString(t,...i);return l0(n),new l3(e,/* converter= */null,new rV(n))}{if(!(e instanceof l3||e instanceof l7))throw new rw(rv.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let n=e._path.child(rP.fromString(t,...i));return l0(n),new l3(e.firestore,e instanceof l7?e.converter:null,new rV(n))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.ou=()=>{let e=oP();e&&rf("AsyncQueue","Visibility state changed to "+e.visibilityState),this.Ho.$o()};let e=oP();e&&"function"==typeof e.addEventListener&&e.addEventListener("visibilitychange",this.ou)}get isShuttingDown(){return this.eu}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ul=/^__.*__$/;/** The result of parsing document data (e.g. for a setData call). */class uu{constructor(e,t,i){this.data=e,this.fieldMask=t,this.fieldTransforms=i}toMutation(e,t){return null!==this.fieldMask?new ag(e,this.data,this.fieldMask,t,this.fieldTransforms):new ap(e,this.data,t,this.fieldTransforms)}}/** The result of parsing "update" data (i.e. for an updateData call). */class uh{constructor(e,t,i){this.data=e,this.fieldMask=t,this.fieldTransforms=i}toMutation(e,t){return new ag(e,this.data,this.fieldMask,t,this.fieldTransforms)}}function uc(e){switch(e){case 0/* UserDataSource.Set */:// fall through
case 2/* UserDataSource.MergeSet */:// fall through
case 1/* UserDataSource.Update */:return!0;case 3/* UserDataSource.Argument */:case 4/* UserDataSource.ArrayArgument */:return!1;default:throw ry()}}/** A "context" object passed around while parsing user data. */class ud{/**
...
void 0===r&&this.du(),this.fieldTransforms=r||[],this.fieldMask=s||[]}get path(){return this.settings.path}get Tu(){return this.settings.Tu}/** Returns a new context with the specified settings overwritten. */Eu(e){return new ud(Object.assign(Object.assign({},this.settings),e),this.databaseId,this.serializer,this.ignoreUndefinedProperties,this.fieldTransforms,this.fieldMask)}Au(e){var t;let i=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.Eu({path:i,Ru:!1});return n.Vu(e),n}mu(e){var t;let i=null===(t=this.path)||void 0===t?void 0:t.child(e),n=this.Eu({path:i,Ru:!1});return n.du(),n}fu(e){// TODO(b/34871131): We don't support array paths right now; so make path
// undefined.
return this.Eu({path:void 0,Ru:!0})}gu(e){return uT(e,this.settings.methodName,this.settings.pu||!1,this.path,this.settings.yu)}/** Returns 'true' if 'fieldPath' was traversed when creating this context. */contains(e){return void 0!==this.fieldMask.find(t=>e.isPrefixOf(t))||void 0!==this.fieldTransforms.find(t=>e.isPrefixOf(t.field))}du(){// TODO(b/34871131): Remove null check once we have proper paths for fields
// within arrays.
if(this.path)for(let e=0;e<this.path.length;e++)this.Vu(this.path.get(e))}Vu(e){if(0===e.length)throw this.gu("Document fields must not be empty");if(uc(this.Tu)&&ul.test(e))throw this.gu('Document fields cannot begin and end with "__"')}}/**
 * Helper for parsing raw user input (provided via the API) into internal model
 * classes.
 */class uf{constructor(e,t,i){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=i||oM(e)}/** Creates a new top-level parse context. */wu(e,t,i,n=!1){return new ud({Tu:e,methodName:t,yu:i,path:rF.emptyPath(),Ru:!1,pu:n},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function um(e){let t=e._freezeSettings(),i=oM(e._databaseId);return new uf(e._databaseId,!!t.ignoreUndefinedProperties,i)}class up extends ua{_toFieldTransform(e){if(2/* UserDataSource.MergeSet */!==e.Tu)throw 1/* UserDataSource.Update */===e.Tu?e.gu(`${this._methodName}() can only appear at the top level of your update data`):e.gu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);// No transform to add for a delete, but we need to add it to our
// fieldMask so it gets deleted.
return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof up}}/**
 ...
 */function ug(e,t){if(uv(// from firestore-exp.
e=$(e)))return uw("Unsupported field value:",t,e),uy(e,t);if(e instanceof ua)// in which case we do not want to include this field in our parsed data
...
if(!uc(t.Tu))throw t.gu(`${e._methodName}() can only be used with update() and set()`);if(!t.path)throw t.gu(`${e._methodName}() is not currently supported inside arrays`);let i=e._toFieldTransform(t);i&&t.fieldTransforms.push(i)}(e,t),null;if(void 0===e&&t.ignoreUndefinedProperties)// don't handle this below. If `ignoreUndefinedProperties` is false,
 ...
 * evaluated.
 */function u_(e,t,i){if(t.search(uE)>=0)throw uT(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,/* hasConverter= */!1,/* path= */void 0,i);try{return new us(...t.split("."))._internalPath}catch(n){throw uT(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,/* hasConverter= */!1,/* path= */void 0,i)}}function uT(e,t,i,n,r){let s=n&&!n.isEmpty(),a=void 0!==r,o=`Function ${t}() called with invalid data`;i&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${n}`),a&&(l+=` in document ${r}`),l+=")"),new rw(rv.INVALID_ARGUMENT,o+e+l)}/** Checks `haystack` if FieldPath `needle` is present. Runs in O(n). */function uI(e,t){return e.some(e=>e.isEqual(t))}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class uC{// Note: This class is stripped down version of the DocumentSnapshot in
...
let e=new uS(this._firestore,this._userDataWriter,this._key,this._document,/* converter= */null);return this._converter.fromFirestore(e)}return this._userDataWriter.convertValue(this._document.data.value)}}/**
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
get(e){if(this._document){let t=this._document.data.field(uD("DocumentSnapshot.get",e));if(null!==t)return this._userDataWriter.convertValue(t)}}}/**
 ...
 */class uN{/** @hideconstructor */constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}/**
 ...
 * access will return 'undefined'. You can use the `exists()` method to
 * explicitly verify a document's existence.
 */class uk extends uC{/** @hideconstructor protected */constructor(e,t,i,n,r,s){super(e,t,i,n,s),this._firestore=e,this._firestoreImpl=e,this.metadata=r}/**
...
// if a converter has been provided.
let t=new uL(this._firestore,this._userDataWriter,this._key,this._document,this.metadata,/* converter= */null);return this._converter.fromFirestore(t,e)}return this._userDataWriter.convertValue(this._document.data.value,e.serverTimestamps)}}/**
     * Retrieves the field specified by `fieldPath`. Returns `undefined` if the
     * document or field doesn't exist.
     *
     ...
     */// We are using `any` here to avoid an explicit cast by our users.
// eslint-disable-next-line @typescript-eslint/no-explicit-any
get(e,t={}){if(this._document){let i=this._document.data.field(uD("DocumentSnapshot.get",e));if(null!==i)return this._userDataWriter.convertValue(i,t.serverTimestamps)}}}/**
 * A `QueryDocumentSnapshot` contains data read from a document in your
 * Firestore database as part of a query. The document is guaranteed to exist
 * and its data can be extracted with `.data()` or `.get(<field>)` to get a
 * specific field.
 ...
 * properties.
 */class uR{/** @hideconstructor */constructor(e,t,i,n){this._firestore=e,this._userDataWriter=t,this._snapshot=n,this.metadata=new uN(n.hasPendingWrites,n.fromCache),this.query=i}/** An array of all the documents in the `QuerySnapshot`. */get docs(){let e=[];return this.forEach(t=>e.push(t)),e}/** The number of documents in the `QuerySnapshot`. */get size(){return this._snapshot.docs.size}/** True if there are no documents in the `QuerySnapshot`. */get empty(){return 0===this.size}/**
     * Enumerates all of the documents in the `QuerySnapshot`.
     *
     * @param callback - A callback to be called with a `QueryDocumentSnapshot` for
     * each document in the snapshot.
     * @param thisArg - The `this` binding for the callback.
     */forEach(e,t){this._snapshot.docs.forEach(i=>{e.call(t,new uL(this._firestore,this._userDataWriter,i.key,i,new uN(this._snapshot.mutatedKeys.has(i.key),this._snapshot.fromCache),this.query.converter))})}/**
     ...
     * snapshot events.
     */docChanges(e={}){let t=!!e.includeMetadataChanges;if(t&&this._snapshot.excludesMetadataChanges)throw new rw(rv.INVALID_ARGUMENT,"To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");return this._cachedChanges&&this._cachedChangesIncludeMetadataChanges===t||(this._cachedChanges=/** Calculates the array of `DocumentChange`s for a given `ViewSnapshot`. */function(e,t){if(e._snapshot.oldDocs.isEmpty()){let t=0;return e._snapshot.docChanges.map(i=>{let n=new uL(e._firestore,e._userDataWriter,i.doc.key,i.doc,new uN(e._snapshot.mutatedKeys.has(i.doc.key),e._snapshot.fromCache),e.query.converter);return i.doc,{type:"added",doc:n,oldIndex:-1,newIndex:t++}})}{// A `DocumentSet` that is updated incrementally as changes are applied to use
// to lookup the index of a document.
let i=e._snapshot.oldDocs;return e._snapshot.docChanges.filter(e=>t||3/* ChangeType.Metadata */!==e.type).map(t=>{let n=new uL(e._firestore,e._userDataWriter,t.doc.key,t.doc,new uN(e._snapshot.mutatedKeys.has(t.doc.key),e._snapshot.fromCache),e.query.converter),r=-1,s=-1;return 0/* ChangeType.Added */!==t.type&&(r=i.indexOf(t.doc.key),i=i.delete(t.doc.key)),1/* ChangeType.Removed */!==t.type&&(s=(i=i.add(t.doc)).indexOf(t.doc.key)),{type:function(e){switch(e){case 0/* ChangeType.Added */:return"added";case 2/* ChangeType.Modified */:case 3/* ChangeType.Metadata */:return"modified";case 1/* ChangeType.Removed */:return"removed";default:return ry()}}(t.type),doc:n,oldIndex:r,newIndex:s}})}}(this,t),this._cachedChangesIncludeMetadataChanges=t),this._cachedChanges}}class ux extends uA{constructor(e){super(),this.firestore=e}convertBytes(e){return new ur(e)}convertReference(e){let t=this.convertDocumentKey(e,this.firestore._databaseId);return new l3(this.firestore,/* converter= */null,t)}}/**
 * Locally writes `mutations` on the async queue.
 * @internal
 */function uO(e,t){return function(e,t){let i=new rb;return e.asyncQueue.enqueueAndForget(async()=>lD(await lW(e).then(e=>e.syncEngine),t,i)),i.promise}(ui(e),t)}new WeakMap,function(e=!0){rh="10.3.1",eE(new z("firestore",(t,{instanceIdentifier:i,options:n})=>{let r=t.getProvider("app").getImmediate(),s=new ut(new rI(t.getProvider("auth-internal")),new rA(t.getProvider("app-check-internal")),function(e,t){if(!Object.prototype.hasOwnProperty.apply(e.options,["projectId"]))throw new rw(rv.INVALID_ARGUMENT,'"projectId" not provided in firebase.initializeApp.');return new st(e.options.projectId,t)}(r,i),r);return n=Object.assign({useFetchStreams:e},n),s._setSettings(n),s},"PUBLIC").setMultipleInstances(!0)),eC(rl,"4.1.3",void 0),eC(rl,"4.1.3","esm2017")}();const uP=eI({apiKey:"AIzaSyAaafzn29XLZBor7sXmsi3PMDsg_cxcakk",authDomain:"ecommerce-c2b5f.firebaseapp.com",projectId:"ecommerce-c2b5f",storageBucket:"ecommerce-c2b5f.appspot.com",messagingSenderId:"267989030227",appId:"1:267989030227:web:28088cbcc5c292d8eebda6"}),uM=function(e,t){let i="object"==typeof e?e:/**
 ...
 *
 * @internal
 */(function(e,t){let i=e.container.getProvider("heartbeat").getImmediate({optional:!0});return i&&i.triggerHeartbeat(),e.container.getProvider(t)})(i,"firestore").getImmediate({identifier:"string"==typeof e?e:"(default)"});if(!n._initialized){let e=P("firestore");e&&/**
...
iss:`https://securetoken.google.com/${i}`,aud:i,iat:n,exp:n+3600,auth_time:n,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},e);return[A(JSON.stringify({alg:"none",type:"JWT"})),A(JSON.stringify(s)),""].join(".")}(n.mockUserToken,null===(r=e._app)||void 0===r?void 0:r.options.projectId);let s=n.mockUserToken.sub||n.mockUserToken.user_id;if(!s)throw new rw(rv.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");i=new ru(s)}e._authCredentials=new rT(new rE(t,i))}}(n,...e)}return n}(uP);console.log(uP),console.log(uM);class uF{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, AdminFirebase is connected!")};get=async e=>{let t=await /**
 ...
 */function(e){e=l9(e,l5);let t=l9(e.firestore,ut),i=ui(t),n=new ux(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function(e){if("L"/* LimitType.Last */===e.limitType&&0===e.explicitOrderBy.length)throw new rw(rv.UNIMPLEMENTED,"limitToLast() queries require specifying at least one orderBy() clause")}(e._query),(function(e,t,i={}){let n=new rb;return e.asyncQueue.enqueueAndForget(async()=>(function(e,t,i,n,r){let s=new lz({next:i=>{// Remove query first before passing event to user to avoid
    ...
    t.enqueueAndForget(()=>lf(e,a)),i.fromCache&&"server"===n.source?r.reject(new rw(rv.UNAVAILABLE,'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')):r.resolve(i)},error:e=>r.reject(e)}),a=new ly(i,s,{includeMetadataChanges:!0,Z_:!0});return ld(e,a)})(await lY(e),e.asyncQueue,t,i,n)),n.promise})(i,e._query).then(i=>new uR(t,n,e,i)))}(function(e,t,...i){if(e=$(e),lZ("collection","path",t),e instanceof l6){let n=rP.fromString(t,...i);return l1(n),new l7(e,/* converter= */null,n)}{if(!(e instanceof l3||e instanceof l7))throw new rw(rv.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let n=e._path.child(rP.fromString(t,...i));return l1(n),new l7(e.firestore,/* converter= */null,n)}}(uM,e)),i=[];// console.log(newCollection);
return t.forEach(e=>{// console.log(`docId: "${doc.id}"`);
let t={};t.docId=e.id;let n=e.data();for(let e in n)t[e]=n[e];i.push(t)}),i};addDocToFirestore=async(e,t)=>{try{let i=l8(uM,e,t.docId);await function(e,t,i){var n;e=l9(e,l3);let r=l9(e.firestore,ut),s=(n=e.converter)?i&&(i.merge||i.mergeFields)?n.toFirestore(t,i):n.toFirestore(t):t;return uO(r,[/** Parse document data from a set() call. */(function(e,t,i,n,r,s={}){let a,o;let l=e.wu(s.merge||s.mergeFields?2/* UserDataSource.MergeSet */:0/* UserDataSource.Set */,t,i,r);uw("Data must be an object, but it was:",l,n);let u=uy(n,l);if(s.merge)a=new r0(l.fieldMask),o=l.fieldTransforms;else if(s.mergeFields){let e=[];for(let n of s.mergeFields){let r=ub(t,n,i);if(!l.contains(r))throw new rw(rv.INVALID_ARGUMENT,`Field '${r}' is specified in your field mask but missing from your input data.`);uI(e,r)||e.push(r)}a=new r0(e),o=l.fieldTransforms.filter(e=>a.covers(e.field))}else a=null,o=l.fieldTransforms;return new uu(new sg(u),a,o)})(um(r),"setDoc",e._key,s,null!==e.converter,i).toMutation(e._key,au.none())])}(i,t),console.log("Item/document succesfully added with docId: ",t.docId)}catch(e){console.error("Error adding document: ",e)}};updateDocInFirestore=async(e,t)=>{try{let i=l8(uM,e,t.docId);await function(e,t,i,...n){e=l9(e,l3);let r=l9(e.firestore,ut),s=um(r);return uO(r,[("string"==typeof// performing validation.
(t=$(t))||t instanceof us?/** Parse update data from a list of field/value arguments. */function(e,t,i,n,r,s){let a=e.wu(1/* UserDataSource.Update */,t,i),o=[ub(t,n,i)],l=[r];if(s.length%2!=0)throw new rw(rv.INVALID_ARGUMENT,`Function ${t}() needs to be called with an even number of arguments that alternate between field names and values.`);for(let e=0;e<s.length;e+=2)o.push(ub(t,s[e])),l.push(s[e+1]);let u=[],h=sg.empty();// We iterate in reverse order to pick the last value for a field if the
// user specified the field multiple times.
for(let e=o.length-1;e>=0;--e)if(!uI(u,o[e])){let t=o[e],i=l[e];// For Compat types, we have to "extract" the underlying types before
// performing validation.
i=$(i);let n=a.mu(t);if(i instanceof up)u.push(t);else{let e=ug(i,n);null!=e&&(u.push(t),h.set(t,e))}}let c=new r0(u);return new uh(h,c,a.fieldTransforms)}(s,"updateDoc",e._key,t,void 0,n):/** Parse update data from an update() call. */function(e,t,i,n){let r=e.wu(1/* UserDataSource.Update */,t,i);uw("Data must be an object, but it was:",r,n);let s=[],a=sg.empty();rG(n,(e,n)=>{let o=u_(t,e,i);// For Compat types, we have to "extract" the underlying types before
// performing validation.
n=$(n);let l=r.mu(o);if(n instanceof up)s.push(o);else{let e=ug(n,l);null!=e&&(s.push(o),a.set(o,e))}});let o=new r0(s);return new uh(a,o,r.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,au.exists(!0))])}(i,t),console.log("Item/document succesfully updated in Firestore, docId: ",t.docId)}catch(e){console.error("Error updating document in Firestore: ",e)}};deleteDocFromFirestore=async(e,t)=>{try{var i;await (i=l8(uM,e,t),uO(l9(i.firestore,ut),[new ab(i._key,au.none())]))}catch(e){console.error("Error deleting document: ",e)}}}// Preliminary Specification for Aviation Parts Marketplace
...
// },
{docId:"EOFDVDSDXC5Z",id:"1001",custId:"c001",userName:"Mattew Yampolski",userAddress:"2023, Cactus Road, Springdale, FL, 33761 USA",userPhone:"+1 898 9289289",userEmail:"matt.y@aerosupplyplus.aero",userActive:!0,userAdmin:!0,transDate:"20230815",transId:"jkjur-tewvn-00001"}],uU=[// {
//     id: "Customer ID",
...
// },
{docId:"44BI5T2JM2Q1",id:"100001",orderCustId:"c001",orderUserId:"1001",orderDatePlaced:"20230828",orderDateReady:"20230828",orderDateCompleted:"20230829",orderPaymentMethod:"card",orderPaymentDeadline:"20230829",orderPaymentDone:"20230828",orderPriceItems:1374982,orderPriceHandling:378,orderPriceTotal:1375360,orderCurrency:"$",transDate:"20230828",transId:"jkjur-tewvn-00011"},{docId:"T1V6FN5IAU41",id:"100002",orderCustId:"c001",orderUserId:"1001",orderDatePlaced:"20230828",orderDateReady:"20230828",orderDateCompleted:"20230829",orderPaymentMethod:"card",orderPaymentDeadline:"20230829",orderPaymentDone:"20230828",orderPriceItems:1374982,orderPriceHandling:378,orderPriceTotal:1375360,orderCurrency:"$",transDate:"20230828",transId:"jkjur-tewvn-00012"},{docId:"CZ193PBP4206",id:"100003",orderCustId:"c001",orderUserId:"1001",orderDatePlaced:"20230828",orderDateReady:"20230828",orderDateCompleted:"20230829",orderPaymentMethod:"card",orderPaymentDeadline:"20230829",orderPaymentDone:"20230828",orderPriceItems:1374982,orderPriceHandling:378,orderPriceTotal:1375360,orderCurrency:"$",transDate:"20230828",transId:"jkjur-tewvn-00013"}],u$=[{docId:"9CGGAEA9Z6Z6",id:"100001",orderId:"100001",itemId:"0032-0001-000",qty:2},{docId:"412KMYERYTGG",id:"100001",orderId:"100001",itemId:"0079-0002-000",qty:5},{docId:"ZYIF4ZAYRZLI",id:"100001",orderId:"100001",itemId:"0079-0002-000",qty:5}],uz="customersData",uK="productItems",uH="usersData",uG="ordersData",uQ="orderItemsData",uW="cartsData",uY="customersDataDb",uX="productItemsDb",uJ="usersDataDb",uZ="ordersDataDb",u0="orderItemsDataDb",u1="cartsDataDb";// TEST Usage of Data objects:
let u2={};const u9=["usersDataDb","customersDataDb","cartsDataDb","ordersDataDb","orderItemsDataDb","productItemsDb"];let u4=[],u6=[],u5=[],u3=[],u7=[],u8=[];// // mini-object format:
...
//     }
// });
const he=new class{constructor(){this.adminView=new u,this.adminModel=new h,this.adminFirebase=new uF}initializeAppMain=async()=>{for(let e of(console.log("HELLO! INIT CARRIED OUT SUCCESFULLY"),this.adminView.checkModuleLinkage(),this.adminModel.checkModuleLinkage(),this.adminFirebase.checkModuleLinkage(),// TEST Usage of Data objects:
console.log("testing import from Firestore to dbInstance:"),u9))u2[e]=await this.adminFirebase.get(e);console.log("dbInstance: ",u2),u4=await this.adminFirebase.get(uJ),u6=await this.adminFirebase.get(uY),u5=await this.adminFirebase.get(u1),u3=await this.adminFirebase.get(uZ),u7=await this.adminFirebase.get(u0),u8=await this.adminFirebase.get(uX),// console.log("usersDataDb: ", usersDataDb);
...
this.displayTables(),this.adminView.renderMenu(uz,uK,uH,uG,uQ,uW),this.attachEventListeners()};displayTables=async()=>{this.adminView.clearContainerLeft(),this.adminView.renderTable(uV,uH),this.adminView.renderTable(u4,uJ),this.adminView.renderTable(uU,uz),this.adminView.renderTable(u6,uY),this.adminView.renderTable(uj,uW),this.adminView.renderTable(u5,u1),this.adminView.renderTable(uq,uG),this.adminView.renderTable(u3,uZ),this.adminView.renderTable(u$,uQ),this.adminView.renderTable(u7,u0),this.adminView.renderTable(uB,uK),this.adminView.renderTable(u8,uX)};// Functions to split elemnt ID (${arrayName}_${object.docId}_${key})
...
getArrayByName(e){return"usersData"===e?uV:"usersDataDb"===e?u4:"customersData"===e?uU:"customersDataDb"===e?u6:"cartsData"===e?uj:"cartsDataDb"===e?u5:"ordersData"===e?uq:"ordersDataDb"===e?u3:"orderItemsData"===e?u$:"orderItemsDataDb"===e?u7:"productItems"===e?uB:"productItemsDb"===e?u8:null}// SUPPORT FUNCTION: GET SISTER ARRAY BY NAME:
getSisterArrayByName(e){return"usersData"===e?u4:"customersData"===e?u6:"cartsData"===e?u5:"ordersData"===e?u3:"orderItemsData"===e?u7:"productItems"===e?u8:null}// SUPPORT FUNCTION: GET SISTER ARRAY BY NAME:
getSisterArrayNameByName(e){return"usersData"===e?"usersDataDb":"customersData"===e?"customersDataDb":"cartsData"===e?"cartsDataDb":"ordersData"===e?"ordersDataDb":"orderItemsData"===e?"orderItemsDataDb":"productItems"===e?"productItemsDb":null}// Add duplicate document (element/object)
cloneDocument(e,t){// FOR TEST- TBS ONLY - REMOVE IN PROD:
// console.log(array[0]);
// console.log(array[1]);
...
n.docId=this.adminModel.generateNewId(12),n)}handleAddBtnClick=e=>{let t=this.getCollectionFromId(e.id),i=this.getDocFromId(e.id);console.log(`Request to clone element in ${t}, docId: ${i}.`);let n=this.getArrayByName(t),r=this.cloneDocument(n,i);// Verify if need to add to Firestore collection
if(console.log("clonedObject: ",r),[uY,uX,uJ,uZ,u0,u1].includes(t))console.log(`trying to include clonedObject: ${r} into Collection ${t}`),// try to add new doc (clonedObject) to Firestore (elementCollection):
this.adminFirebase.addDocToFirestore(t,r);else{// Identify Sister Array Name, Sister Array
let e=this.getSisterArrayByName(t),i=this.getSisterArrayNameByName(t);// try to add new doc (clonedObject) to sister Firestore array/collection:
this.adminFirebase.addDocToFirestore(i,r),// add cloned object/document to local copy of the Firestore array/collection
e.push(r)}// Add cloned object/document to array/collection:
...
a.forEach(e=>{let t=e.querySelector("input");if(t){let e=this.getKeyFromId(t.id),i=t.value;r[e]=i}}),console.log("docToUpdate: ",r),[uY,uX,uJ,uZ,u0,u1].includes(t)&&(console.log(`trying to update element/doc with docId: ${i} in Collection ${t}`),// try to update doc with elementId (docId) in Firestore collection:
this.adminFirebase.updateDocInFirestore(t,r)),this.displayTables()};handleDeleteBtnClick=e=>{let t=this.getCollectionFromId(e.id),i=this.getDocFromId(e.id);console.log(`Request to delete element in ${t}, docId: ${i}.`),[uY,uX,uJ,uZ,u0,u1].includes(t)&&(console.log(`trying to delete element/doc with docId: ${i} from Collection ${t}`),// try to delete doc with elementId (docId) from Firestore collection:
this.adminFirebase.deleteDocFromFirestore(t,i));// Remove element/doc from affected array/collection using .splice() method
let n=this.getArrayByName(t),r=n.findIndex(e=>e.docId===i);-1!==r?(n.splice(r,1),console.log("Deleted element/document with docId = ",i)):console.log("Not found element/document with docId = ",i),this.displayTables()};handleButtonsClick=e=>{let t=e.target;t.classList.contains("add-btn")&&this.handleAddBtnClick(t),t.classList.contains("updt-btn")&&this.handleUpdateBtnClick(t),t.classList.contains("del-btn")&&this.handleDeleteBtnClick(t)};fetchBackupData=async()=>{try{let e=await fetch("./js/backup.json");if(// Log response object
console.log("Fetch response: ",e),!e.ok)throw Error(`HTTP error! Status: ${e.status}`);let t=await e.json();return t}catch(e){console.error("Error fetching data: ",e)}};attachEventListeners(){this.adminView.containerLeftNode.addEventListener("click",this.handleButtonsClick),this.adminView.testBtnNode.addEventListener("click",async()=>{console.log("call backupData function"),// // FUNCTIONS: SUPPORT AND TBS
function(e){// convert array to JSON format
let t=JSON.stringify(e,null,2),i=new Blob([t],{type:"application/json"}),n=URL.createObjectURL(i),r=Date.now(),s=document.createElement("a");s.href=n,s.download=`backup-${r}.json`,// display backup file name
console.log(`data saved to file 'backup-${r}.json'`),// Trigger the download
document.body.appendChild(s),s.click(),// clean up
window.URL.revokeObjectURL(n),document.body.removeChild(s)}// // Function gets ID and Value of Input element and returns in
(u2);let e=await this.fetchBackupData();console.log("fetchedBackupData: ",e)})}};try{he.initializeAppMain()}catch(e){console.error("An error occured duting app initialization:",e),alert("Something went wrong. Please contact the app admin or try again later.")}//# sourceMappingURL=index.9e505bb2.js.map

//# sourceMappingURL=index.9e505bb2.js.map
