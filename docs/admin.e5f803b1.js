...
setNewOrderDetails=(e,t)=>{let n=Date.now(),r={userId:e.userId,userName:e.userName,userEmail:e.userEmail,userPhone:e.userPhone,custId:e.custId,custLegalName:e.custLegalName,custBillToAddress:e.custBillToAddress,custHandlingFee:e.custHandlingFee,paymentMethod:e.paymentMethod,priceItems:t.items,priceHandling:t.handling,priceTotal:t.total,orderCurrency:"$",orderId:this.generateOrderNumber(8),orderDate:n,paymentDate:n,docId:this.generateUniqueId()};return r}}}),i.register("fkNhc",function(t,n){e(t.exports,"initializeApp",function(){return i("MjY8E").initializeApp}),e(t.exports,"registerVersion",function(){return i("MjY8E").registerVersion}),/**
 * @license
...
//# sourceMappingURL=admin.e5f803b1.js.map
