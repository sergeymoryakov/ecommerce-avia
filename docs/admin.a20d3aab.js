function e(e,t,n,r){Object.defineProperty(e,t,{get:n,set:r,enumerable:!0,configurable:!0})}var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},r={},i=t.parcelRequire5d32;null==i&&((i=function(e){if(e in n)return n[e].exports;if(e in r){var t=r[e];delete r[e];var i={id:e,exports:{}};return n[e]=i,t.call(i.exports,i,i.exports),i.exports}var s=Error("Cannot find module '"+e+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(e,t){r[e]=t},t.parcelRequire5d32=i),i.register("keq33",function(t,n){e(t.exports,"ModelFirebase",function(){return h}),// Import the functions you need from the SDKs you need
// REMOVED FOR TEST & TBS / FOR PROD USE CONST FILE
// import { firebaseConfig } from "./constants";
i("gKkQl");var r=i("ix4Jr");i("ftYLF");var s=i("3PjDZ");i("gzF8M");var o=i("jcWEj");let a=(0,r.initializeApp)({apiKey:"AIzaSyAaafzn29XLZBor7sXmsi3PMDsg_cxcakk",authDomain:"ecommerce-c2b5f.firebaseapp.com",projectId:"ecommerce-c2b5f",storageBucket:"ecommerce-c2b5f.appspot.com",messagingSenderId:"267989030227",appId:"1:267989030227:web:28088cbcc5c292d8eebda6"}),l=(0,s.getFirestore)(a),u=(0,o.getStorage)(a);(0,o.ref)(u),(0,o.ref)(u,"images");class h{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelFirebase is connected!")};get=async e=>{let t=await (0,s.getDocs)((0,s.collection)(l,e)),n=[];// console.log(newCollection);
return t.forEach(e=>{// console.log(`docId: "${doc.id}"`);
let t={};t.docId=e.id;let r=e.data();for(let e in r)t[e]=r[e];n.push(t)}),n};addDocToFirestore=async(e,t)=>{try{let n=(0,s.doc)(l,e,t.docId);await (0,s.setDoc)(n,t),console.log("Item/document succesfully added with docId: ",t.docId)}catch(e){console.error("Error adding document: ",e)}};updateDocInFirestore=async(e,t)=>{try{let n=(0,s.doc)(l,e,t.docId);await (0,s.updateDoc)(n,t),console.log("Item/document succesfully updated in Firestore, docId: ",t.docId)}catch(e){console.error("Error updating document in Firestore: ",e)}};deleteDocFromFirestore=async(e,t)=>{try{await (0,s.deleteDoc)((0,s.doc)(l,e,t))}catch(e){console.error("Error deleting document: ",e)}};getLinkToImage=async e=>new Promise((t,n)=>{let r=(0,o.ref)(u,`images/${e}`);(0,o.getDownloadURL)(r).then(e=>{t(e)}).catch(e=>{n(e)})})}}),i.register("gKkQl",function(t,n){e(t.exports,"initializeApp",function(){return i("ix4Jr").initializeApp}),e(t.exports,"registerVersion",function(){return i("ix4Jr").registerVersion}),/**
 * @license
 ...
 */function eW(e,t=null,n=[],r=[],i=null,s=null,o=null){return new eQ(e,t,n,r,i,s,o)}function eX(e){if(null===e.he){let t=e.path.canonicalString();null!==e.collectionGroup&&(t+="|cg:"+e.collectionGroup),t+="|f:"+e.filters.map(e=>(function e(t){if(t instanceof eM)// the same description, such as the int 3 and the string "3". So we should
    ...
    return t.field.canonicalString()+t.op.toString()+eE(t.value);if(eU(t)&&eV(t))// In the new SDK versions, the developer may use an explicit AND filter.
...
this.Ir=new et(nb.dr),this.Tr=new et(nb.Er)}/** Returns true if the reference set contains no references. */isEmpty(){return this.Ir.isEmpty()}/** Adds a reference to the given document key for the given ID. */addReference(e,t){let n=new nb(e,t);this.Ir=this.Ir.add(n),this.Tr=this.Tr.add(n)}/** Add references to the given document keys for the given ID. */Ar(e,t){e.forEach(e=>this.addReference(e,t))}/**
     ...
     * removed.
     */mr(e){let t=new j(new V([])),n=new nb(t,e),r=new nb(t,e+1),i=[];return this.Tr.forEachInRange([n,r],e=>{this.Rr(e),i.push(e.key)}),i}gr(){this.Ir.forEach(e=>this.Rr(e))}Rr(e){this.Ir=this.Ir.delete(e),this.Tr=this.Tr.delete(e)}pr(e){let t=new j(new V([])),n=new nb(t,e),r=new nb(t,e+1),i=ta();return this.Tr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nb(e,0),n=this.Ir.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nb{constructor(e,t){this.key=e,this.yr=t}/** Compare by key then by ID */static dr(e,t){return j.comparator(e.key,t.key)||L(e.yr,t.yr)}/** Compare by ID then by key */static Er(e,t){return L(e.yr,t.yr)||j.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
let t=r[e];if(void 0!==t)return tU(t)}(t),s=o.message;void 0===n&&(n=E.INTERNAL,s="Unknown error status: "+t+" with message "+o.message),p=!0,g.mo(new b(n,s)),d.close()}else m(nH,`RPC '${e}' stream ${i} received:`,s),g.fo(s)}}),y(a,h.Event.STAT_EVENT,t=>{t.stat===h.Stat.PROXY?m(nH,`RPC '${e}' stream ${i} detected buffering proxy`):t.stat===h.Stat.NOPROXY&&m(nH,`RPC '${e}' stream ${i} detected no buffering proxy`)}),setTimeout(()=>{// Technically we could/should wait for the WebChannel opened event,
...
// the in-memory data
let t=n.rs.get(e.targetId);return(null===t||e.snapshotVersion.compareTo(t.snapshotVersion)>0)&&(n.rs=n.rs.insert(e.targetId,e),n.ss.set(r,e.targetId)),e})),a=o.sharedClientState.addLocalQueryTarget(e.targetId);i=e.targetId,s=await rV(o,t,i,"current"===a,e.resumeToken),o.isPrimaryClient&&n6(o.remoteStore,e)}return s}/**
...
(t=(0,u.getModularInstance)(t))instanceof ib)return t._internalPath;if("string"==typeof t)return iU(e,t);throw iB("Field path arguments must be of type string or ",e,/* hasConverter= */!1,/* path= */void 0,n)}/**
...
n=(0,u.getModularInstance)(n);let r=o.mu(t);if(n instanceof ix)h.push(t);else{let e=iL(n,r);null!=e&&(h.push(t),c.set(t,e))}}let d=new er(h);return new iA(c,d,o.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):/** Parse update data from an update() call. */function(e,t,n,r){let i=e.wu(1/* UserDataSource.Update */,t,n);iM("Data must be an object, but it was:",i,r);let s=[],o=ek.empty();X(r,(e,r)=>{let a=iU(t,e,n);// For Compat types, we have to "extract" the underlying types before
// performing validation.
r=(0,u.getModularInstance)(r);let l=i.mu(a);if(r instanceof ix)s.push(a);else{let e=iL(r,l);null!=e&&(s.push(a),o.set(a,e))}});let a=new er(s);return new iA(o,a,i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tb.exists(!0))])}/**
...
s.getPromise().then(()=>this._requests.delete(s),()=>this._requests.delete(s)),s}}async makeRequestWithTokens(e,t){let[n,r]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,n,r).getPromise()}}let U="@firebase/storage",B="0.11.2",j="storage";/**
 ...
 * bucket.
 */function e(t,n){if(t instanceof V){if(null==t._bucket)throw new f(o.NO_DEFAULT_BUCKET,"No default bucket found. Did you set the '"+d+"' property when initializing the app?");let r=new M(t,t._bucket);return null!=n?e(r,n):r}return(// ref is a Reference
void 0!==n?/**
 ...
 */function(e,{instanceIdentifier:t}){let n=e.getProvider("app").getImmediate(),r=e.getProvider("auth-internal"),i=e.getProvider("app-check-internal");return new V(n,r,i,t,l.SDK_VERSION)},"PUBLIC"/* ComponentType.PUBLIC */).setMultipleInstances(!0)),//RUNTIME_ENV will be replaced during the compilation to "node" for nodejs and an empty string for browser
(0,l.registerVersion)(U,B,""),// BUILD_TARGET will be replaced by values like esm5, esm2017, cjs5, etc during the compilation
(0,l.registerVersion)(U,B,"esm2017")}),i.register("1ggDV",function(t,n){e(t.exports,"dbCollectionNames",function(){return r});let r=["usersData","customersData","cartsData","ordersData","orderItemsData","productItems"]});//# sourceMappingURL=admin.a20d3aab.js.map

//# sourceMappingURL=admin.a20d3aab.js.map
