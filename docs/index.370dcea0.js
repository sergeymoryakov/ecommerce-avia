...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),o[e]=t),t}}),c("4G3qk").register(JSON.parse('{"ceDhw":"index.370dcea0.js","4M8Gf":"icon-add-order.d5dcde0a.png","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","baUMc":"admin.ed3ff856.js"}'));var i={};i=c("260Jh").getBundleURL("ceDhw")+c("4G3qk").resolve("4M8Gf");var d={};d=c("260Jh").getBundleURL("ceDhw")+c("4G3qk").resolve("kSZwU");class l{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
