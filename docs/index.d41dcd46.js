...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),a[e]=t),t}}),o("4G3qk").register(JSON.parse('{"ceDhw":"index.d41dcd46.js","4M8Gf":"icon-add-order.d5dcde0a.png","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","kVJvh":"admin.e5f803b1.js"}'));var d={};d=o("260Jh").getBundleURL("ceDhw")+o("4G3qk").resolve("4M8Gf");var c={};c=o("260Jh").getBundleURL("ceDhw")+o("4G3qk").resolve("kSZwU");class i{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
o.appendChild(c),l.appendChild(s),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(E),l.appendChild(I),l.appendChild(_),y.appendChild(f),y.appendChild(P),i.appendChild(l),i.appendChild(y),a.appendChild(o),a.appendChild(i),w.appendChild(b),w.appendChild(k),r.appendChild(n),r.appendChild(a),r.appendChild(w),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
o.appendChild(d),l.appendChild(s),i.appendChild(l),m.appendChild(u),m.appendChild(p),i.appendChild(m),h.appendChild(C),h.appendChild(g),i.appendChild(h),L.appendChild(E),L.appendChild(I),i.appendChild(L),_.appendChild(y),_.appendChild(f),i.appendChild(_),n&&(b.appendChild(k),b.appendChild(v),b.appendChild(T)),P.appendChild(w),P.appendChild(b),i.appendChild(P),c.appendChild(i),a.appendChild(o),a.appendChild(c),a};// Left Container - Create Cart Page
