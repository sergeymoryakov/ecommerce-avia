...
a.appendChild(d),l.appendChild(s),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(I),l.appendChild(_),l.appendChild(y),E.appendChild(f),E.appendChild(b),c.appendChild(l),c.appendChild(E),o.appendChild(a),o.appendChild(c),P.appendChild(w),P.appendChild(T),r.appendChild(n),r.appendChild(o),r.appendChild(P),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
let y={},E="",f={},b={},P=[],w=[],T={};// Init HTML variables:
const v=document.createElement("div");v.innerHTML="";const k=document.createElement("div");k.innerHTML="";const D=document.createElement("div");D.innerHTML="";// Init cross-ref Map: image - url
