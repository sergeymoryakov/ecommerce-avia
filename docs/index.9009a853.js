function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},a={},o=r.parcelRequire5d32;null==o&&((o=function(e){if(e in n)return n[e].exports;if(e in a){var t=a[e];delete a[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){a[e]=t},r.parcelRequire5d32=o),o.register("d5gZm",function(t,r){e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var n,a,o={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)o[t[r]]=e[t[r]]},a=function(e){var t=o[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),o("d5gZm").register(JSON.parse('{"bjFny":"index.9009a853.js","3XKo6":"icon-add-order.d5dcde0a.png","jyKjU":"icon-cart.dd455062.png","5WNTT":"icon-order.5ea58f4f.png","1riji":"admin.b564ab4a.js"}'));var d={};d=new URL(o("d5gZm").resolve("3XKo6"),import.meta.url).toString();var i={};i=new URL(o("d5gZm").resolve("jyKjU"),import.meta.url).toString();class l{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
s.appendChild(m),l.appendChild(c),l.appendChild(s),a.appendChild(o),a.appendChild(d),a.appendChild(l),r.appendChild(n),r.appendChild(a),r};// Left Container - Render product items
...
const D=new Map,x=new class{constructor(){this.viewProducts=new l(this),this.viewCart=new s(this),this.viewOrders=new m(this),this.viewAdmin=new p,this.viewSuperadmin=new u,this.modelFirebase=new h.ModelFirebase,this.modelProducts=new C,this.modelCart=new g(this),this.modelOrders=new L,this.modelUser=new E,this.bodyNode=document.querySelector("body"),this.containerLeftNode=document.getElementById("containerLeft"),this.containerRightNode=document.getElementById("containerRight"),this.containerPupupNode=document.getElementById("containerPupup"),this.popupContentNode=document.getElementById("popupContent")}initializeAppMain=async()=>{for(let e of(// TEST AND TBS - REMOVE IN PRODUCTION
...
this.renderCartAndOrdersSummary(f,T),this.attachEventListenrs();// TEST-TBS ONLY:
...
this.updateCartPriceVariable(f,O,I.productItems,b.custHandlingFee)};// MIGHT BE A PART OF MODEL:
...
e.appendChild(this.viewOrders.createPaymentMethodContentBlock(w,!0));let t=this.viewOrders.createCheckOutCartWrapper(),r=document.createElement("div");for(let e of(r.classList="checkout-cart-items",f)){let t=this.getProductObjectById(e.itemId);// Third argument ("checkout-cart-item") is a classList to pass to 'div' element
...
renderCheckOutPricePanel=()=>{this.clearContainerRight(),this.containerRightNode.appendChild(this.viewOrders.createOrderSummaryPriceBlock(O,!0))};// Right Container - Render Order Price Panel
...
console.log("Received command to display CART."),this.updateCartPriceVariable(f,O,I.productItems,b.custHandlingFee),this.renderCartSummary(f),this.renderCartSummaryWithPrice(f,O)};// Handle Order Placement
...
let e=JSON.parse(JSON.stringify(this.modelFirebase.setNewOrderDetails(w,O)));// TEST-TBS REMOVE IN PROD
...
this.handleViewOfTotalPrceInCart(O.priceTotal)};// Update product QTY in CART in 2 locations: price and selector
