function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},o={},d=r.parcelRequire5d32;null==d&&((d=function(e){if(e in n)return n[e].exports;if(e in o){var t=o[e];delete o[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var d=Error("Cannot find module '"+e+"'");throw d.code="MODULE_NOT_FOUND",d}).register=function(e,t){o[e]=t},r.parcelRequire5d32=d),d.register("d5gZm",function(t,r){e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return o},function(e){return o=e});var n,o,d={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)d[t[r]]=e[t[r]]},o=function(e){var t=d[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),d("d5gZm").register(JSON.parse('{"bjFny":"index.a8f42754.js","3XKo6":"icon-add-order.d5dcde0a.png","jyKjU":"icon-cart.dd455062.png","5WNTT":"icon-order.5ea58f4f.png","1riji":"admin.4e4aab7f.js"}'));var i={};i=new URL(d("d5gZm").resolve("3XKo6"),import.meta.url).toString();var a={};a=new URL(d("d5gZm").resolve("jyKjU"),import.meta.url).toString();class c{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
checkModuleLinkage=()=>{console.log("HELLO, ViewProducts is connected!")};createProductItemCard=e=>{// Create elements
let r=document.createElement("div");r.classList="product-item",r.id=`product-card_${e.itemId}`;let n=document.createElement("img");n.classList="product-item__img",n.src=this.controller.getUrlByNameLocal(e.itemImg);let o=document.createElement("div");o.classList="product-item__content";let d=document.createElement("h3");d.classList="product-item__content_desc",d.textContent=e.itemName;let i=document.createElement("p");i.classList="product-item__content_part-number",i.textContent=e.itemPN;let c=document.createElement("div");c.classList="product-item__content_price-block";let l=document.createElement("h3");l.classList="product-item__content_price",l.textContent=`$${e.itemPrice}`;let s=document.createElement("button");s.classList="product-item__content_price-btn",s.id=`product-btn_${e.itemId}`;let m=document.createElement("img");return m.classList="product-item__content_price-btn-img",m.src=/*@__PURE__*/t(a),m.alt="Select",// Append elemens to respective parents
s.appendChild(m),c.appendChild(l),c.appendChild(s),o.appendChild(d),o.appendChild(i),o.appendChild(c),r.appendChild(n),r.appendChild(o),r};// Left Container - Render product items
...
d.appendChild(a),l.appendChild(s),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(_),l.appendChild(I),l.appendChild(E),y.appendChild(f),y.appendChild(b),c.appendChild(l),c.appendChild(y),o.appendChild(d),o.appendChild(c),P.appendChild(w),P.appendChild(v),r.appendChild(n),r.appendChild(o),r.appendChild(P),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
let r=this.createCartSummaryTitle(),n=this.createCartProductItemsBlock(e),o=this.createTotalAmountBlock(t),d=this.createProceedToCheckoutBtn();// TEST-TBS - REMOVE FOR PROD
// console.log("cartSummaryBlock: ", cartSummaryBlock);
return r.appendChild(n),r.appendChild(o),r.appendChild(d),r};// Left Container - Create Product Item Card block
...
let n=this.controller.getDocIdFromArrayByItemId(e,t);if(n)this.controller.handleChangeQtyInCart(e,t,1);else{let n={docId:this.controller.handleNewIdGeneration(),itemId:t,qty:1,userId:r};console.log("MODEL: try to add to database.cartsData a [*** newCartElement *** ]: ",n),this.controller.handleAddDocToFirestore("cartsData",n),e.push(n),console.log("an updated [*** sessionIdCart ***]: ",e)}return e}}class L{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class _{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelUser is connected!")};getSessionIdCustomerByCustomerId=(e,t)=>{let r=t.filter(t=>t.custId===e);return r[0]}}var I=d("1ggDV");// Init database instance (dataBase):
let E={},y="",f={},b={},P=[],w=[],v={};// Init HTML variables:
const k=document.createElement("div");k.innerHTML="";const T=document.createElement("div");T.innerHTML="";const B=document.createElement("div");B.innerHTML="";// Init cross-ref Map: image - url
...
updateCartPriceVariable=(e,t,r,n)=>{let o=0,d=0;for(let n of(// TO-DO: CHECK, if it is required here. Delete for now:
...
// this.controller.handleViewOfTotalPrceInCart(sessionIdCartPrice.total);
return d=o*n,t.items=o,t.handling=d,t.total=o+d,console.log("new sessionIdCartPrice: ",t),console.log("for sessionIdCart: ",e),t};// handleChangeQtyInCart = (sessionIdCart, itemId, adder) => {
//     // TEST-TBS REMOVE IN PROD
//     console.log("sessionIdCart: ", sessionIdCart);
//     for (const product of sessionIdCart) {
//         if (product.itemId === itemId) {
