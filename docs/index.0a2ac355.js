!function(){let e,t,n;var i,r,s,a,o,l,h="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};// SET VIEW MODULE:
...
this.testBtnNode=document.getElementById("testBtn"),this.backupBtnNode=document.getElementById("backupBtn"),this.getServerBtnNode=document.getElementById("getServerBtn"),this.getLocalBtnNode=document.getElementById("getLocalBtn")}checkModuleLinkage=()=>{console.log("HELLO, AdminView is connected!")};clearContainerLeft=()=>{this.containerLeftNode.innerHTML=""};clearContainerRight=()=>{this.containerRightNode.innerHTML=""};createHeaderRow=e=>{let t=document.createElement("tr"),n=document.createElement("th");n.classList="db-section__table_cell",t.appendChild(n);let i=document.createElement("th");// create header cells in loop
for(let[n,r]of(i.classList="db-section__table_cell",t.appendChild(i),Object.entries(e))){let e=document.createElement("th");e.classList="db-section__table_cell",e.innerText=`${n}`,t.appendChild(e)}// Add another empty element at the end of the row:
let r=document.createElement("th");return r.classList="db-section__table_cell",t.appendChild(r),t};// NOTE: isBackup - a backupInstancevalidator:
// 0 - dataInstance
// 1 - backupInstance
createDataRow=(e,t,n)=>{// FOR TBS ONLY:
// console.log("doc.id: ", doc.id);
// console.log("doc.docId: ", doc.docId);
let i=document.createElement("tr"),r=document.createElement("td");r.classList="db-section__table_cell";let s=document.createElement("button");s.classList="db-section__table_btn add-btn",s.id=`${n}_${t}_${e.docId}_addBtn`,s.innerText="+",r.appendChild(s),i.appendChild(r);let a=document.createElement("td");a.classList="db-section__table_cell";let o=document.createElement("button");for(let[r,s]of(o.classList="db-section__table_btn updt-btn",o.id=`${n}_${t}_${e.docId}_updtBtn`,o.innerText="u",a.appendChild(o),i.appendChild(a),Object.entries(e))){// Add table cell element, class and ID:
let a=document.createElement("td");a.classList="db-section__table_cell",a.id=`${n}_${t}_${e.docId}_${r}`;let o=document.createElement("input");o.type="text",o.id=`${n}_${t}_${e.docId}_${r}_input`,o.value=`${s}`,a.appendChild(o),i.appendChild(a)}// Add another button element to the end of row:
let l=document.createElement("td");l.classList="db-section__table_cell";let h=document.createElement("button");return h.classList="db-section__table_btn del-btn",h.id=`${n}_${t}_${e.docId}_delBtn`,h.innerText="-",l.appendChild(h),i.appendChild(l),i};createTable=(e,t,n)=>{// Create new Table
let i=document.createElement("table"),r=this.createHeaderRow(e[0]);// create Data Rows and add to Table
for(let s of(i.appendChild(r),e)){let e=this.createDataRow(s,t,n);i.appendChild(e)}return i};renderTable=(e,t,n)=>{let i=document.createElement("div");i.classList="db-section";let r=document.createElement("h2");r.classList="db-section__title",r.id=`${n}_${t}`,r.innerText=t;let s=this.createTable(e,t,n);s.classList="db-section__table",i.appendChild(r),i.appendChild(s),this.containerLeftNode.appendChild(i)};createMenuBtn=e=>{let t=document.createElement("li");t.classList="menu-btn-wrapper";let n=document.createElement("a");return n.classList="menu-btn",n.href=`#${e}`,n.innerText=`${e}`,t.appendChild(n),t};createMenu=e=>{// Init menu wrapper:
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let I=function(e){// TODO(user): Use native implementations if/when available
 ...
 */let D=function(e){let t=I(e);return S.encodeByteArray(t,!0)},k=function(e){// Use base64url encoding and remove padding in the end (dot characters).
 ...
 */let W=[];(eV=e$||(e$={}))[eV.DEBUG=0]="DEBUG",eV[eV.VERBOSE=1]="VERBOSE",eV[eV.INFO=2]="INFO",eV[eV.WARN=3]="WARN",eV[eV.ERROR=4]="ERROR",eV[eV.SILENT=5]="SILENT";let Y={debug:e$.DEBUG,verbose:e$.VERBOSE,info:e$.INFO,warn:e$.WARN,error:e$.ERROR,silent:e$.SILENT},X=e$.INFO,J={[e$.DEBUG]:"log",[e$.VERBOSE]:"log",[e$.INFO]:"info",[e$.WARN]:"warn",[e$.ERROR]:"error"},Z=(e,t,...n)=>{if(t<e.logLevel)return;let i=new Date().toISOString(),r=J[t];if(r)console[r](`[${i}]  ${e.name}:`,...n);else throw Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class ee{/**
...
setLogLevel(e){this._logLevel="string"==typeof e?Y[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}/**
     ...
     */debug(...e){this._userLogHandler&&this._userLogHandler(this,e$.DEBUG,...e),this._logHandler(this,e$.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,e$.VERBOSE,...e),this._logHandler(this,e$.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,e$.INFO,...e),this._logHandler(this,e$.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,e$.WARN,...e),this._logHandler(this,e$.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,e$.ERROR,...e),this._logHandler(this,e$.ERROR,...e)}}let et=(e,t)=>t.some(t=>e instanceof t),en=new WeakMap,ei=new WeakMap,er=new WeakMap,es=new WeakMap,ea=new WeakMap,eo={get(e,t,n){if(e instanceof IDBTransaction){// Special handling for transaction.done.
 ...
 * provider.
 */function(e){let t=e.getComponent();return(null==t?void 0:t.type)==="VERSION"/* ComponentType.VERSION */}(e))return null;{let t=e.getImmediate();return`${t.library}/${t.version}`}}).filter(e=>e).join(" ")}}let em="@firebase/app",eg="0.9.18",ey=new ee("@firebase/app"),ev="[DEFAULT]",ew={[em]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},eE=new Map,eb=new Map;/**
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let rc="10.3.1",rd=new ee("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
...
t.push(...n.split("/").filter(e=>e.length>0))}return new rP(t)}static emptyPath(){return new rP([])}}let rF=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
 ...
 */function(e){let t="";for(let n=0;n<e.length;++n)t+=String.fromCharCode(e[n]);return t}(e);return new r9(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return btoa(this.binaryString)}toUint8Array(){return function(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return rL(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}r9.EMPTY_BYTE_STRING=new r9("");let r4=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let aD=new rl([4294967295,4294967295],0);// Hash a string using md5 hashing algorithm.
...
i.Be(t),this.Ue=this.Ue.insert(t,this.ct(t).delete(e)),n&&(this.$e=this.$e.insert(t,n))}removeTarget(e){this.Ke.delete(e)}/**
     ...
     * specified target.
     */ut(e,t){return this.Qe.getRemoteKeysForTarget(e).has(t)}}function aB(){return new rY(rU.comparator)}function aj(){return new rY(rU.comparator)}let a$={asc:"ASCENDING",desc:"DESCENDING"},aq={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},az={and:"AND",or:"OR"};/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let oO="WebChannelConnection";class oM extends /**
...
iss:`https://securetoken.google.com/${n}`,aud:n,iat:i,exp:i+3600,auth_time:i,sub:r,user_id:r,firebase:{sign_in_provider:"custom",identities:{}}},e);return[k(JSON.stringify({alg:"none",type:"JWT"})),k(JSON.stringify(s)),""].join(".")}(i.mockUserToken,null===(r=e._app)||void 0===r?void 0:r.options.projectId);let s=i.mockUserToken.sub||i.mockUserToken.user_id;if(!s)throw new rE(rw.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");n=new ru(s)}e._authCredentials=new rI(new r_(t,n))}}(i,...e)}return i}(hP);class hV{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, AdminFirebase is connected!")};get=async e=>{let t=await /**
...
// performing validation.
i=z(i);let l=r.mu(o);if(i instanceof hg)s.push(o);else{let e=hy(i,l);null!=e&&(s.push(o),a.set(o,e))}});let o=new r1(s);return new hc(a,o,r.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,au.exists(!0))])}(n,t),console.log("Item/document succesfully updated in Firestore, docId: ",t.docId)}catch(e){console.error("Error updating document in Firestore: ",e)}};deleteDocFromFirestore=async(e,t)=>{try{var n;await (n=he(hF,e,t),hM(l4(n.firestore,hn),[new ab(n._key,au.none())]))}catch(e){console.error("Error deleting document: ",e)}}}let hU="undefined"!=typeof crypto&&crypto.randomUUID&&crypto.randomUUID.bind(crypto);var hB={randomUUID:hU};let hj=new Uint8Array(16),h$=[];for(let e=0;e<256;++e)h$.push((e+256).toString(16).slice(1));var hq=function(e,t,i){if(hB.randomUUID&&!t&&!e)return hB.randomUUID();e=e||{};let r=e.random||(e.rng||function(){// lazy load so that environments that need to polyfill have a chance to do so
if(!n&&!// getRandomValues needs to be invoked in a context where "this" is a Crypto implementation.
(n="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)))throw Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return n(hj)})();// Per 4.4, set bits for version and `clock_seq_hi_and_reserved`
