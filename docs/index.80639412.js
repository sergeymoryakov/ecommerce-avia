...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),n[e]=t),t}}),i("4G3qk").register(JSON.parse('{"ceDhw":"index.80639412.js","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","g125u":"admin.a26f408d.js"}'));// import iconAddOrder from "../../other_assets/icon-add-order.png";
