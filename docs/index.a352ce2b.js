...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),o[e]=t),t}}),i("4G3qk").register(JSON.parse('{"ceDhw":"index.a352ce2b.js","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","5XZ8c":"admin.9b8fb189.js"}'));// import iconAddOrder from "../../other_assets/icon-add-order.png";
var c={};c=i("260Jh").getBundleURL("ceDhw")+i("4G3qk").resolve("kSZwU");class l{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
d.appendChild(u),s.appendChild(a),s.appendChild(d),o.appendChild(i),o.appendChild(l),o.appendChild(s),r.appendChild(n),r.appendChild(o),r};// Left Container - Render product items
...
var s={};s=i("260Jh").getBundleURL("ceDhw")+i("4G3qk").resolve("8HtV0");class a{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ViewCart is connected!")};// Right Container - Create Cart Title
...
createGoToCartButton=()=>{let e=document.createElement("div");e.classList="cart-goto-btn-wrapper";let r=document.createElement("button");r.classList="cart-goto-btn";let n=document.createElement("img");n.src=/*@__PURE__*/t(s),n.alt="Select";let o=document.createElement("span");return o.innerText=" Cart",// Append elemens to respective parents
...
console.log("productImage: ",e);let n=this.controller.getUrlByNameLocal(e);// FOR TEST-TBS
console.log("imageURL: ",n);let o=this.createCartItemButton(n);r.appendChild(o)}t.appendChild(r);// Right Container - Render Go-To-Cart Button
...
let k={},w="",I={},E={},v=document.createElement("div");v.innerHTML="";let O=document.createElement("div");v.innerHTML="";let b=document.createElement("div");v.innerHTML="";// Init cross-ref Map: image - url
let y=new Map,M=new class{constructor(){this.viewProducts=new l(this),this.viewCart=new a(this),this.viewOrders=new d(this),this.viewAdmin=new u,this.viewSuperadmin=new m,this.modelFirebase=new h.ModelFirebase,this.modelProducts=new g,this.modelCart=new p,this.modelOrders=new L,this.modelAdmin=new f,this.containerLeftNode=document.getElementById("containerLeft"),this.containerRightNode=document.getElementById("containerRight")}initializeAppMain=async()=>{for(let e of(// TEST AND TBS - REMOVE IN PRODUCTION
