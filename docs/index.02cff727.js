 ...
 */let D=function(e){let t=T(e);return C.encodeByteArray(t,!0)},A=function(e){// Use base64url encoding and remove padding in the end (dot characters).
...
t.push(...i.split("/").filter(e=>e.length>0))}return new rP(t)}static emptyPath(){return new rP([])}}let rM=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let aD=new ro([4294967295,4294967295],0);// Hash a string using md5 hashing algorithm.
...
(u2);let e=await this.fetchBackupData();console.log("fetchedBackupData: ",e)})}};try{he.initializeAppMain()}catch(e){console.error("An error occured duting app initialization:",e),alert("Something went wrong. Please contact the app admin or try again later.")}}();//# sourceMappingURL=index.02cff727.js.map

//# sourceMappingURL=index.02cff727.js.map
