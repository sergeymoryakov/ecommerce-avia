!function(){function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},a={},d=r.parcelRequire5d32;null==d&&((d=function(e){if(e in n)return n[e].exports;if(e in a){var t=a[e];delete a[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var d=Error("Cannot find module '"+e+"'");throw d.code="MODULE_NOT_FOUND",d}).register=function(e,t){a[e]=t},r.parcelRequire5d32=d),d.register("4G3qk",function(t,r){e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var n,a,d={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)d[t[r]]=e[t[r]]},a=function(e){var t=d[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),d.register("260Jh",function(t,r){e(t.exports,"getBundleURL",function(){return n},function(e){return n=e});var n,a={};n=function(e){var t=a[e];return t||(t=function(){try{throw Error()}catch(t){var e=(""+t.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(e)// Use the 3rd one, which will be a runtime in the original bundle.
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),a[e]=t),t}}),d("4G3qk").register(JSON.parse('{"ceDhw":"index.6807652e.js","4M8Gf":"icon-add-order.d5dcde0a.png","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","kVJvh":"admin.59777211.js"}'));var o={};o=d("260Jh").getBundleURL("ceDhw")+d("4G3qk").resolve("4M8Gf");var i={};i=d("260Jh").getBundleURL("ceDhw")+d("4G3qk").resolve("kSZwU");class c{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
d.appendChild(i),l.appendChild(s),l.appendChild(m),l.appendChild(p),l.appendChild(u),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(E),l.appendChild(I),l.appendChild(y),_.appendChild(f),_.appendChild(P),c.appendChild(l),c.appendChild(_),a.appendChild(d),a.appendChild(c),w.appendChild(O),w.appendChild(b),r.appendChild(n),r.appendChild(a),r.appendChild(w),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
// import iconCart from "../../other_assets/icon-cart.png";
// import iconCc from "../../other_assets/icon-cc.png";
var l={};l=d("260Jh").getBundleURL("ceDhw")+d("4G3qk").resolve("8HtV0");class s{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ViewCart is connected!")};// Right Container - Create Cart Title
...
createUpdateButtonBlock=()=>{let e=document.createElement("div");e.classList="update-btn-wrapper";let t=document.createElement("button");return t.classList="update-btn",t.innerText="Update",e.appendChild(t),e}}class p{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewAdmin is connected!")}}class u{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewSuperadmin is connected!")}}var h=d("9zRuU");class C{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelProducts is connected!")}}class g{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ModelCart is connected!")}}class L{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class E{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelUser is connected!")};getSessionIdCustomerByCustomerId=(e,t)=>{let r=t.filter(t=>t.custId===e);return r[0]}}var I=d("ljOiA");// Init database instance (dataBase):
let y={},_="",f={},P={},w=[],O=[],b={},k={},T=document.createElement("div");T.innerHTML="";let v=document.createElement("div");v.innerHTML="";let B=document.createElement("div");B.innerHTML="";// Init cross-ref Map: image - url
...
O=this.getCartItemsByUserID(_),console.log(`[*** sessionIdCartItems ***] for User ID ${_}: `,O),// 2. Set "sessionIdOrders" by sesstion's userId (sessionIdNumber):
w=this.getOrdersByUserID(_),console.log(`[*** sessionIdOrders ***] for User ID ${_}: `,w),// 3. Set "sessionIdCartDetails":
k=this.getSessionIdCartDetails(),console.log(`[*** sessionIdCartDetails ***] for User ID ${_}: `,k),// ALERT - POPOUP DISCLAMER
...
this.renderCartAndOrdersSummary(O,w),this.attachEventListenrs();// TEST-TBS ONLY:
...
getSessionIdCustomerData=()=>P=this.modelUser.getSessionIdCustomerByCustomerId(f.custId,y.customersData);// Set "sessionIdCartDetails":
...
this.updateCartPriceVariable(O,b,y.productItems,P.custHandlingFee)};// MIGHT BE A PART OF MODEL:
updateCartPriceVariable=(e,t,r,n)=>{let a=0,d=0;for(let n of(// TO-DO: CHECK, if it is required here. Delete for now:
console.log("MODEL - [*** sessionIdCartItems ***]: ",e),console.log("MODEL - [*** sessionIdCartPrice ***]: ",t),console.log("MODEL - [*** dataBase.productItems ***]: ",y.productItems),console.log("MODEL - [*** sessionIdCustome ***]: ",P),e))a+=n.qty*this.getPriceByProductId(r,n.itemId);// TO-DO: CHECK, if it is required here. Delete for now:
...
e.appendChild(this.viewOrders.createPaymentMethodContentBlock(k,!0));let t=this.viewOrders.createCheckOutCartWrapper(),r=document.createElement("div");for(let e of(r.classList="checkout-cart-items",O)){let t=this.getProductObjectById(e.itemId);// Third argument ("checkout-cart-item") is a classList to pass to 'div' element
...
renderCheckOutPricePanel=()=>{this.clearContainerRight(),this.containerRightNode.appendChild(this.viewOrders.createOrderSummaryPriceBlock(b,!0))};// Right Container - Render Order Price Panel
...
this.renderCartAndOrdersSummary(O,w)};// "Add to Cart" button at detailed product card (page)
...
let t=this.getProdIdFromElementId(e.id),r=this.getDocIdFromArrayByItemId(O,t);r?this.handleQtyChangeBtn(e,1):this.addProduct(t,_),this.renderCartAndOrdersSummary(O,w)};// "Go to Cart" button at right panel or checkout panel
handleGotoCartBtn=()=>{// TEST-TBS REMOVE IN PROD
console.log("Received command to display CART."),this.updateCartPriceVariable(O,b,y.productItems,P.custHandlingFee),this.renderCartSummary(O),this.renderCartSummaryWithPrice(O,b)};// Handle Order Placement
...
let e=JSON.parse(JSON.stringify(this.modelFirebase.setNewOrderDetails(k,b)));// TEST-TBS REMOVE IN PROD
...
let t=JSON.parse(JSON.stringify(O)),r=JSON.parse(JSON.stringify(e.orderId));for(let e in // TEST-TBS REMOVE IN PROD
...
for(let e in O){console.log("[*** sessionIdCartItems[cartItem].docId ***] to delete from cartsData: ",O[e].docId);try{this.handleDeleteDocFromFirestore("cartsData",O[e].docId)}catch(e){console.error("Error deleting sessionIdCartItems from Firestore: ",e)}}console.log("UPDATE LOCAL DATABASE VARIABLES HERE");try{await this.getUpdateLocalDataBase()}catch(e){console.error("Error updating local variables: ",e)}this.handleDisplayOrder(r)};// "Proceed to checkout" button at right panel
...
console.log("Function: 'handleQtyChangeBtn()': update QTY of prod ID: ",e.id),console.log("'sessionIdCartItems': ",O),console.log("itemId: ",r);// product/object to update:
let n=JSON.parse(JSON.stringify(O.find(e=>e.itemId===r)));if(!n){console.log("Product/object not found");return}// remove product from array:
let a=O.filter(e=>e.itemId!==r);n.qty+t>0?(this.updateProduct(a,n,t),this.updateCartDOM(r,n)):(this.deleteProduct(a,n),this.handleGotoCartBtn())};addProduct=(e,t)=>{let r={docId:this.handleNewIdGeneration(),itemId:e,qty:1,userId:t};console.log("MODEL: try to add to database.cartsData a [*** newProductToCart *** ]: ",r),this.handleAddDocToFirestore("cartsData",r),O.push(r),console.log("Updated [*** sessionIdCartItems ***]: ",O)};updateProduct=(e,t,r)=>{// Modify product/object
...
O=e};deleteProduct=(e,t)=>{// Delete product from Firestore
this.handleDeleteDocFromFirestore("cartsData",t.docId),// Update global variable
O=e};updateCartDOM=(e,t)=>{//  update/re-render 'qty' in user's cart (DOM)
...
this.handleViewOfTotalPrceInCart(b.priceTotal)};// Update product QTY in CART in 2 locations: price and selector
