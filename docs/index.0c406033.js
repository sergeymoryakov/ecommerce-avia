...
let I={},P="",f={},b={},_=[],T=[],w={},v={},k=document.createElement("div");k.innerHTML="";let O=document.createElement("div");O.innerHTML="";let B=document.createElement("div");B.innerHTML="";// Init cross-ref Map: image - url
...
this.renderCartAndOrdersSummary(T,_),this.attachEventListenrs()};// TO-DO: check where it is used?
...
console.log("Received command to call for Price Variable update"),this.updateCartPriceVariable(T,w,I.productItems,b.custHandlingFee)};// MIGHT BE A PART OF MODEL:
