...
this.containerLeftNode.appendChild(t)}}class i{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewCart is connected!")}}class l{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewOrders is connected!")}}class s{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewAdmin is connected!")}}class r{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewSuperadmin is connected!")}}var a=n("keq33");class d{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelProducts is connected!")}}class m{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelCart is connected!")}}class u{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class g{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelAdmin is connected!")}}var h=n("1ggDV");// Initiate database instance (dataBase):
let L={};const p=new Map,k=new class{constructor(){this.viewProducts=new c(this),this.viewCart=new i,this.viewOrders=new l,this.viewAdmin=new s,this.viewSuperadmin=new r,this.modelFirebase=new a.ModelFirebase,this.modelProducts=new d,this.modelCart=new m,this.modelOrders=new u,this.modelAdmin=new g}initializeAppMain=async()=>{for(let e of(// TEST AND TBS - REMOVE IN PRODUCTION
