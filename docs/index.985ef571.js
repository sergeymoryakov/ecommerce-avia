...
return e2.call(this,e,0)}}}!function(){try{e2="function"==typeof setTimeout?setTimeout:A}catch(e){e2=A}try{e9="function"==typeof clearTimeout?clearTimeout:D}catch(e){e9=D}}();var N=[],L=!1,R=-1;function O(){L&&e4&&(L=!1,e4.length?N=e4.concat(N):R=-1,N.length&&P())}function P(){if(!L){var e=k(O);L=!0;for(var t=N.length;t;){for(e4=N,N=[];++R<t;)e4&&e4[R].run();R=-1,t=N.length}e4=null,L=!1,function(e){if(e9===clearTimeout)return clearTimeout(e);// if clearTimeout wasn't available but was latter defined
...
let s=e[n++],a=e[n++],o=e[n++],l=((7&i)<<18|(63&s)<<12|(63&a)<<6|63&o)-65536;t[r++]=String.fromCharCode(55296+(l>>10)),t[r++]=String.fromCharCode(56320+(1023&l))}else{let s=e[n++],a=e[n++];t[r++]=String.fromCharCode((15&i)<<12|(63&s)<<6|63&a)}}return t.join("")},V={/**
...
this.HAS_NATIVE_SUPPORT&&!t?atob(e):U(this.decodeStringToByteArray(e,t)))},/**
     ...
     */decodeStringToByteArray(e,t){this.init_();let n=t?this.charToByteMapWebSafe_:this.charToByteMap_,r=[];for(let t=0;t<e.length;){let i=n[e.charAt(t++)],s=t<e.length,a=s?n[e.charAt(t)]:0;++t;let o=t<e.length,l=o?n[e.charAt(t)]:64;++t;let c=t<e.length,h=c?n[e.charAt(t)]:64;if(++t,null==i||null==a||null==l||null==h)throw new B;let u=i<<2|a>>4;if(r.push(u),64!==l){let e=a<<4&240|l>>2;if(r.push(e),64!==h){let e=l<<6&192|h;r.push(e)}}}return r},/**
 ...
 */class B extends Error{constructor(){super(...arguments),this.name="DecodeBase64StringError"}}/**
 * URL-safe base64 encoding
 */const $=function(e){let t=F(e);return V.encodeByteArray(t,!0)},j=function(e){// Use base64url encoding and remove padding in the end (dot characters).
return $(e).replace(/\./g,"")},q=function(e){try{return V.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null},H=()=>/**
 * @license
 ...
 * provider.
 */function(e){let t=e.getComponent();return(null==t?void 0:t.type)==="VERSION"/* ComponentType.VERSION */}(e))return null;{let t=e.getImmediate();return`${t.library}/${t.version}`}}).filter(e=>e).join(" ")}}const ek="@firebase/app",eN="0.9.19",eL=new ef("@firebase/app"),eR="[DEFAULT]",eO={[ek]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},eP=new Map,ex=new Map;/**
 *
...
for(let n of(ex.set(t,e),eP.values()))!/**
 ...
 *
 * @public
 */const eB="10.4.0";function e$(e,t={}){let n=e;if("object"!=typeof t){let e=t;t={name:e}}let r=Object.assign({name:eR,automaticDataCollectionEnabled:!1},t),i=r.name;if("string"!=typeof i||!i)throw eU.create("bad-app-name"/* AppError.BAD_APP_NAME */,{appName:String(i)});if(n||(n=X()),!n)throw eU.create("no-options"/* AppError.NO_OPTIONS */);let s=eP.get(i);if(s){// return the existing app if options and config deep equal the ones in the existing app.
if(en(n,s.options)&&en(r,s.config))return s;throw eU.create("duplicate-app"/* AppError.DUPLICATE_APP */,{appName:i})}let a=new el(i);for(let e of ex.values())a.addComponent(e);let o=new eV(n,r,a);return eP.set(i,o),o}/**
...
let i=null!==(r=eO[e])&&void 0!==r?r:e;n&&(i+=`-${n}`);let s=i.match(/\s|\//),a=t.match(/\s|\//);if(s||a){let e=[`Unable to register library "${i}" with version "${t}":`];s&&e.push(`library name "${i}" contains illegal characters (whitespace or "/")`),s&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),eL.warn(e.join(" "));return}eM(new es(`${i}-version`,()=>({library:i,version:t}),"VERSION"/* ComponentType.VERSION */))}const eH="firebase-heartbeat-store";let ez=null;function eK(){return ez||(ez=/**
 * Open a database.
 *
...
function iN(){return ik.logLevel}function iL(e,...t){if(ik.logLevel<=e6.DEBUG){let n=t.map(iP);ik.debug(`Firestore (${iD}): ${e}`,...n)}}function iR(e,...t){if(ik.logLevel<=e6.ERROR){let n=t.map(iP);ik.error(`Firestore (${iD}): ${e}`,...n)}}/**
 * @internal
 */function iO(e,...t){if(ik.logLevel<=e6.WARN){let n=t.map(iP);ik.warn(`Firestore (${iD}): ${e}`,...n)}}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class iV{constructor(e,t){this.user=t,this.type="OAuth",this.headers=new Map,this.headers.set("Authorization",`Bearer ${e}`)}}/**
 * A CredentialsProvider that always yields an empty token.
 * @internal
 */class iB{getToken(){return Promise.resolve(null)}invalidateToken(){}start(e,t){// Fire with initial user.
...
let e=this.i,t=this.forceRefresh;return this.forceRefresh=!1,this.auth?this.auth.getToken(t).then(t=>// outstanding so the response is potentially for a previous user (which
    ...
    this.i!==e?(iL("FirebaseAuthCredentialsProvider","getToken aborted due to token change."),this.getToken()):t?("string"==typeof t.accessToken||ix(),new iV(t.accessToken,this.currentUser)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.auth&&this.auth.removeAuthTokenListener(this.o)}// Auth.getUid() can return null even with a user logged in. It is because
...
let e=this.getFieldsMap(t);this.applyChanges(e,n,r),n={},r=[],t=i.popLast()}e?n[i.lastSegment()]=sR(e):r.push(i.lastSegment())});let i=this.getFieldsMap(t);this.applyChanges(i,n,r)}/**
     ...
     * entries.
     */applyChanges(e,t,n){for(let r of(st(t,(t,n)=>e[t]=n),n))delete e[r]}clone(){return new sP(sR(this.value))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class sB{}class s$ extends sB{constructor(e,t,n){super(),this.field=e,this.op=t,this.value=n}/**
...
t.isKeyField()||e.Pe.push(new sV(t)),e.Pe.push(new sV(i1.keyField(),"asc"/* Direction.ASCENDING */));else{let t=!1;for(let n of e.explicitOrderBy)e.Pe.push(n),n.field.isKeyField()&&(t=!0);if(!t){// The order of the implicit key ordering always matches the last
// explicit order-by
let t=e.explicitOrderBy.length>0?e.explicitOrderBy[e.explicitOrderBy.length-1].dir:"asc"/* Direction.ASCENDING */;e.Pe.push(new sV(i1.keyField(),t))}}}return e.Pe}/**
...
if(null===t)return e.isNoDocument()?new aU(e.key,aA.none()):new aO(e.key,e.data,aA.none());{let n=e.data,r=sP.empty(),i=new sa(i1.comparator);for(let e of t.fields)if(!i.has(e)){let t=n.field(e);// If we are deleting a nested field, we take the immediate parent as
...
null===t&&e.length>1&&(e=e.popLast(),t=n.field(e)),null===t?r.delete(e):r.set(e,t),i=i.add(e)}return new aP(e.key,r,new sl(i.toArray()),aA.none())}}/**
 ...
 */function aL(e,t,n,r){return e instanceof aO?function(e,t,n,r){if(!aD(e.precondition,t))// caused a name collision).
 ...
 */class aB{/**
     ...
     * backend.
     */applyToRemoteDocument(e,t){let n=t.mutationResults;for(let t=0;t<this.mutations.length;t++){let i=this.mutations[t];if(i.key.isEqual(e.key)){var r;r=n[t],i instanceof aO?function(e,t,n){// Unlike setMutationApplyToLocalView, if we're applying a mutation to a
// remote document the server has accepted the mutation so the precondition
// must have held.
let r=e.value.clone(),i=aM(e.fieldTransforms,t,n.transformResults);r.setAll(i),t.convertToFoundDocument(n.version,r).setHasCommittedMutations()}(i,e,r):i instanceof aP?function(e,t,n){if(!aD(e.precondition,t))// matched on the backend. We therefore must not have the expected version
...
this.Ze(t),this.We=this.We.insert(t,2/* BloomFilterApplicationStatus.FalsePositive */===i?"TargetPurposeExistenceFilterMismatchBloom"/* TargetPurpose.ExistenceFilterMismatchBloom */:"TargetPurposeExistenceFilterMismatch"/* TargetPurpose.ExistenceFilterMismatch */))}}}}/**
     ...
     * filter.
     */nt(e){let t,n;let r=e.ye.unchangedNames;if(!r||!r.bits)return null;let{bits:{bitmap:i="",padding:s=0},hashCount:a=0}=r;try{t=sf(i).toUint8Array()}catch(e){if(e instanceof sc)return iO("Decoding the base64 bloom filter in existence filter failed ("+e.message+"); ignoring the bloom filter and falling back to full re-query."),null;throw e}try{// BloomFilter throws error if the inputs are invalid.
n=new aQ(t,s,a)}catch(e){return iO(e instanceof aW?"BloomFilter error: ":"Applying bloom filter failed: ",e),null}return 0===n.Ae?null:n}/**
...
r.has(t.key)&&(void 0===a||a.mutation instanceof aP)?i=i.insert(t.key,t):void 0!==a?(s.set(t.key,a.mutation.getFieldMask()),aL(a.mutation,t,a.mutation.getFieldMask(),iX.now())):// Using EMPTY to indicate there is no overlay for the document.
...
// change.
async function oV(e,t){return await e.persistence.runTransaction("Handle user change","readonly",n=>{// Swap out the mutation queue, grabbing the pending mutation batches
// before and after.
 ...
 */function oB(e){return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Kr.getLastRemoteSnapshotVersion(t))}/**
...
return!1}bo(e,t,n,r,i){let s=oQ(),a=this.Do(e,t);iL("RestConnection",`Sending RPC '${e}' ${s}:`,a,n);let o={"google-cloud-resource-prefix":this.yo,"x-goog-request-params":this.wo};return this.Co(o,r,i),this.vo(e,a,o,n).then(t=>(iL("RestConnection",`Received RPC '${e}' ${s}: `,t),t),t=>{throw iO("RestConnection",`RPC '${e}' ${s} failed with error: `,t,"url: ",a,"request:",n),t})}Fo(e,t,n,r,i,s){// The REST API automatically aggregates all of the streamed results, so we
...
return m(u,iC.EventType.OPEN,()=>{p||iL(oY,`RPC '${e}' stream ${r} transport opened.`)}),m(u,iC.EventType.CLOSE,()=>{p||(p=!0,iL(oY,`RPC '${e}' stream ${r} transport closed`),f.mo())}),m(u,iC.EventType.ERROR,t=>{p||(p=!0,iO(oY,`RPC '${e}' stream ${r} transport errored:`,t),f.mo(new iF(iM.UNAVAILABLE,"The operation could not be completed")))}),m(u,iC.EventType.MESSAGE,t=>{var n;if(!p){let i=t.data[0];i||ix();// TODO(b/35143891): There is a bug in One Platform that caused errors
...
let e={};e.database=ol(this.serializer),this.n_(e)}/** Sends a group of mutations to the Firestore backend to apply. */d_(e){let t={streamToken:this.lastStreamToken,writes:e.map(e=>(function(e,t){var n;let r;if(t instanceof aO)r={update:oh(e,t.key,t.value)};else if(t instanceof aU)r={delete:os(e,t.key)};else if(t instanceof aP)r={update:oh(e,t.key,t.data),updateMask:function(e){let t=[];return e.fields.forEach(e=>t.push(e.canonicalString())),{fieldPaths:t}}(t.fieldMask)};else{if(!(t instanceof aV))return ix();r={verify:os(e,t.key)}}return t.fieldTransforms.length>0&&(r.updateTransforms=t.fieldTransforms.map(e=>(function(e,t){let n=t.transform;if(n instanceof av)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof aw)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof aE)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof ab)return{fieldPath:t.field.canonicalString(),increment:n.Te};throw ix()})(0,e))),t.precondition.isNone||(r.currentDocument=void 0!==(n=t.precondition).updateTime?{updateTime:oe(e,n.updateTime.toTimestamp())}:void 0!==n.exists?{exists:n.exists}:ix()),r})(this.serializer,e))};this.n_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
(n=()=>oB(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{iL("RemoteStore","Retrying IndexedDB access"),await n(),e.F_.delete(1/* OfflineCause.IndexedDbFailed */),await o7(e)})}/**
 ...
 */class lD{constructor(){this.Q_=void 0,this.listeners=[]}}class lk{constructor(){this.queries=new ai(e=>ae(e),s8),this.onlineState="Unknown"/* OnlineState.Unknown */,this.K_=new Set}}async function lN(e,t){let n=t.query,r=!1,i=e.queries.get(n);if(i||(r=!0,i=new lD),r)try{i.Q_=await e.onListen(n)}catch(n){let e=lT(n,`Initialization of query '${at(t.query)}' failed`);return void t.onError(e)}e.queries.set(n,i),i.listeners.push(t),t.U_(e.onlineState),i.Q_&&t.W_(i.Q_)&&lP(e)}async function lL(e,t){let n=t.query,r=!1,i=e.queries.get(n);if(i){let e=i.listeners.indexOf(t);e>=0&&(i.listeners.splice(e,1),r=0===i.listeners.length)}if(r)return e.queries.delete(n),e.onUnlisten(n)}function lR(e,t){let n=!1;for(let r of t){let t=r.query,i=e.queries.get(t);if(i){for(let e of i.listeners)e.W_(r)&&(n=!0);i.Q_=r}}n&&lP(e)}function lO(e,t,n){let r=e.queries.get(t);if(r)for(let e of r.listeners)e.onError(n);// Remove all listeners. NOTE: We don't need to call syncEngine.unlisten()
// after an error.
 ...
 */class lV{constructor(/**
     ...
     * possible results.
     */n){this.query=e,this.targetId=t,this.view=n}}/** Tracks a limbo resolution. */class lB{constructor(e){this.key=e,/**
 ...
 */async function lj(e,t){var n,r;let i,s;let a=(e.remoteStore.remoteSyncer.applyRemoteEvent=lK.bind(null,e),e.remoteStore.remoteSyncer.getRemoteKeysForTarget=l6.bind(null,e),e.remoteStore.remoteSyncer.rejectListen=lQ.bind(null,e),e.fa.c_=lR.bind(null,e.eventManager),e.fa.xa=lO.bind(null,e.eventManager),e),o=a.ga.get(t);if(o)// already exists when EventManager calls us for the first time. This
 ...
 */function(e,t){let n=null;for(let r of e.fieldTransforms){let e=t.data.field(r.field),i=ay(r.transform,e||null);null!=i&&(null===n&&(n=sP.empty()),n.set(r.field,i))}return n||null}(e,n.get(e.key).overlayedDocument);null!=t&&// NOTE: The base state should only be applied if there's some
...
// SharedClientState.
if(e.isPrimaryClient&&0/* OnlineStateSource.RemoteStore */===n||!e.isPrimaryClient&&1/* OnlineStateSource.SharedClientState */===n){let n;let i=[];e.ga.forEach((e,n)=>{let r=n.view.U_(t);r.snapshot&&i.push(r.snapshot)}),(r=e.eventManager).onlineState=t,n=!1,r.queries.forEach((e,r)=>{for(let e of r.listeners)e.U_(t)&&(n=!0)}),n&&lP(r),i.length&&e.fa.c_(i),e.onlineState=t,e.isPrimaryClient&&e.sharedClientState.setOnlineState(t)}}/**
 ...
 */function cP(e,t){if(cM(// from firestore-exp.
...
if(t.settings.Ru&&4/* UserDataSource.ArrayArgument */!==t.Tu)throw t.gu("Nested arrays are not supported");return function(e,t){let n=[],r=0;for(let i of e){let e=cP(i,t.fu(r));null==e&&// Just include nulls in the array for fields being replaced with a
// sentinel.
...
t.path&&t.path.length>0&&t.fieldMask.push(t.path):st(e,(e,r)=>{let i=cP(r,t.Au(e));null!=i&&(n[e]=i)}),{mapValue:{fields:n}}}function cM(e){return!("object"!=typeof e||null===e||e instanceof Array||e instanceof Date||e instanceof iX||e instanceof cI||e instanceof cC||e instanceof cm||e instanceof cT)}function cF(e,t,n){if(!cM(n)||!("object"==typeof n&&null!==n&&(Object.getPrototypeOf(n)===Object.prototype||null===Object.getPrototypeOf(n)))){let r=ch(n);throw"an object"===r?t.gu(e+" a custom object"):t.gu(e+" "+r)}}/**
 * Helper that calls fromDotSeparatedString() but wraps any error thrown.
 */function cU(e,t,n){if(// FieldPath.
(t=ei(t))instanceof cb)return t._internalPath;if("string"==typeof t)return cB(e,t);throw c$("Field path arguments must be of type string or ",e,/* hasConverter= */!1,/* path= */void 0,n)}/**
 ...
 * Security Rules.
 */function(e,t,n,r={}){var i;let s=(e=cu(e,cp))._getSettings(),a=`${t}:${n}`;if("firestore.googleapis.com"!==s.host&&s.host!==a&&iO("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),e._setSettings(Object.assign(Object.assign({},s),{host:a,ssl:!1})),r.mockUserToken){let t,n;if("string"==typeof r.mockUserToken)t=r.mockUserToken,n=iA.MOCK_USER;else{// Let createMockUserToken validate first (catches common mistakes like
// invalid field "uid" and missing field "sub" / "user_id".)
t=J(r.mockUserToken,null===(i=e._app)||void 0===i?void 0:i.options.projectId);let s=r.mockUserToken.sub||r.mockUserToken.user_id;if(!s)throw new iF(iM.INVALID_ARGUMENT,"mockUserToken must contain 'sub' or 'user_id' field!");n=new iA(s)}e._authCredentials=new i$(new iV(t,n))}}(r,...e)}return r}(hS),hD=/**
...
n=ei(n);let r=a.mu(t);if(n instanceof cO)c.push(t);else{let e=cP(n,r);null!=e&&(c.push(t),h.set(t,e))}}let u=new sl(c);return new cD(h,u,a.fieldTransforms)}(s,"updateDoc",e._key,t,void 0,r):/** Parse update data from an update() call. */function(e,t,n,r){let i=e.wu(1/* UserDataSource.Update */,t,n);cF("Data must be an object, but it was:",i,r);let s=[],a=sP.empty();st(r,(e,r)=>{let o=cB(t,e,n);// For Compat types, we have to "extract" the underlying types before
// performing validation.
r=ei(r);let l=i.mu(o);if(r instanceof cO)s.push(o);else{let e=cP(r,l);null!=e&&(s.push(o),a.set(o,e))}});let o=new sl(s);return new cD(a,o,i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,aA.exists(!0))])}(n,t),console.log("Item/document succesfully updated in Firestore, docId: ",t.docId)}catch(e){console.error("Error updating document in Firestore: ",e)}};deleteDocFromFirestore=async(e,t)=>{try{var n;await (n=cy(hA,e,t),cJ(cu(n.firestore,cw),[new aU(n._key,aA.none())]))}catch(e){console.error("Error deleting document: ",e)}};// Support Functions
// Generate unique ID
...
const hX=new Map,hY=new class{constructor(){this.viewProducts=new _(this),this.viewCart=new C(this),this.viewOrders=new b(this),this.viewPopup=new T,this.modelFirebase=new hk,this.modelProducts=new hN,this.modelCart=new hL(this),this.modelOrders=new hR,this.modelUser=new hO,this.bodyNode=document.querySelector("body"),this.containerLeftNode=document.getElementById("containerLeft"),this.containerRightNode=document.getElementById("containerRight"),this.containerPupupNode=document.getElementById("containerPupup"),this.popupContentNode=document.getElementById("popupContent")}initializeAppMain=async()=>{for(let e of(// TEST AND TBS - REMOVE IN PRODUCTION
...
console.log("Action: Create Image Links Map imageLinksMap{}:"),hV.productItems)){let t=await this.modelFirebase.getLinkToImage(e.itemImg).then(e=>e).catch(e=>{console.log("Error getting download URL: ",e)});// FOR TEST AND TBS - REMOVE IN PROD:
...
hB=hV.usersData[0].userId),console.log("[*** sessionIdUser ***] initiated: ",// Assign to sessionIdUser a first object/document from DB (usersData[0])
h$=hV.usersData[0]),console.log("[*** sessionIdCustomer ***] initiated: ",// Assign to sessionIdCustomer an object/document associated with sesstionIdUser (by userId)
...
hH=this.getCartItemsByUserID(hB),console.log(`[*** sessionIdCartItems ***] for User ID ${hB}: `,hH),// 2. Set "sessionIdOrders" by sesstion's userId (sessionIdNumber):
hq=this.getOrdersByUserID(hB),console.log(`[*** sessionIdOrders ***] for User ID ${hB}: `,hq),// 3. Set "sessionIdCartDetails":
hK=this.getSessionIdCartDetails(),console.log(`[*** sessionIdCartDetails ***] for User ID ${hB}: `,hK),// Left Container - Render product items
this.renderProductItemsList(hV.productItems),// Right Container - Render Cart Summary
...
getUpdateLocalDataBase=async()=>{for(let e of(console.log("Get or Update data from Firebase and keep in local dataBase{}."),hP))hV[e]=await this.modelFirebase.get(e),console.log(`[*** dataBase.${e} ***] :`,hV[e])};deleteObjectFromArrayByDocId=(e,t)=>{let n=e.filter(e=>e.docId===t);return -1!==n?(e.splice(n,1),console.log("Deleted element/document with docId = ",t)):console.log("Not found element/document with docId = ",t),e};// Assign to sessionIdCustomer an object/document associated with sesstionIdUser (by userId)
getSessionIdCustomerData=()=>hj=this.modelUser.getSessionIdCustomerByCustomerId(h$.custId,hV.customersData);// Set "sessionIdCartDetails":
...
getCartItemsByUserID=e=>hV.cartsData.filter(t=>t.userId===e);// Set "sessionIdOrders" by sesstion's userId and sorted by orderDate:
getOrdersByUserID=e=>hV.ordersData.filter(t=>t.userId===e).sort((e,t)=>e.orderDate-t.orderDate);// Get "orderDetailsToDisplay" by orderNumber:
getOrderDetailsToDisplay=e=>hV.ordersData.filter(t=>t.orderId===e)[0];// Get "orderItemsToDisplay" by orderNumber:
getOrderItemsToDisplay=e=>hV.orderItemsData.filter(t=>t.orderId===e);getImageByProductId=e=>{let t=hV.productItems.filter(t=>t.itemId===e);return t[0].itemImg};getPriceByProductId=(e,t)=>{let n=e.filter(e=>e.itemId===t);return n[0].itemPrice};getProdIdFromElementId=e=>e.split("_")[1];// Get product/object from "dataBase.productItems" product ID (itemId):
getProductObjectById=e=>{// Filter product array => single object array
let t=hV.productItems.filter(t=>t.itemId===e);return 0===t.length?null:t[0]};getDocIdFromArrayByItemId=(e,t)=>{let n=e.filter(e=>e.itemId===t);return(// TEST-TBS - REMOVE FOR PROD
console.log("[*** filteredArray ***]: ",n),0===n.length)?null:n[0].docId};callToUpdateCartPriceVariable=()=>{// TEST-TBD
console.log("Received command to call for Price Variable update"),this.updateCartPriceVariable(hH,hz,hV.productItems,hj.custHandlingFee)};// MIGHT BE A PART OF MODEL:
...
handleGotoProductsBtn=()=>{this.renderProductItemsList(hV.productItems),// TO-DO: CHECK, if it is required here. Delete for now:
...
let t=this.getProdIdFromElementId(e.id),n=this.getDocIdFromArrayByItemId(hH,t);n?this.handleQtyChangeBtn(e,1):this.addProduct(t,hB),this.renderCartAndOrdersSummary(hH,hq)};// "Go to Cart" button at right panel or checkout panel
handleGotoCartBtn=()=>{// TEST-TBS REMOVE IN PROD
console.log("Received command to display CART."),this.updateCartPriceVariable(hH,hz,hV.productItems,hj.custHandlingFee),this.renderCartSummary(hH),this.renderCartSummaryWithPrice(hH,hz)};// Handle Order Placement
...
console.log("Got comand to ACTIVATE WELCOME DISCLAIMER"),this.popupContentNode.innerHTML="";let e=this.viewPopup.createPopupMessage(hM);this.popupContentNode.appendChild(e),this.togglePopup()};activatePopupMessage=e=>{// Clear Popup Content
