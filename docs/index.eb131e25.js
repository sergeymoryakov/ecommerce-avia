function e(e,t,o,r){Object.defineProperty(e,t,{get:o,set:r,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var o="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},r={},n={},i=o.parcelRequire5d32;null==i&&((i=function(e){if(e in r)return r[e].exports;if(e in n){var t=n[e];delete n[e];var o={id:e,exports:{}};return r[e]=o,t.call(o.exports,o,o.exports),o.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){n[e]=t},o.parcelRequire5d32=i),i.register("d5gZm",function(t,o){e(t.exports,"register",function(){return r},function(e){return r=e}),e(t.exports,"resolve",function(){return n},function(e){return n=e});var r,n,i={};r=function(e){for(var t=Object.keys(e),o=0;o<t.length;o++)i[t[o]]=e[t[o]]},n=function(e){var t=i[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),i("d5gZm").register(JSON.parse('{"bjFny":"index.eb131e25.js","jyKjU":"icon-cart.dd455062.png","5WNTT":"icon-order.5ea58f4f.png","g4wMT":"admin.d5e5d0a5.js"}'));// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
d.appendChild(u),l.appendChild(a),l.appendChild(d),n.appendChild(i),n.appendChild(s),n.appendChild(l),o.appendChild(r),o.appendChild(n),o};// Left Container - Render product items
...
i("ftYLF");var l={};l=new URL(i("d5gZm").resolve("5WNTT"),import.meta.url).toString();class a{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ViewCart is connected!")};// Right Container - Create Cart Title
...
createGoToCartButton=()=>{let e=document.createElement("div");e.classList="cart-goto-btn-wrapper";let o=document.createElement("button");o.classList="cart-goto-btn";let r=document.createElement("img");r.src=/*@__PURE__*/t(l),r.alt="Select";let n=document.createElement("span");return n.innerText=" Cart",// Append elemens to respective parents
o.appendChild(r),o.appendChild(n),e.appendChild(o),e};// Right Container - Render Cart Summaary
renderCartSummaryNoTotal=e=>{this.controller.clearContainerRight();// Right Container - Render Cart Title
