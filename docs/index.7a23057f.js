let e,t;var i,n,r,s,a,o,l="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};// SET VIEW MODULE:
...
let r=document.createElement("th");return r.classList="db-section__table_cell",t.appendChild(r),t};createDataRow=(e,t)=>{let i=document.createElement("tr"),n=document.createElement("td");n.classList="db-section__table_cell";let r=document.createElement("button");r.classList="db-section__table_button",r.innerText="+",n.appendChild(r),i.appendChild(n);let s=document.createElement("td");s.classList="db-section__table_cell";let a=document.createElement("button");for(let[n,r]of(a.classList="db-section__table_button",a.innerText="u",s.appendChild(a),i.appendChild(s),Object.entries(e))){// Add table cell element, class and ID:
let s=document.createElement("td");s.classList="db-section__table_cell",s.id=`${t}_${e.id}_${n}`;let a=document.createElement("input");a.type="text",a.id=`${t}_${e.id}_${n}_input`,a.value=`${r}`,s.appendChild(a),i.appendChild(s)}// Add another button element to the end of row:
let o=document.createElement("td");o.classList="db-section__table_cell";let l=document.createElement("button");return l.classList="db-section__table_button",l.innerText="-",o.appendChild(l),i.appendChild(o),i};createTable=(e,t)=>{// Create new Table
let i=document.createElement("table"),n=this.createHeaderRow(e[0]);// create Data Rows and add to Table
for(let r of(i.appendChild(n),e)){let e=this.createDataRow(r,t);i.appendChild(e)}return i};renderTable=(e,t)=>{let i=document.createElement("div");i.classList="db-section";let n=document.createElement("h2");n.classList="db-section__title",n.id=`${t}`,n.innerText=t;let r=this.createTable(e,t);r.classList="db-section__table",i.appendChild(n),i.appendChild(r),console.log(i),this.containerLeftNode.appendChild(i)};createMenuBtn=e=>{let t=document.createElement("li");t.classList="menu-btn-wrapper";let i=document.createElement("a");return i.classList="menu-btn",i.href=`#${e}`,i.innerText=`${e}`,t.appendChild(i),t};createMenu=(e,t,i,n,r)=>{// Init menu wrapper:
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const T=function(e){// TODO(user): Use native implementations if/when available
...
let s=e[i++],a=e[i++],o=e[i++],l=((7&r)<<18|(63&s)<<12|(63&a)<<6|63&o)-65536;t[n++]=String.fromCharCode(55296+(l>>10)),t[n++]=String.fromCharCode(56320+(1023&l))}else{let s=e[i++],a=e[i++];t[n++]=String.fromCharCode((15&r)<<12|(63&s)<<6|63&a)}}return t.join("")},S={/**
 ...
 */const A=function(e){let t=T(e);return S.encodeByteArray(t,!0)},D=function(e){// Use base64url encoding and remove padding in the end (dot characters).
return A(e).replace(/\./g,"")},N=function(e){try{return S.decodeString(e,!0)}catch(e){console.error("base64Decode failed: ",e)}return null},k=()=>/**
 * @license
...
return}let t=e&&N(e[1]);return t&&JSON.parse(t)},P=()=>{try{return k()||L()||R()}catch(e){/**
         * Catch-all for being unable to get __FIREBASE_DEFAULTS__ due
         * to any environment case we have not accounted for. Log to
         * info instead of swallowing so we can find these unknown cases
         * and add paths for them if needed.
         */console.info(`Unable to get __FIREBASE_DEFAULTS__ due to: ${e}`);return}},x=e=>{var t,i;return null===(i=null===(t=P())||void 0===t?void 0:t.emulatorHosts)||void 0===i?void 0:i[e]},O=e=>{let t=x(e);if(!t)return;let i=t.lastIndexOf(":");// Finding the last since IPv6 addr also has colons.
...
let n=parseInt(t.substring(i+1),10);return"["===t[0]?[t.substring(1,i-1),n]:[t.substring(0,i),n]},M=()=>{var e;return null===(e=P())||void 0===e?void 0:e.config};/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class K{constructor(e,t){this.name=e,this.container=t,this.component=null,this.instances=new Map,this.instancesDeferred=new Map,this.instancesOptions=new Map,this.onInitCallbacks=new Map}/**
...
}}getOrInitializeService({instanceIdentifier:e,options:t={}}){let i=this.instances.get(e);if(!i&&this.component&&(i=this.component.instanceFactory(this.container,{instanceIdentifier:e===z?void 0:e,options:t}),this.instances.set(e,i),this.instancesOptions.set(e,t),/**
...
}return i||null}normalizeInstanceIdentifier(e=z){return this.component?this.component.multipleInstances?e:z:e// assume multiple instances are supported before the component is provided.
 ...
 */const G=[];(eM=eB||(eB={}))[eM.DEBUG=0]="DEBUG",eM[eM.VERBOSE=1]="VERBOSE",eM[eM.INFO=2]="INFO",eM[eM.WARN=3]="WARN",eM[eM.ERROR=4]="ERROR",eM[eM.SILENT=5]="SILENT";const Q={debug:eB.DEBUG,verbose:eB.VERBOSE,info:eB.INFO,warn:eB.WARN,error:eB.ERROR,silent:eB.SILENT},W=eB.INFO,Y={[eB.DEBUG]:"log",[eB.VERBOSE]:"log",[eB.INFO]:"info",[eB.WARN]:"warn",[eB.ERROR]:"error"},X=(e,t,...i)=>{if(t<e.logLevel)return;let n=new Date().toISOString(),r=Y[t];if(r)console[r](`[${n}]  ${e.name}:`,...i);else throw Error(`Attempted to log a message with an invalid logType (value: ${t})`)};class J{/**
...
setLogLevel(e){this._logLevel="string"==typeof e?Q[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}/**
     ...
     */debug(...e){this._userLogHandler&&this._userLogHandler(this,eB.DEBUG,...e),this._logHandler(this,eB.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,eB.VERBOSE,...e),this._logHandler(this,eB.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,eB.INFO,...e),this._logHandler(this,eB.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,eB.WARN,...e),this._logHandler(this,eB.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,eB.ERROR,...e),this._logHandler(this,eB.ERROR,...e)}}const Z=(e,t)=>t.some(t=>e instanceof t),ee=new WeakMap,et=new WeakMap,ei=new WeakMap,en=new WeakMap,er=new WeakMap;let es={get(e,t,i){if(e instanceof IDBTransaction){// Special handling for transaction.done.
 ...
 * provider.
 */function(e){let t=e.getComponent();return(null==t?void 0:t.type)==="VERSION"/* ComponentType.VERSION */}(e))return null;{let t=e.getImmediate();return`${t.library}/${t.version}`}}).filter(e=>e).join(" ")}}const ef="@firebase/app",em="0.9.18",ep=new J("@firebase/app"),eg="[DEFAULT]",ey={[ef]:"fire-core","@firebase/app-compat":"fire-core-compat","@firebase/analytics":"fire-analytics","@firebase/analytics-compat":"fire-analytics-compat","@firebase/app-check":"fire-app-check","@firebase/app-check-compat":"fire-app-check-compat","@firebase/auth":"fire-auth","@firebase/auth-compat":"fire-auth-compat","@firebase/database":"fire-rtdb","@firebase/database-compat":"fire-rtdb-compat","@firebase/functions":"fire-fn","@firebase/functions-compat":"fire-fn-compat","@firebase/installations":"fire-iid","@firebase/installations-compat":"fire-iid-compat","@firebase/messaging":"fire-fcm","@firebase/messaging-compat":"fire-fcm-compat","@firebase/performance":"fire-perf","@firebase/performance-compat":"fire-perf-compat","@firebase/remote-config":"fire-rc","@firebase/remote-config-compat":"fire-rc-compat","@firebase/storage":"fire-gcs","@firebase/storage-compat":"fire-gcs-compat","@firebase/firestore":"fire-fst","@firebase/firestore-compat":"fire-fst-compat","fire-js":"fire-js",firebase:"fire-js-all"},ev=new Map,ew=new Map;/**
 *
...
if(j(i,s.options)&&j(n,s.config))return s;throw eb.create("duplicate-app"/* AppError.DUPLICATE_APP */,{appName:r})}let a=new H(r);for(let e of ew.values())a.addComponent(e);let o=new e_(i,n,a);return ev.set(r,o),o}/**
...
let r=null!==(n=ey[e])&&void 0!==n?n:e;i&&(r+=`-${i}`);let s=r.match(/\s|\//),a=t.match(/\s|\//);if(s||a){let e=[`Unable to register library "${r}" with version "${t}":`];s&&e.push(`library name "${r}" contains illegal characters (whitespace or "/")`),s&&a&&e.push("and"),a&&e.push(`version name "${t}" contains illegal characters (whitespace or "/")`),ep.warn(e.join(" "));return}eE(new $(`${r}-version`,()=>({library:r,version:t}),"VERSION"/* ComponentType.VERSION */))}const eS="firebase-heartbeat-store";let eI=null;function eA(){return eI||(eI=/**
 * Open a database.
 *
 * @param name Name of the database.
 * @param version Schema version.
 * @param callbacks Additional callbacks.
 */(function(e,t,{blocked:i,upgrade:n,blocking:r,terminated:s}={}){let a=indexedDB.open(e,1),o=ea(a);return n&&a.addEventListener("upgradeneeded",e=>{n(ea(a.result),e.oldVersion,e.newVersion,ea(a.transaction),e)}),i&&a.addEventListener("blocked",e=>i(e.oldVersion,e.newVersion,e)),o.then(e=>{s&&e.addEventListener("close",()=>s()),r&&e.addEventListener("versionchange",e=>r(e.oldVersion,e.newVersion,e))}).catch(()=>{}),o})("firebase-heartbeat-database",0,{upgrade:(e,t)=>{0===t&&e.createObjectStore(eS)}}).catch(e=>{throw eb.create("idb-open"/* AppError.IDB_OPEN */,{originalErrorMessage:e.message})})),eI}async function eD(e){try{let t=await eA(),i=await t.transaction(eS).objectStore(eS).get(ek(e));return i}catch(e){if(e instanceof V)ep.warn(e.message);else{let t=eb.create("idb-get"/* AppError.IDB_GET */,{originalErrorMessage:null==e?void 0:e.message});ep.warn(t.message)}}}async function eN(e,t){try{let i=await eA(),n=i.transaction(eS,"readwrite"),r=n.objectStore(eS);await r.put(t,ek(e)),await n.done}catch(e){if(e instanceof V)ep.warn(e.message);else{let t=eb.create("idb-set"/* AppError.IDB_WRITE */,{originalErrorMessage:null==e?void 0:e.message});ep.warn(t.message)}}}function ek(e){return`${e.name}!${e.options.appId}`}class eL{constructor(e){this.container=e,/**
...
{if(e.dates.push(r.date),ex(i)>t){e.dates.pop();break}}else if(// If no entry for this user agent exists, create one.
i.push({agent:r.agent,dates:[r.date]}),ex(i)>t){// If the header would exceed max size, remove the added heartbeat
...
eC("fire-js",""),eC("firebase","10.3.1","app");var eO,eM,eF,eV,eU,eB,ej,eq="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof window?window:void 0!==l?l:"undefined"!=typeof self?self:{},e$={},ez=ez||{},eK=eq||self;function eH(e){var t=typeof e;return"array"==(t="object"!=t?t:e?Array.isArray(e)?"array":t:"null")||"object"==t&&"number"==typeof e.length}function eG(e){var t=typeof e;return"object"==t&&null!=e||"function"==t}function eQ(e,t,i){return e.call.apply(e.bind,arguments)}function eW(e,t,i){if(!e)throw Error();if(2<arguments.length){var n=Array.prototype.slice.call(arguments,2);return function(){var i=Array.prototype.slice.call(arguments);return Array.prototype.unshift.apply(i,n),e.apply(t,i)}}return function(){return e.apply(t,arguments)}}function eY(e,t,i){return(eY=Function.prototype.bind&&-1!=Function.prototype.bind.toString().indexOf("native code")?eQ:eW).apply(null,arguments)}function eX(e,t){var i=Array.prototype.slice.call(arguments,1);return function(){var t=i.slice();return t.push.apply(t,arguments),e.apply(this,t)}}function eJ(e,t){function i(){}i.prototype=t.prototype,e.$=t.prototype,e.prototype=new i,e.prototype.constructor=e,e.ac=function(e,i,n){for(var r=Array(arguments.length-2),s=2;s<arguments.length;s++)r[s-2]=arguments[s];return t.prototype[i].apply(e,r)}}function eZ(){this.s=this.s,this.o=this.o}eZ.prototype.s=!1,eZ.prototype.sa=function(){this.s||(this.s=!0,this.N())},eZ.prototype.N=function(){if(this.o)for(;this.o.length;)this.o.shift()()};const e0=Array.prototype.indexOf?function(e,t){return Array.prototype.indexOf.call(e,t,void 0)}:function(e,t){if("string"==typeof e)return"string"!=typeof t||1!=t.length?-1:e.indexOf(t,0);for(let i=0;i<e.length;i++)if(i in e&&e[i]===t)return i;return -1};function e1(e){let t=e.length;if(0<t){let i=Array(t);for(let n=0;n<t;n++)i[n]=e[n];return i}return[]}function e2(e,t){for(let t=1;t<arguments.length;t++){let i=arguments[t];if(eH(i)){let t=e.length||0,n=i.length||0;e.length=t+n;for(let r=0;r<n;r++)e[t+r]=i[r]}else e.push(i)}}function e9(e,t){this.type=e,this.g=this.target=t,this.defaultPrevented=!1}e9.prototype.h=function(){this.defaultPrevented=!0};var e4=function(){if(!eK.addEventListener||!Object.defineProperty)return!1;var e=!1,t=Object.defineProperty({},"passive",{get:function(){e=!0}});try{eK.addEventListener("test",()=>{},t),eK.removeEventListener("test",()=>{},t)}catch(e){}return e}();function e6(e){return/^[\s\xa0]*$/.test(e)}function e5(){var e=eK.navigator;return e&&(e=e.userAgent)?e:""}function e3(e){return -1!=e5().indexOf(e)}function e7(e){return e7[" "](e),e}e7[" "]=function(){};var e8=e3("Opera"),te=e3("Trident")||e3("MSIE"),tt=e3("Edge"),ti=tt||te,tn=e3("Gecko")&&!(-1!=e5().toLowerCase().indexOf("webkit")&&!e3("Edge"))&&!(e3("Trident")||e3("MSIE"))&&!e3("Edge"),tr=-1!=e5().toLowerCase().indexOf("webkit")&&!e3("Edge");function ts(){var e=eK.document;return e?e.documentMode:void 0}e:{var ta,to="",tl=(ta=e5(),tn?/rv:([^\);]+)(\)|;)/.exec(ta):tt?/Edge\/([\d\.]+)/.exec(ta):te?/\b(?:MSIE|rv)[: ]([^\);]+)(\)|;)/.exec(ta):tr?/WebKit\/(\S+)/.exec(ta):e8?/(?:Version)[ \/]?(\S+)/.exec(ta):void 0);if(tl&&(to=tl?tl[1]:""),te){var th=ts();if(null!=th&&th>parseFloat(to)){n=String(th);break e}}n=to}var tu=eK.document&&te&&(ts()||parseInt(n,10))||void 0;function tc(e,t){if(e9.call(this,e?e.type:""),this.relatedTarget=this.g=this.target=null,this.button=this.screenY=this.screenX=this.clientY=this.clientX=0,this.key="",this.metaKey=this.shiftKey=this.altKey=this.ctrlKey=!1,this.state=null,this.pointerId=0,this.pointerType="",this.i=null,e){var i=this.type=e.type,n=e.changedTouches&&e.changedTouches.length?e.changedTouches[0]:null;if(this.target=e.target||e.srcElement,this.g=t,t=e.relatedTarget){if(tn){e:{try{e7(t.nodeName);var r=!0;break e}catch(e){}r=!1}r||(t=null)}}else"mouseover"==i?t=e.fromElement:"mouseout"==i&&(t=e.toElement);this.relatedTarget=t,n?(this.clientX=void 0!==n.clientX?n.clientX:n.pageX,this.clientY=void 0!==n.clientY?n.clientY:n.pageY,this.screenX=n.screenX||0,this.screenY=n.screenY||0):(this.clientX=void 0!==e.clientX?e.clientX:e.pageX,this.clientY=void 0!==e.clientY?e.clientY:e.pageY,this.screenX=e.screenX||0,this.screenY=e.screenY||0),this.button=e.button,this.key=e.key||"",this.ctrlKey=e.ctrlKey,this.altKey=e.altKey,this.shiftKey=e.shiftKey,this.metaKey=e.metaKey,this.pointerId=e.pointerId||0,this.pointerType="string"==typeof e.pointerType?e.pointerType:td[e.pointerType]||"",this.state=e.state,this.i=e,e.defaultPrevented&&tc.$.h.call(this)}}eJ(tc,e9);var td={2:"touch",3:"pen",4:"mouse"};tc.prototype.h=function(){tc.$.h.call(this);var e=this.i;e.preventDefault?e.preventDefault():e.returnValue=!1};var tf="closure_listenable_"+(1e6*Math.random()|0),tm=0;function tp(e,t,i,n,r){this.listener=e,this.proxy=null,this.src=t,this.type=i,this.capture=!!n,this.la=r,this.key=++tm,this.fa=this.ia=!1}function tg(e){e.fa=!0,e.listener=null,e.proxy=null,e.src=null,e.la=null}function ty(e,t,i){for(let n in e)t.call(i,e[n],n,e)}function tv(e){let t={};for(let i in e)t[i]=e[i];return t}const tw="constructor hasOwnProperty isPrototypeOf propertyIsEnumerable toLocaleString toString valueOf".split(" ");function tE(e,t){let i,n;for(let t=1;t<arguments.length;t++){for(i in n=arguments[t])e[i]=n[i];for(let t=0;t<tw.length;t++)i=tw[t],Object.prototype.hasOwnProperty.call(n,i)&&(e[i]=n[i])}}function tb(e){this.src=e,this.g={},this.h=0}function t_(e,t){var i=t.type;if(i in e.g){var n,r=e.g[i],s=e0(r,t);(n=0<=s)&&Array.prototype.splice.call(r,s,1),n&&(tg(t),0==e.g[i].length&&(delete e.g[i],e.h--))}}function tT(e,t,i,n){for(var r=0;r<e.length;++r){var s=e[r];if(!s.fa&&s.listener==t&&!!i==s.capture&&s.la==n)return r}return -1}tb.prototype.add=function(e,t,i,n,r){var s=e.toString();(e=this.g[s])||(e=this.g[s]=[],this.h++);var a=tT(e,t,n,r);return -1<a?(t=e[a],i||(t.ia=!1)):((t=new tp(t,this.src,s,!!n,r)).ia=i,e.push(t)),t};var tC="closure_lm_"+(1e6*Math.random()|0),tS={};function tI(e,t,i,n,r,s){if(!t)throw Error("Invalid event type");var a=eG(r)?!!r.capture:!!r,o=tk(e);if(o||(e[tC]=o=new tb(e)),(i=o.add(t,i,n,a,s)).proxy)return i;if(n=function e(t){return tN.call(e.src,e.listener,t)},i.proxy=n,n.src=e,n.listener=i,e.addEventListener)e4||(r=a),void 0===r&&(r=!1),e.addEventListener(t.toString(),n,r);else if(e.attachEvent)e.attachEvent(tD(t.toString()),n);else if(e.addListener&&e.removeListener)e.addListener(n);else throw Error("addEventListener and attachEvent are unavailable.");return i}function tA(e){if("number"!=typeof e&&e&&!e.fa){var t=e.src;if(t&&t[tf])t_(t.i,e);else{var i=e.type,n=e.proxy;t.removeEventListener?t.removeEventListener(i,n,e.capture):t.detachEvent?t.detachEvent(tD(i),n):t.addListener&&t.removeListener&&t.removeListener(n),(i=tk(t))?(t_(i,e),0==i.h&&(i.src=null,t[tC]=null)):tg(e)}}}function tD(e){return e in tS?tS[e]:tS[e]="on"+e}function tN(e,t){if(e.fa)e=!0;else{t=new tc(t,this);var i=e.listener,n=e.la||e.src;e.ia&&tA(e),e=i.call(n,t)}return e}function tk(e){return(e=e[tC])instanceof tb?e:null}var tL="__closure_events_fn_"+(1e9*Math.random()>>>0);function tR(e){return"function"==typeof e?e:(e[tL]||(e[tL]=function(t){return e.handleEvent(t)}),e[tL])}function tP(){eZ.call(this),this.i=new tb(this),this.S=this,this.J=null}function tx(e,t){var i,n=e.J;if(n)for(i=[];n;n=n.J)i.push(n);if(e=e.S,n=t.type||t,"string"==typeof t)t=new e9(t,e);else if(t instanceof e9)t.target=t.target||e;else{var r=t;tE(t=new e9(n,e),r)}if(r=!0,i)for(var s=i.length-1;0<=s;s--){var a=t.g=i[s];r=tO(a,n,!0,t)&&r}if(r=tO(a=t.g=e,n,!0,t)&&r,r=tO(a,n,!1,t)&&r,i)for(s=0;s<i.length;s++)r=tO(a=t.g=i[s],n,!1,t)&&r}function tO(e,t,i,n){if(!(t=e.i.g[String(t)]))return!0;t=t.concat();for(var r=!0,s=0;s<t.length;++s){var a=t[s];if(a&&!a.fa&&a.capture==i){var o=a.listener,l=a.la||a.src;a.ia&&t_(e.i,a),r=!1!==o.call(l,n)&&r}}return r&&!n.defaultPrevented}eJ(tP,eZ),tP.prototype[tf]=!0,tP.prototype.removeEventListener=function(e,t,i,n){!function e(t,i,n,r,s){if(Array.isArray(i))for(var a=0;a<i.length;a++)e(t,i[a],n,r,s);else(r=eG(r)?!!r.capture:!!r,n=tR(n),t&&t[tf])?(t=t.i,(i=String(i).toString())in t.g&&-1<(n=tT(a=t.g[i],n,r,s))&&(tg(a[n]),Array.prototype.splice.call(a,n,1),0==a.length&&(delete t.g[i],t.h--))):t&&(t=tk(t))&&(i=t.g[i.toString()],t=-1,i&&(t=tT(i,n,r,s)),(n=-1<t?i[t]:null)&&tA(n))}(this,e,t,i,n)},tP.prototype.N=function(){if(tP.$.N.call(this),this.i){var e,t=this.i;for(e in t.g){for(var i=t.g[e],n=0;n<i.length;n++)tg(i[n]);delete t.g[e],t.h--}}this.J=null},tP.prototype.O=function(e,t,i,n){return this.i.add(String(e),t,!1,i,n)},tP.prototype.P=function(e,t,i,n){return this.i.add(String(e),t,!0,i,n)};var tM=eK.JSON.stringify,tF=new class{constructor(e,t){this.i=e,this.j=t,this.h=0,this.g=null}get(){let e;return 0<this.h?(this.h--,e=this.g,this.g=e.next,e.next=null):e=this.i(),e}}(()=>new tV,e=>e.reset());class tV{constructor(){this.next=this.g=this.h=null}set(e,t){this.h=e,this.g=t,this.next=null}reset(){this.next=this.g=this.h=null}}let tU,tB=!1,tj=new class{constructor(){this.h=this.g=null}add(e,t){let i=tF.get();i.set(e,t),this.h?this.h.next=i:this.g=i,this.h=i}},tq=()=>{let e=eK.Promise.resolve(void 0);tU=()=>{e.then(t$)}};var t$=()=>{let e;for(var t;e=null,tj.g&&(e=tj.g,tj.g=tj.g.next,tj.g||(tj.h=null),e.next=null),t=e;){try{t.h.call(t.g)}catch(e){!function(e){eK.setTimeout(()=>{throw e},0)}(e)}tF.j(t),100>tF.h&&(tF.h++,t.next=tF.g,tF.g=t)}tB=!1};function tz(e,t){tP.call(this),this.h=e||1,this.g=t||eK,this.j=eY(this.qb,this),this.l=Date.now()}function tK(e){e.ga=!1,e.T&&(e.g.clearTimeout(e.T),e.T=null)}function tH(e,t,i){if("function"==typeof e)i&&(e=eY(e,i));else if(e&&"function"==typeof e.handleEvent)e=eY(e.handleEvent,e);else throw Error("Invalid listener argument");return 2147483647<Number(t)?-1:eK.setTimeout(e,t||0)}eJ(tz,tP),(ej=tz.prototype).ga=!1,ej.T=null,ej.qb=function(){if(this.ga){var e=Date.now()-this.l;0<e&&e<.8*this.h?this.T=this.g.setTimeout(this.j,this.h-e):(this.T&&(this.g.clearTimeout(this.T),this.T=null),tx(this,"tick"),this.ga&&(tK(this),this.start()))}},ej.start=function(){this.ga=!0,this.T||(this.T=this.g.setTimeout(this.j,this.h),this.l=Date.now())},ej.N=function(){tz.$.N.call(this),tK(this),delete this.g};class tG extends eZ{constructor(e,t){super(),this.m=e,this.j=t,this.h=null,this.i=!1,this.g=null}l(e){this.h=arguments,this.g?this.i=!0:function e(t){t.g=tH(()=>{t.g=null,t.i&&(t.i=!1,e(t))},t.j);let i=t.h;t.h=null,t.m.apply(null,i)}(this)}N(){super.N(),this.g&&(eK.clearTimeout(this.g),this.g=null,this.i=!1,this.h=null)}}function tQ(e){eZ.call(this),this.h=e,this.g={}}eJ(tQ,eZ);var tW=[];function tY(e,t,i,n){Array.isArray(i)||(i&&(tW[0]=i.toString()),i=tW);for(var r=0;r<i.length;r++){var s=function e(t,i,n,r,s){if(r&&r.once)return function e(t,i,n,r,s){if(Array.isArray(i)){for(var a=0;a<i.length;a++)e(t,i[a],n,r,s);return null}return n=tR(n),t&&t[tf]?t.P(i,n,eG(r)?!!r.capture:!!r,s):tI(t,i,n,!0,r,s)}(t,i,n,r,s);if(Array.isArray(i)){for(var a=0;a<i.length;a++)e(t,i[a],n,r,s);return null}return n=tR(n),t&&t[tf]?t.O(i,n,eG(r)?!!r.capture:!!r,s):tI(t,i,n,!1,r,s)}(t,i[r],n||e.handleEvent,!1,e.h||e);if(!s)break;e.g[s.key]=s}}function tX(e){ty(e.g,function(e,t){this.g.hasOwnProperty(t)&&tA(e)},e),e.g={}}function tJ(){this.g=!0}function tZ(e,t,i,n){e.info(function(){return"XMLHTTP TEXT ("+t+"): "+function(e,t){if(!e.g)return t;if(!t)return null;try{var i=JSON.parse(t);if(i){for(e=0;e<i.length;e++)if(Array.isArray(i[e])){var n=i[e];if(!(2>n.length)){var r=n[1];if(Array.isArray(r)&&!(1>r.length)){var s=r[0];if("noop"!=s&&"stop"!=s&&"close"!=s)for(var a=1;a<r.length;a++)r[a]=""}}}}return tM(i)}catch(e){return t}}(e,i)+(n?" "+n:"")})}tQ.prototype.N=function(){tQ.$.N.call(this),tX(this)},tQ.prototype.handleEvent=function(){throw Error("EventHandler.handleEvent not implemented")},tJ.prototype.Ea=function(){this.g=!1},tJ.prototype.info=function(){};var t0={},t1=null;function t2(){return t1=t1||new tP}function t9(e){e9.call(this,t0.Ta,e)}function t4(e){let t=t2();tx(t,new t9(t))}function t6(e,t){e9.call(this,t0.STAT_EVENT,e),this.stat=t}function t5(e){let t=t2();tx(t,new t6(t,e))}function t3(e,t){e9.call(this,t0.Ua,e),this.size=t}function t7(e,t){if("function"!=typeof e)throw Error("Fn must not be null and must be a function");return eK.setTimeout(function(){e()},t)}t0.Ta="serverreachability",eJ(t9,e9),t0.STAT_EVENT="statevent",eJ(t6,e9),t0.Ua="timingevent",eJ(t3,e9);var t8={NO_ERROR:0,rb:1,Eb:2,Db:3,yb:4,Cb:5,Fb:6,Qa:7,TIMEOUT:8,Ib:9},ie={wb:"complete",Sb:"success",Ra:"error",Qa:"abort",Kb:"ready",Lb:"readystatechange",TIMEOUT:"timeout",Gb:"incrementaldata",Jb:"progress",zb:"downloadprogress",$b:"uploadprogress"};function it(){}function ii(e){return e.h||(e.h=e.i())}function ir(){}it.prototype.h=null;var is={OPEN:"a",vb:"b",Ra:"c",Hb:"d"};function ia(){e9.call(this,"d")}function io(){e9.call(this,"c")}function il(){}function ih(e,t,i,n){this.l=e,this.j=t,this.m=i,this.W=n||1,this.U=new tQ(this),this.P=ic,e=ti?125:void 0,this.V=new tz(e),this.I=null,this.i=!1,this.s=this.A=this.v=this.L=this.G=this.Y=this.B=null,this.F=[],this.g=null,this.C=0,this.o=this.u=null,this.ca=-1,this.J=!1,this.O=0,this.M=null,this.ba=this.K=this.aa=this.S=!1,this.h=new iu}function iu(){this.i=null,this.g="",this.h=!1}eJ(ia,e9),eJ(io,e9),eJ(il,it),il.prototype.g=function(){return new XMLHttpRequest},il.prototype.i=function(){return{}},s=new il;var ic=45e3,id={},im={};function ip(e,t,i){e.L=1,e.v=iP(iD(t)),e.s=i,e.S=!0,ig(e,null)}function ig(e,t){e.G=Date.now(),iw(e),e.A=iD(e.v);var i=e.A,n=e.W;Array.isArray(n)||(n=[String(n)]),iH(i.i,"t",n),e.C=0,i=e.l.J,e.h=new iu,e.g=nO(e.l,i?t:null,!e.s),0<e.O&&(e.M=new tG(eY(e.Pa,e,e.g),e.O)),tY(e.U,e.g,"readystatechange",e.nb),t=e.I?tv(e.I):{},e.s?(e.u||(e.u="POST"),t["Content-Type"]="application/x-www-form-urlencoded",e.g.ha(e.A,e.u,e.s,t)):(e.u="GET",e.g.ha(e.A,e.u,null,t)),t4(),function(e,t,i,n,r,s){e.info(function(){if(e.g){if(s)for(var a="",o=s.split("&"),l=0;l<o.length;l++){var h=o[l].split("=");if(1<h.length){var u=h[0];h=h[1];var c=u.split("_");a=2<=c.length&&"type"==c[1]?a+(u+"=")+h+"&":a+(u+"=redacted&")}}else a=null}else a=s;return"XMLHTTP REQ ("+n+") [attempt "+r+"]: "+t+"\n"+i+"\n"+a})}(e.j,e.u,e.A,e.m,e.W,e.s)}function iy(e){return!!e.g&&"GET"==e.u&&2!=e.L&&e.l.Ha}function iv(e,t,i){let n=!0,r;for(;!e.J&&e.C<i.length;)if((r=function(e,t){var i=e.C,n=t.indexOf("\n",i);return -1==n?im:isNaN(i=Number(t.substring(i,n)))?id:(n+=1)+i>t.length?im:(t=t.slice(n,n+i),e.C=n+i,t)}(e,i))==im){4==t&&(e.o=4,t5(14),n=!1),tZ(e.j,e.m,null,"[Incomplete Response]");break}else if(r==id){e.o=4,t5(15),tZ(e.j,e.m,i,"[Invalid Chunk]"),n=!1;break}else tZ(e.j,e.m,r,null),iC(e,r);iy(e)&&r!=im&&r!=id&&(e.h.g="",e.C=0),4!=t||0!=i.length||e.h.h||(e.o=1,t5(16),n=!1),e.i=e.i&&n,n?0<i.length&&!e.ba&&(e.ba=!0,(t=e.l).g==e&&t.ca&&!t.M&&(t.l.info("Great, no buffering proxy detected. Bytes received: "+i.length),nA(t),t.M=!0,t5(11))):(tZ(e.j,e.m,i,"[Invalid Chunked Response]"),iT(e),i_(e))}function iw(e){e.Y=Date.now()+e.P,iE(e,e.P)}function iE(e,t){if(null!=e.B)throw Error("WatchDog timer not null");e.B=t7(eY(e.lb,e),t)}function ib(e){e.B&&(eK.clearTimeout(e.B),e.B=null)}function i_(e){0==e.l.H||e.J||nk(e.l,e)}function iT(e){ib(e);var t=e.M;t&&"function"==typeof t.sa&&t.sa(),e.M=null,tK(e.V),tX(e.U),e.g&&(t=e.g,e.g=null,t.abort(),t.sa())}function iC(e,t){try{var i=e.l;if(0!=i.H&&(i.g==e||iZ(i.i,e))){if(!e.K&&iZ(i.i,e)&&3==i.H){try{var n=i.Ja.g.parse(t)}catch(e){n=null}if(Array.isArray(n)&&3==n.length){var r=n;if(0==r[0]){e:if(!i.u){if(i.g){if(i.g.G+3e3<e.G)nN(i),nw(i);else break e}nI(i),t5(18)}}else i.Fa=r[1],0<i.Fa-i.V&&37500>r[2]&&i.G&&0==i.A&&!i.v&&(i.v=t7(eY(i.ib,i),6e3));if(1>=iJ(i.i)&&i.oa){try{i.oa()}catch(e){}i.oa=void 0}}else nR(i,11)}else if((e.K||i.g==e)&&nN(i),!e6(t))for(r=i.Ja.g.parse(t),t=0;t<r.length;t++){let o=r[t];if(i.V=o[0],o=o[1],2==i.H){if("c"==o[0]){i.K=o[1],i.pa=o[2];let t=o[3];null!=t&&(i.ra=t,i.l.info("VER="+i.ra));let r=o[4];null!=r&&(i.Ga=r,i.l.info("SVER="+i.Ga));let l=o[5];null!=l&&"number"==typeof l&&0<l&&(n=1.5*l,i.L=n,i.l.info("backChannelRequestTimeoutMs_="+n)),n=i;let h=e.g;if(h){let e=h.g?h.g.getResponseHeader("X-Client-Wire-Protocol"):null;if(e){var s=n.i;s.g||-1==e.indexOf("spdy")&&-1==e.indexOf("quic")&&-1==e.indexOf("h2")||(s.j=s.l,s.g=new Set,s.h&&(i0(s,s.h),s.h=null))}if(n.F){let e=h.g?h.g.getResponseHeader("X-HTTP-Session-Id"):null;e&&(n.Da=e,iR(n.I,n.F,e))}}if(i.H=3,i.h&&i.h.Ba(),i.ca&&(i.S=Date.now()-e.G,i.l.info("Handshake RTT: "+i.S+"ms")),(n=i).wa=nx(n,n.J?n.pa:null,n.Y),e.K){i1(n.i,e);var a=n.L;a&&e.setTimeout(a),e.B&&(ib(e),iw(e)),n.g=e}else nS(n);0<i.j.length&&nb(i)}else"stop"!=o[0]&&"close"!=o[0]||nR(i,7)}else 3==i.H&&("stop"==o[0]||"close"==o[0]?"stop"==o[0]?nR(i,7):nv(i):"noop"!=o[0]&&i.h&&i.h.Aa(o),i.A=0)}}t4(4)}catch(e){}}function iS(e,t){if(e.forEach&&"function"==typeof e.forEach)e.forEach(t,void 0);else if(eH(e)||"string"==typeof e)Array.prototype.forEach.call(e,t,void 0);else for(var i=function(e){if(e.ta&&"function"==typeof e.ta)return e.ta();if(!e.Z||"function"!=typeof e.Z){if("undefined"!=typeof Map&&e instanceof Map)return Array.from(e.keys());if(!("undefined"!=typeof Set&&e instanceof Set)){if(eH(e)||"string"==typeof e){var t=[];e=e.length;for(var i=0;i<e;i++)t.push(i);return t}for(let n in t=[],i=0,e)t[i++]=n;return t}}}(e),n=function(e){if(e.Z&&"function"==typeof e.Z)return e.Z();if("undefined"!=typeof Map&&e instanceof Map||"undefined"!=typeof Set&&e instanceof Set)return Array.from(e.values());if("string"==typeof e)return e.split("");if(eH(e)){for(var t=[],i=e.length,n=0;n<i;n++)t.push(e[n]);return t}for(n in t=[],i=0,e)t[i++]=e[n];return t}(e),r=n.length,s=0;s<r;s++)t.call(void 0,n[s],i&&i[s],e)}(ej=ih.prototype).setTimeout=function(e){this.P=e},ej.nb=function(e){e=e.target;let t=this.M;t&&3==nd(e)?t.l():this.Pa(e)},ej.Pa=function(e){try{if(e==this.g)e:{let u=nd(this.g);var t=this.g.Ia();let c=this.g.da();if(!(3>u)&&(3!=u||ti||this.g&&(this.h.h||this.g.ja()||nf(this.g)))){this.J||4!=u||7==t||(8==t||0>=c?t4(3):t4(2)),ib(this);var i=this.g.da();this.ca=i;t:if(iy(this)){var n=nf(this.g);e="";var r=n.length,s=4==nd(this.g);if(!this.h.i){if("undefined"==typeof TextDecoder){iT(this),i_(this);var a="";break t}this.h.i=new eK.TextDecoder}for(t=0;t<r;t++)this.h.h=!0,e+=this.h.i.decode(n[t],{stream:s&&t==r-1});n.splice(0,r),this.h.g+=e,this.C=0,a=this.h.g}else a=this.g.ja();if(this.i=200==i,function(e,t,i,n,r,s,a){e.info(function(){return"XMLHTTP RESP ("+n+") [ attempt "+r+"]: "+t+"\n"+i+"\n"+s+" "+a})}(this.j,this.u,this.A,this.m,this.W,u,i),this.i){if(this.aa&&!this.K){t:{if(this.g){var o,l=this.g;if((o=l.g?l.g.getResponseHeader("X-HTTP-Initial-Response"):null)&&!e6(o)){var h=o;break t}}h=null}if(i=h)tZ(this.j,this.m,i,"Initial handshake response via X-HTTP-Initial-Response"),this.K=!0,iC(this,i);else{this.i=!1,this.o=3,t5(12),iT(this),i_(this);break e}}this.S?(iv(this,u,a),ti&&this.i&&3==u&&(tY(this.U,this.V,"tick",this.mb),this.V.start())):(tZ(this.j,this.m,a,null),iC(this,a)),4==u&&iT(this),this.i&&!this.J&&(4==u?nk(this.l,this):(this.i=!1,iw(this)))}else(function(e){let t={};e=(e.g&&2<=nd(e)&&e.g.getAllResponseHeaders()||"").split("\r\n");for(let n=0;n<e.length;n++){if(e6(e[n]))continue;var i=function(e){var t=1;e=e.split(":");let i=[];for(;0<t&&e.length;)i.push(e.shift()),t--;return e.length&&i.push(e.join(":")),i}(e[n]);let r=i[0];if("string"!=typeof(i=i[1]))continue;i=i.trim();let s=t[r]||[];t[r]=s,s.push(i)}!function(e,t){for(let i in e)t.call(void 0,e[i],i,e)}(t,function(e){return e.join(", ")})})(this.g),400==i&&0<a.indexOf("Unknown SID")?(this.o=3,t5(12)):(this.o=0,t5(13)),iT(this),i_(this)}}}catch(e){}finally{}},ej.mb=function(){if(this.g){var e=nd(this.g),t=this.g.ja();this.C<t.length&&(ib(this),iv(this,e,t),this.i&&4!=e&&iw(this))}},ej.cancel=function(){this.J=!0,iT(this)},ej.lb=function(){this.B=null;let e=Date.now();0<=e-this.Y?(function(e,t){e.info(function(){return"TIMEOUT: "+t})}(this.j,this.A),2!=this.L&&(t4(),t5(17)),iT(this),this.o=2,i_(this)):iE(this,this.Y-e)};var iI=RegExp("^(?:([^:/?#.]+):)?(?://(?:([^\\\\/?#]*)@)?([^\\\\/?#]*?)(?::([0-9]+))?(?=[\\\\/?#]|$))?([^?#]+)?(?:\\?([^#]*))?(?:#([\\s\\S]*))?$");function iA(e){if(this.g=this.s=this.j="",this.m=null,this.o=this.l="",this.h=!1,e instanceof iA){this.h=e.h,iN(this,e.j),this.s=e.s,this.g=e.g,ik(this,e.m),this.l=e.l;var t=e.i,i=new iq;i.i=t.i,t.g&&(i.g=new Map(t.g),i.h=t.h),iL(this,i),this.o=e.o}else e&&(t=String(e).match(iI))?(this.h=!1,iN(this,t[1]||"",!0),this.s=ix(t[2]||""),this.g=ix(t[3]||"",!0),ik(this,t[4]),this.l=ix(t[5]||"",!0),iL(this,t[6]||"",!0),this.o=ix(t[7]||"")):(this.h=!1,this.i=new iq(null,this.h))}function iD(e){return new iA(e)}function iN(e,t,i){e.j=i?ix(t,!0):t,e.j&&(e.j=e.j.replace(/:$/,""))}function ik(e,t){if(t){if(isNaN(t=Number(t))||0>t)throw Error("Bad port number "+t);e.m=t}else e.m=null}function iL(e,t,i){var n,r;t instanceof iq?(e.i=t,n=e.i,(r=e.h)&&!n.j&&(i$(n),n.i=null,n.g.forEach(function(e,t){var i=t.toLowerCase();t!=i&&(iz(this,t),iH(this,i,e))},n)),n.j=r):(i||(t=iO(t,iB)),e.i=new iq(t,e.h))}function iR(e,t,i){e.i.set(t,i)}function iP(e){return iR(e,"zx",Math.floor(2147483648*Math.random()).toString(36)+Math.abs(Math.floor(2147483648*Math.random())^Date.now()).toString(36)),e}function ix(e,t){return e?t?decodeURI(e.replace(/%25/g,"%2525")):decodeURIComponent(e):""}function iO(e,t,i){return"string"==typeof e?(e=encodeURI(e).replace(t,iM),i&&(e=e.replace(/%25([0-9a-fA-F]{2})/g,"%$1")),e):null}function iM(e){return"%"+((e=e.charCodeAt(0))>>4&15).toString(16)+(15&e).toString(16)}iA.prototype.toString=function(){var e=[],t=this.j;t&&e.push(iO(t,iF,!0),":");var i=this.g;return(i||"file"==t)&&(e.push("//"),(t=this.s)&&e.push(iO(t,iF,!0),"@"),e.push(encodeURIComponent(String(i)).replace(/%25([0-9a-fA-F]{2})/g,"%$1")),null!=(i=this.m)&&e.push(":",String(i))),(i=this.l)&&(this.g&&"/"!=i.charAt(0)&&e.push("/"),e.push(iO(i,"/"==i.charAt(0)?iU:iV,!0))),(i=this.i.toString())&&e.push("?",i),(i=this.o)&&e.push("#",iO(i,ij)),e.join("")};var iF=/[#\/\?@]/g,iV=/[#\?:]/g,iU=/[#\?]/g,iB=/[#\?@]/g,ij=/#/g;function iq(e,t){this.h=this.g=null,this.i=e||null,this.j=!!t}function i$(e){e.g||(e.g=new Map,e.h=0,e.i&&function(e,t){if(e){e=e.split("&");for(var i=0;i<e.length;i++){var n=e[i].indexOf("="),r=null;if(0<=n){var s=e[i].substring(0,n);r=e[i].substring(n+1)}else s=e[i];t(s,r?decodeURIComponent(r.replace(/\+/g," ")):"")}}}(e.i,function(t,i){e.add(decodeURIComponent(t.replace(/\+/g," ")),i)}))}function iz(e,t){i$(e),t=iG(e,t),e.g.has(t)&&(e.i=null,e.h-=e.g.get(t).length,e.g.delete(t))}function iK(e,t){return i$(e),t=iG(e,t),e.g.has(t)}function iH(e,t,i){iz(e,t),0<i.length&&(e.i=null,e.g.set(iG(e,t),e1(i)),e.h+=i.length)}function iG(e,t){return t=String(t),e.j&&(t=t.toLowerCase()),t}(ej=iq.prototype).add=function(e,t){i$(this),this.i=null,e=iG(this,e);var i=this.g.get(e);return i||this.g.set(e,i=[]),i.push(t),this.h+=1,this},ej.forEach=function(e,t){i$(this),this.g.forEach(function(i,n){i.forEach(function(i){e.call(t,i,n,this)},this)},this)},ej.ta=function(){i$(this);let e=Array.from(this.g.values()),t=Array.from(this.g.keys()),i=[];for(let n=0;n<t.length;n++){let r=e[n];for(let e=0;e<r.length;e++)i.push(t[n])}return i},ej.Z=function(e){i$(this);let t=[];if("string"==typeof e)iK(this,e)&&(t=t.concat(this.g.get(iG(this,e))));else{e=Array.from(this.g.values());for(let i=0;i<e.length;i++)t=t.concat(e[i])}return t},ej.set=function(e,t){return i$(this),this.i=null,iK(this,e=iG(this,e))&&(this.h-=this.g.get(e).length),this.g.set(e,[t]),this.h+=1,this},ej.get=function(e,t){return e&&0<(e=this.Z(e)).length?String(e[0]):t},ej.toString=function(){if(this.i)return this.i;if(!this.g)return"";let e=[],t=Array.from(this.g.keys());for(var i=0;i<t.length;i++){var n=t[i];let s=encodeURIComponent(String(n)),a=this.Z(n);for(n=0;n<a.length;n++){var r=s;""!==a[n]&&(r+="="+encodeURIComponent(String(a[n]))),e.push(r)}}return this.i=e.join("&")};var iQ=class{constructor(e,t){this.g=e,this.map=t}};function iW(e){this.l=e||iY,e=eK.PerformanceNavigationTiming?0<(e=eK.performance.getEntriesByType("navigation")).length&&("hq"==e[0].nextHopProtocol||"h2"==e[0].nextHopProtocol):!!(eK.g&&eK.g.Ka&&eK.g.Ka()&&eK.g.Ka().ec),this.j=e?this.l:1,this.g=null,1<this.j&&(this.g=new Set),this.h=null,this.i=[]}var iY=10;function iX(e){return!!e.h||!!e.g&&e.g.size>=e.j}function iJ(e){return e.h?1:e.g?e.g.size:0}function iZ(e,t){return e.h?e.h==t:!!e.g&&e.g.has(t)}function i0(e,t){e.g?e.g.add(t):e.h=t}function i1(e,t){e.h&&e.h==t?e.h=null:e.g&&e.g.has(t)&&e.g.delete(t)}function i2(e){if(null!=e.h)return e.i.concat(e.h.F);if(null!=e.g&&0!==e.g.size){let t=e.i;for(let i of e.g.values())t=t.concat(i.F);return t}return e1(e.i)}iW.prototype.cancel=function(){if(this.i=i2(this),this.h)this.h.cancel(),this.h=null;else if(this.g&&0!==this.g.size){for(let e of this.g.values())e.cancel();this.g.clear()}};var i9=class{stringify(e){return eK.JSON.stringify(e,void 0)}parse(e){return eK.JSON.parse(e,void 0)}};function i4(){this.g=new i9}function i6(e,t,i,n,r){try{t.onload=null,t.onerror=null,t.onabort=null,t.ontimeout=null,r(n)}catch(e){}}function i5(e){this.l=e.fc||null,this.j=e.ob||!1}function i3(e,t){tP.call(this),this.F=e,this.u=t,this.m=void 0,this.readyState=i7,this.status=0,this.responseType=this.responseText=this.response=this.statusText="",this.onreadystatechange=null,this.v=new Headers,this.h=null,this.C="GET",this.B="",this.g=!1,this.A=this.j=this.l=null}eJ(i5,it),i5.prototype.g=function(){return new i3(this.l,this.j)},i5.prototype.i=(i={},function(){return i}),eJ(i3,tP);var i7=0;function i8(e){e.j.read().then(e.Xa.bind(e)).catch(e.ka.bind(e))}function ne(e){e.readyState=4,e.l=null,e.j=null,e.A=null,nt(e)}function nt(e){e.onreadystatechange&&e.onreadystatechange.call(e)}(ej=i3.prototype).open=function(e,t){if(this.readyState!=i7)throw this.abort(),Error("Error reopening a connection");this.C=e,this.B=t,this.readyState=1,nt(this)},ej.send=function(e){if(1!=this.readyState)throw this.abort(),Error("need to call open() first. ");this.g=!0;let t={headers:this.v,method:this.C,credentials:this.m,cache:void 0};e&&(t.body=e),(this.F||eK).fetch(new Request(this.B,t)).then(this.$a.bind(this),this.ka.bind(this))},ej.abort=function(){this.response=this.responseText="",this.v=new Headers,this.status=0,this.j&&this.j.cancel("Request was aborted.").catch(()=>{}),1<=this.readyState&&this.g&&4!=this.readyState&&(this.g=!1,ne(this)),this.readyState=i7},ej.$a=function(e){if(this.g&&(this.l=e,this.h||(this.status=this.l.status,this.statusText=this.l.statusText,this.h=e.headers,this.readyState=2,nt(this)),this.g&&(this.readyState=3,nt(this),this.g))){if("arraybuffer"===this.responseType)e.arrayBuffer().then(this.Ya.bind(this),this.ka.bind(this));else if(void 0!==eK.ReadableStream&&"body"in e){if(this.j=e.body.getReader(),this.u){if(this.responseType)throw Error('responseType must be empty for "streamBinaryChunks" mode responses.');this.response=[]}else this.response=this.responseText="",this.A=new TextDecoder;i8(this)}else e.text().then(this.Za.bind(this),this.ka.bind(this))}},ej.Xa=function(e){if(this.g){if(this.u&&e.value)this.response.push(e.value);else if(!this.u){var t=e.value?e.value:new Uint8Array(0);(t=this.A.decode(t,{stream:!e.done}))&&(this.response=this.responseText+=t)}e.done?ne(this):nt(this),3==this.readyState&&i8(this)}},ej.Za=function(e){this.g&&(this.response=this.responseText=e,ne(this))},ej.Ya=function(e){this.g&&(this.response=e,ne(this))},ej.ka=function(){this.g&&ne(this)},ej.setRequestHeader=function(e,t){this.v.append(e,t)},ej.getResponseHeader=function(e){return this.h&&this.h.get(e.toLowerCase())||""},ej.getAllResponseHeaders=function(){if(!this.h)return"";let e=[],t=this.h.entries();for(var i=t.next();!i.done;)e.push((i=i.value)[0]+": "+i[1]),i=t.next();return e.join("\r\n")},Object.defineProperty(i3.prototype,"withCredentials",{get:function(){return"include"===this.m},set:function(e){this.m=e?"include":"same-origin"}});var ni=eK.JSON.parse;function nn(e){tP.call(this),this.headers=new Map,this.u=e||null,this.h=!1,this.C=this.g=null,this.I="",this.m=0,this.j="",this.l=this.G=this.v=this.F=!1,this.B=0,this.A=null,this.K=nr,this.L=this.M=!1}eJ(nn,tP);var nr="",ns=/^https?$/i,na=["POST","PUT"];function no(e,t){e.h=!1,e.g&&(e.l=!0,e.g.abort(),e.l=!1),e.j=t,e.m=5,nl(e),nu(e)}function nl(e){e.F||(e.F=!0,tx(e,"complete"),tx(e,"error"))}function nh(e){if(e.h&&void 0!==ez&&(!e.C[1]||4!=nd(e)||2!=e.da())){if(e.v&&4==nd(e))tH(e.La,0,e);else if(tx(e,"readystatechange"),4==nd(e)){e.h=!1;try{let a=e.da();switch(a){case 200:case 201:case 202:case 204:case 206:case 304:case 1223:var t,i,n=!0;break;default:n=!1}if(!(t=n)){if(i=0===a){var r=String(e.I).match(iI)[1]||null;!r&&eK.self&&eK.self.location&&(r=eK.self.location.protocol.slice(0,-1)),i=!ns.test(r?r.toLowerCase():"")}t=i}if(t)tx(e,"complete"),tx(e,"success");else{e.m=6;try{var s=2<nd(e)?e.g.statusText:""}catch(e){s=""}e.j=s+" ["+e.da()+"]",nl(e)}}finally{nu(e)}}}}function nu(e,t){if(e.g){nc(e);let i=e.g,n=e.C[0]?()=>{}:null;e.g=null,e.C=null,t||tx(e,"ready");try{i.onreadystatechange=n}catch(e){}}}function nc(e){e.g&&e.L&&(e.g.ontimeout=null),e.A&&(eK.clearTimeout(e.A),e.A=null)}function nd(e){return e.g?e.g.readyState:0}function nf(e){try{if(!e.g)return null;if("response"in e.g)return e.g.response;switch(e.K){case nr:case"text":return e.g.responseText;case"arraybuffer":if("mozResponseArrayBuffer"in e.g)return e.g.mozResponseArrayBuffer}return null}catch(e){return null}}function nm(e){let t="";return ty(e,function(e,i){t+=i+":"+e+"\r\n"}),t}function np(e,t,i){e:{for(n in i){var n=!1;break e}n=!0}n||(i=nm(i),"string"==typeof e?null!=i&&encodeURIComponent(String(i)):iR(e,t,i))}function ng(e,t,i){return i&&i.internalChannelParams&&i.internalChannelParams[e]||t}function ny(e){this.Ga=0,this.j=[],this.l=new tJ,this.pa=this.wa=this.I=this.Y=this.g=this.Da=this.F=this.na=this.o=this.U=this.s=null,this.fb=this.W=0,this.cb=ng("failFast",!1,e),this.G=this.v=this.u=this.m=this.h=null,this.aa=!0,this.Fa=this.V=-1,this.ba=this.A=this.C=0,this.ab=ng("baseRetryDelayMs",5e3,e),this.hb=ng("retryDelaySeedMs",1e4,e),this.eb=ng("forwardChannelMaxRetries",2,e),this.xa=ng("forwardChannelRequestTimeoutMs",2e4,e),this.va=e&&e.xmlHttpFactory||void 0,this.Ha=e&&e.dc||!1,this.L=void 0,this.J=e&&e.supportsCrossDomainXhr||!1,this.K="",this.i=new iW(e&&e.concurrentRequestLimit),this.Ja=new i4,this.P=e&&e.fastHandshake||!1,this.O=e&&e.encodeInitMessageHeaders||!1,this.P&&this.O&&(this.O=!1),this.bb=e&&e.bc||!1,e&&e.Ea&&this.l.Ea(),e&&e.forceLongPolling&&(this.aa=!1),this.ca=!this.P&&this.aa&&e&&e.detectBufferingProxy||!1,this.qa=void 0,e&&e.longPollingTimeout&&0<e.longPollingTimeout&&(this.qa=e.longPollingTimeout),this.oa=void 0,this.S=0,this.M=!1,this.ma=this.B=null}function nv(e){if(nE(e),3==e.H){var t=e.W++,i=iD(e.I);if(iR(i,"SID",e.K),iR(i,"RID",t),iR(i,"TYPE","terminate"),nT(e,i),(t=new ih(e,e.l,t)).L=2,t.v=iP(iD(i)),i=!1,eK.navigator&&eK.navigator.sendBeacon)try{i=eK.navigator.sendBeacon(t.v.toString(),"")}catch(e){}!i&&eK.Image&&((new Image).src=t.v,i=!0),i||(t.g=nO(t.l,null),t.g.ha(t.v)),t.G=Date.now(),iw(t)}nP(e)}function nw(e){e.g&&(nA(e),e.g.cancel(),e.g=null)}function nE(e){nw(e),e.u&&(eK.clearTimeout(e.u),e.u=null),nN(e),e.i.cancel(),e.m&&("number"==typeof e.m&&eK.clearTimeout(e.m),e.m=null)}function nb(e){if(!iX(e.i)&&!e.m){e.m=!0;var t=e.Na;tU||tq(),tB||(tU(),tB=!0),tj.add(t,e),e.C=0}}function n_(e,t){var i;i=t?t.m:e.W++;let n=iD(e.I);iR(n,"SID",e.K),iR(n,"RID",i),iR(n,"AID",e.V),nT(e,n),e.o&&e.s&&np(n,e.o,e.s),i=new ih(e,e.l,i,e.C+1),null===e.o&&(i.I=e.s),t&&(e.j=t.F.concat(e.j)),t=nC(e,i,1e3),i.setTimeout(Math.round(.5*e.xa)+Math.round(.5*e.xa*Math.random())),i0(e.i,i),ip(i,n,t)}function nT(e,t){e.na&&ty(e.na,function(e,i){iR(t,i,e)}),e.h&&iS({},function(e,i){iR(t,i,e)})}function nC(e,t,i){i=Math.min(e.j.length,i);var n=e.h?eY(e.h.Va,e.h,e):null;e:{var r=e.j;let t=-1;for(;;){let e=["count="+i];-1==t?0<i?(t=r[0].g,e.push("ofs="+t)):t=0:e.push("ofs="+t);let s=!0;for(let a=0;a<i;a++){let i=r[a].g,o=r[a].map;if(0>(i-=t))t=Math.max(0,r[a].g-100),s=!1;else try{!function(e,t,i){let n=i||"";try{iS(e,function(e,i){let r=e;eG(e)&&(r=tM(e)),t.push(n+i+"="+encodeURIComponent(r))})}catch(e){throw t.push(n+"type="+encodeURIComponent("_badmap")),e}}(o,e,"req"+i+"_")}catch(e){n&&n(o)}}if(s){n=e.join("&");break e}}}return e=e.j.splice(0,i),t.F=e,n}function nS(e){if(!e.g&&!e.u){e.ba=1;var t=e.Ma;tU||tq(),tB||(tU(),tB=!0),tj.add(t,e),e.A=0}}function nI(e){return!e.g&&!e.u&&!(3<=e.A)&&(e.ba++,e.u=t7(eY(e.Ma,e),nL(e,e.A)),e.A++,!0)}function nA(e){null!=e.B&&(eK.clearTimeout(e.B),e.B=null)}function nD(e){e.g=new ih(e,e.l,"rpc",e.ba),null===e.o&&(e.g.I=e.s),e.g.O=0;var t=iD(e.wa);iR(t,"RID","rpc"),iR(t,"SID",e.K),iR(t,"AID",e.V),iR(t,"CI",e.G?"0":"1"),!e.G&&e.qa&&iR(t,"TO",e.qa),iR(t,"TYPE","xmlhttp"),nT(e,t),e.o&&e.s&&np(t,e.o,e.s),e.L&&e.g.setTimeout(e.L);var i=e.g;e=e.pa,i.L=1,i.v=iP(iD(t)),i.s=null,i.S=!0,ig(i,e)}function nN(e){null!=e.v&&(eK.clearTimeout(e.v),e.v=null)}function nk(e,t){var i=null;if(e.g==t){nN(e),nA(e),e.g=null;var n=2}else{if(!iZ(e.i,t))return;i=t.F,i1(e.i,t),n=1}if(0!=e.H){if(t.i){if(1==n){i=t.s?t.s.length:0,t=Date.now()-t.G;var r,s=e.C;tx(n=t2(),new t3(n,i)),nb(e)}else nS(e)}else if(3==(s=t.o)||0==s&&0<t.ca||!(1==n&&(r=t,!(iJ(e.i)>=e.i.j-(e.m?1:0))&&(e.m?(e.j=r.F.concat(e.j),!0):1!=e.H&&2!=e.H&&!(e.C>=(e.cb?0:e.eb))&&(e.m=t7(eY(e.Na,e,r),nL(e,e.C)),e.C++,!0)))||2==n&&nI(e)))switch(i&&0<i.length&&((t=e.i).i=t.i.concat(i)),s){case 1:nR(e,5);break;case 4:nR(e,10);break;case 3:nR(e,6);break;default:nR(e,2)}}}function nL(e,t){let i=e.ab+Math.floor(Math.random()*e.hb);return e.isActive()||(i*=2),i*t}function nR(e,t){if(e.l.info("Error code "+t),2==t){var i=null;e.h&&(i=null);var n=eY(e.pb,e);i||(i=new iA("//www.google.com/images/cleardot.gif"),eK.location&&"http"==eK.location.protocol||iN(i,"https"),iP(i)),function(e,t){let i=new tJ;if(eK.Image){let n=new Image;n.onload=eX(i6,i,n,"TestLoadImage: loaded",!0,t),n.onerror=eX(i6,i,n,"TestLoadImage: error",!1,t),n.onabort=eX(i6,i,n,"TestLoadImage: abort",!1,t),n.ontimeout=eX(i6,i,n,"TestLoadImage: timeout",!1,t),eK.setTimeout(function(){n.ontimeout&&n.ontimeout()},1e4),n.src=e}else t(!1)}(i.toString(),n)}else t5(2);e.H=0,e.h&&e.h.za(t),nP(e),nE(e)}function nP(e){if(e.H=0,e.ma=[],e.h){let t=i2(e.i);(0!=t.length||0!=e.j.length)&&(e2(e.ma,t),e2(e.ma,e.j),e.i.i.length=0,e1(e.j),e.j.length=0),e.h.ya()}}function nx(e,t,i){var n=i instanceof iA?iD(i):new iA(i);if(""!=n.g)t&&(n.g=t+"."+n.g),ik(n,n.m);else{var r=eK.location;n=r.protocol,t=t?t+"."+r.hostname:r.hostname,r=+r.port;var s=new iA(null);n&&iN(s,n),t&&(s.g=t),r&&ik(s,r),i&&(s.l=i),n=s}return i=e.F,t=e.Da,i&&t&&iR(n,i,t),iR(n,"VER",e.ra),nT(e,n),n}function nO(e,t,i){if(t&&!e.J)throw Error("Can't create secondary domain capable XhrIo object.");return(t=new nn(i&&e.Ha&&!e.va?new i5({ob:!0}):e.va)).Oa(e.J),t}function nM(){}function nF(){if(te&&!(10<=Number(tu)))throw Error("Environmental error: no available transport.")}function nV(e,t){tP.call(this),this.g=new ny(t),this.l=e,this.h=t&&t.messageUrlParams||null,e=t&&t.messageHeaders||null,t&&t.clientProtocolHeaderRequired&&(e?e["X-Client-Protocol"]="webchannel":e={"X-Client-Protocol":"webchannel"}),this.g.s=e,e=t&&t.initMessageHeaders||null,t&&t.messageContentType&&(e?e["X-WebChannel-Content-Type"]=t.messageContentType:e={"X-WebChannel-Content-Type":t.messageContentType}),t&&t.Ca&&(e?e["X-WebChannel-Client-Profile"]=t.Ca:e={"X-WebChannel-Client-Profile":t.Ca}),this.g.U=e,(e=t&&t.cc)&&!e6(e)&&(this.g.o=e),this.A=t&&t.supportsCrossDomainXhr||!1,this.v=t&&t.sendRawJson||!1,(t=t&&t.httpSessionIdParam)&&!e6(t)&&(this.g.F=t,null!==(e=this.h)&&t in e&&t in(e=this.h)&&delete e[t]),this.j=new nj(this)}function nU(e){ia.call(this),e.__headers__&&(this.headers=e.__headers__,this.statusCode=e.__status__,delete e.__headers__,delete e.__status__);var t=e.__sm__;if(t){e:{for(let i in t){e=i;break e}e=void 0}(this.i=e)&&(e=this.i,t=null!==t&&e in t?t[e]:void 0),this.data=t}else this.data=e}function nB(){io.call(this),this.status=1}function nj(e){this.g=e}function nq(){this.blockSize=-1,this.blockSize=64,this.g=[,,,,],this.m=Array(this.blockSize),this.i=this.h=0,this.reset()}function n$(e,t,i){i||(i=0);var n=Array(16);if("string"==typeof t)for(var r=0;16>r;++r)n[r]=t.charCodeAt(i++)|t.charCodeAt(i++)<<8|t.charCodeAt(i++)<<16|t.charCodeAt(i++)<<24;else for(r=0;16>r;++r)n[r]=t[i++]|t[i++]<<8|t[i++]<<16|t[i++]<<24;t=e.g[0],i=e.g[1],r=e.g[2];var s=e.g[3],a=t+(s^i&(r^s))+n[0]+3614090360&4294967295;a=s+(r^(t=i+(a<<7&4294967295|a>>>25))&(i^r))+n[1]+3905402710&4294967295,a=r+(i^(s=t+(a<<12&4294967295|a>>>20))&(t^i))+n[2]+606105819&4294967295,a=i+(t^(r=s+(a<<17&4294967295|a>>>15))&(s^t))+n[3]+3250441966&4294967295,a=t+(s^(i=r+(a<<22&4294967295|a>>>10))&(r^s))+n[4]+4118548399&4294967295,a=s+(r^(t=i+(a<<7&4294967295|a>>>25))&(i^r))+n[5]+1200080426&4294967295,a=r+(i^(s=t+(a<<12&4294967295|a>>>20))&(t^i))+n[6]+2821735955&4294967295,a=i+(t^(r=s+(a<<17&4294967295|a>>>15))&(s^t))+n[7]+4249261313&4294967295,a=t+(s^(i=r+(a<<22&4294967295|a>>>10))&(r^s))+n[8]+1770035416&4294967295,a=s+(r^(t=i+(a<<7&4294967295|a>>>25))&(i^r))+n[9]+2336552879&4294967295,a=r+(i^(s=t+(a<<12&4294967295|a>>>20))&(t^i))+n[10]+4294925233&4294967295,a=i+(t^(r=s+(a<<17&4294967295|a>>>15))&(s^t))+n[11]+2304563134&4294967295,a=t+(s^(i=r+(a<<22&4294967295|a>>>10))&(r^s))+n[12]+1804603682&4294967295,a=s+(r^(t=i+(a<<7&4294967295|a>>>25))&(i^r))+n[13]+4254626195&4294967295,a=r+(i^(s=t+(a<<12&4294967295|a>>>20))&(t^i))+n[14]+2792965006&4294967295,a=i+(t^(r=s+(a<<17&4294967295|a>>>15))&(s^t))+n[15]+1236535329&4294967295,i=r+(a<<22&4294967295|a>>>10),a=t+(r^s&(i^r))+n[1]+4129170786&4294967295,t=i+(a<<5&4294967295|a>>>27),a=s+(i^r&(t^i))+n[6]+3225465664&4294967295,s=t+(a<<9&4294967295|a>>>23),a=r+(t^i&(s^t))+n[11]+643717713&4294967295,r=s+(a<<14&4294967295|a>>>18),a=i+(s^t&(r^s))+n[0]+3921069994&4294967295,i=r+(a<<20&4294967295|a>>>12),a=t+(r^s&(i^r))+n[5]+3593408605&4294967295,t=i+(a<<5&4294967295|a>>>27),a=s+(i^r&(t^i))+n[10]+38016083&4294967295,s=t+(a<<9&4294967295|a>>>23),a=r+(t^i&(s^t))+n[15]+3634488961&4294967295,r=s+(a<<14&4294967295|a>>>18),a=i+(s^t&(r^s))+n[4]+3889429448&4294967295,i=r+(a<<20&4294967295|a>>>12),a=t+(r^s&(i^r))+n[9]+568446438&4294967295,t=i+(a<<5&4294967295|a>>>27),a=s+(i^r&(t^i))+n[14]+3275163606&4294967295,s=t+(a<<9&4294967295|a>>>23),a=r+(t^i&(s^t))+n[3]+4107603335&4294967295,r=s+(a<<14&4294967295|a>>>18),a=i+(s^t&(r^s))+n[8]+1163531501&4294967295,i=r+(a<<20&4294967295|a>>>12),a=t+(r^s&(i^r))+n[13]+2850285829&4294967295,t=i+(a<<5&4294967295|a>>>27),a=s+(i^r&(t^i))+n[2]+4243563512&4294967295,s=t+(a<<9&4294967295|a>>>23),a=r+(t^i&(s^t))+n[7]+1735328473&4294967295,r=s+(a<<14&4294967295|a>>>18),a=i+(s^t&(r^s))+n[12]+2368359562&4294967295,a=t+((i=r+(a<<20&4294967295|a>>>12))^r^s)+n[5]+4294588738&4294967295,a=s+((t=i+(a<<4&4294967295|a>>>28))^i^r)+n[8]+2272392833&4294967295,a=r+((s=t+(a<<11&4294967295|a>>>21))^t^i)+n[11]+1839030562&4294967295,a=i+((r=s+(a<<16&4294967295|a>>>16))^s^t)+n[14]+4259657740&4294967295,a=t+((i=r+(a<<23&4294967295|a>>>9))^r^s)+n[1]+2763975236&4294967295,a=s+((t=i+(a<<4&4294967295|a>>>28))^i^r)+n[4]+1272893353&4294967295,a=r+((s=t+(a<<11&4294967295|a>>>21))^t^i)+n[7]+4139469664&4294967295,a=i+((r=s+(a<<16&4294967295|a>>>16))^s^t)+n[10]+3200236656&4294967295,a=t+((i=r+(a<<23&4294967295|a>>>9))^r^s)+n[13]+681279174&4294967295,a=s+((t=i+(a<<4&4294967295|a>>>28))^i^r)+n[0]+3936430074&4294967295,a=r+((s=t+(a<<11&4294967295|a>>>21))^t^i)+n[3]+3572445317&4294967295,a=i+((r=s+(a<<16&4294967295|a>>>16))^s^t)+n[6]+76029189&4294967295,a=t+((i=r+(a<<23&4294967295|a>>>9))^r^s)+n[9]+3654602809&4294967295,a=s+((t=i+(a<<4&4294967295|a>>>28))^i^r)+n[12]+3873151461&4294967295,a=r+((s=t+(a<<11&4294967295|a>>>21))^t^i)+n[15]+530742520&4294967295,a=i+((r=s+(a<<16&4294967295|a>>>16))^s^t)+n[2]+3299628645&4294967295,i=r+(a<<23&4294967295|a>>>9),a=t+(r^(i|~s))+n[0]+4096336452&4294967295,t=i+(a<<6&4294967295|a>>>26),a=s+(i^(t|~r))+n[7]+1126891415&4294967295,s=t+(a<<10&4294967295|a>>>22),a=r+(t^(s|~i))+n[14]+2878612391&4294967295,r=s+(a<<15&4294967295|a>>>17),a=i+(s^(r|~t))+n[5]+4237533241&4294967295,i=r+(a<<21&4294967295|a>>>11),a=t+(r^(i|~s))+n[12]+1700485571&4294967295,t=i+(a<<6&4294967295|a>>>26),a=s+(i^(t|~r))+n[3]+2399980690&4294967295,s=t+(a<<10&4294967295|a>>>22),a=r+(t^(s|~i))+n[10]+4293915773&4294967295,r=s+(a<<15&4294967295|a>>>17),a=i+(s^(r|~t))+n[1]+2240044497&4294967295,i=r+(a<<21&4294967295|a>>>11),a=t+(r^(i|~s))+n[8]+1873313359&4294967295,t=i+(a<<6&4294967295|a>>>26),a=s+(i^(t|~r))+n[15]+4264355552&4294967295,s=t+(a<<10&4294967295|a>>>22),a=r+(t^(s|~i))+n[6]+2734768916&4294967295,r=s+(a<<15&4294967295|a>>>17),a=i+(s^(r|~t))+n[13]+1309151649&4294967295,i=r+(a<<21&4294967295|a>>>11),a=t+(r^(i|~s))+n[4]+4149444226&4294967295,t=i+(a<<6&4294967295|a>>>26),a=s+(i^(t|~r))+n[11]+3174756917&4294967295,s=t+(a<<10&4294967295|a>>>22),a=r+(t^(s|~i))+n[2]+718787259&4294967295,r=s+(a<<15&4294967295|a>>>17),a=i+(s^(r|~t))+n[9]+3951481745&4294967295,e.g[0]=e.g[0]+t&4294967295,e.g[1]=e.g[1]+(r+(a<<21&4294967295|a>>>11))&4294967295,e.g[2]=e.g[2]+r&4294967295,e.g[3]=e.g[3]+s&4294967295}function nz(e,t){this.h=t;for(var i=[],n=!0,r=e.length-1;0<=r;r--){var s=0|e[r];n&&s==t||(i[r]=s,n=!1)}this.g=i}(ej=nn.prototype).Oa=function(e){this.M=e},ej.ha=function(e,t,i,n){if(this.g)throw Error("[goog.net.XhrIo] Object is active with another request="+this.I+"; newUri="+e);t=t?t.toUpperCase():"GET",this.I=e,this.j="",this.m=0,this.F=!1,this.h=!0,this.g=this.u?this.u.g():s.g(),this.C=this.u?ii(this.u):ii(s),this.g.onreadystatechange=eY(this.La,this);try{this.G=!0,this.g.open(t,String(e),!0),this.G=!1}catch(e){no(this,e);return}if(e=i||"",i=new Map(this.headers),n){if(Object.getPrototypeOf(n)===Object.prototype)for(var r in n)i.set(r,n[r]);else if("function"==typeof n.keys&&"function"==typeof n.get)for(let e of n.keys())i.set(e,n.get(e));else throw Error("Unknown input type for opt_headers: "+String(n))}for(let[s,a]of(n=Array.from(i.keys()).find(e=>"content-type"==e.toLowerCase()),r=eK.FormData&&e instanceof eK.FormData,!(0<=e0(na,t))||n||r||i.set("Content-Type","application/x-www-form-urlencoded;charset=utf-8"),i))this.g.setRequestHeader(s,a);this.K&&(this.g.responseType=this.K),"withCredentials"in this.g&&this.g.withCredentials!==this.M&&(this.g.withCredentials=this.M);try{var a;nc(this),0<this.B&&((this.L=(a=this.g,te&&"number"==typeof a.timeout&&void 0!==a.ontimeout))?(this.g.timeout=this.B,this.g.ontimeout=eY(this.ua,this)):this.A=tH(this.ua,this.B,this)),this.v=!0,this.g.send(e),this.v=!1}catch(e){no(this,e)}},ej.ua=function(){void 0!==ez&&this.g&&(this.j="Timed out after "+this.B+"ms, aborting",this.m=8,tx(this,"timeout"),this.abort(8))},ej.abort=function(e){this.g&&this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1,this.m=e||7,tx(this,"complete"),tx(this,"abort"),nu(this))},ej.N=function(){this.g&&(this.h&&(this.h=!1,this.l=!0,this.g.abort(),this.l=!1),nu(this,!0)),nn.$.N.call(this)},ej.La=function(){this.s||(this.G||this.v||this.l?nh(this):this.kb())},ej.kb=function(){nh(this)},ej.isActive=function(){return!!this.g},ej.da=function(){try{return 2<nd(this)?this.g.status:-1}catch(e){return -1}},ej.ja=function(){try{return this.g?this.g.responseText:""}catch(e){return""}},ej.Wa=function(e){if(this.g){var t=this.g.responseText;return e&&0==t.indexOf(e)&&(t=t.substring(e.length)),ni(t)}},ej.Ia=function(){return this.m},ej.Sa=function(){return"string"==typeof this.j?this.j:String(this.j)},(ej=ny.prototype).ra=8,ej.H=1,ej.Na=function(e){if(this.m){if(this.m=null,1==this.H){if(!e){this.W=Math.floor(1e5*Math.random()),e=this.W++;let r=new ih(this,this.l,e),s=this.s;if(this.U&&(s?tE(s=tv(s),this.U):s=this.U),null!==this.o||this.O||(r.I=s,s=null),this.P)e:{for(var t=0,i=0;i<this.j.length;i++){t:{var n=this.j[i];if("__data__"in n.map&&"string"==typeof(n=n.map.__data__)){n=n.length;break t}n=void 0}if(void 0===n)break;if(4096<(t+=n)){t=i;break e}if(4096===t||i===this.j.length-1){t=i+1;break e}}t=1e3}else t=1e3;t=nC(this,r,t),iR(i=iD(this.I),"RID",e),iR(i,"CVER",22),this.F&&iR(i,"X-HTTP-Session-Id",this.F),nT(this,i),s&&(this.O?t="headers="+encodeURIComponent(String(nm(s)))+"&"+t:this.o&&np(i,this.o,s)),i0(this.i,r),this.bb&&iR(i,"TYPE","init"),this.P?(iR(i,"$req",t),iR(i,"SID","null"),r.aa=!0,ip(r,i,null)):ip(r,i,t),this.H=2}}else 3==this.H&&(e?n_(this,e):0==this.j.length||iX(this.i)||n_(this))}},ej.Ma=function(){if(this.u=null,nD(this),this.ca&&!(this.M||null==this.g||0>=this.S)){var e=2*this.S;this.l.info("BP detection timer enabled: "+e),this.B=t7(eY(this.jb,this),e)}},ej.jb=function(){this.B&&(this.B=null,this.l.info("BP detection timeout reached."),this.l.info("Buffering proxy detected and switch to long-polling!"),this.G=!1,this.M=!0,t5(10),nw(this),nD(this))},ej.ib=function(){null!=this.v&&(this.v=null,nw(this),nI(this),t5(19))},ej.pb=function(e){e?(this.l.info("Successfully pinged google.com"),t5(2)):(this.l.info("Failed to ping google.com"),t5(1))},ej.isActive=function(){return!!this.h&&this.h.isActive(this)},(ej=nM.prototype).Ba=function(){},ej.Aa=function(){},ej.za=function(){},ej.ya=function(){},ej.isActive=function(){return!0},ej.Va=function(){},nF.prototype.g=function(e,t){return new nV(e,t)},eJ(nV,tP),nV.prototype.m=function(){this.g.h=this.j,this.A&&(this.g.J=!0);var e=this.g,t=this.l,i=this.h||void 0;t5(0),e.Y=t,e.na=i||{},e.G=e.aa,e.I=nx(e,null,e.Y),nb(e)},nV.prototype.close=function(){nv(this.g)},nV.prototype.u=function(e){var t=this.g;if("string"==typeof e){var i={};i.__data__=e,e=i}else this.v&&((i={}).__data__=tM(e),e=i);t.j.push(new iQ(t.fb++,e)),3==t.H&&nb(t)},nV.prototype.N=function(){this.g.h=null,delete this.j,nv(this.g),delete this.g,nV.$.N.call(this)},eJ(nU,ia),eJ(nB,io),eJ(nj,nM),nj.prototype.Ba=function(){tx(this.g,"a")},nj.prototype.Aa=function(e){tx(this.g,new nU(e))},nj.prototype.za=function(e){tx(this.g,new nB)},nj.prototype.ya=function(){tx(this.g,"b")},eJ(nq,function(){this.blockSize=-1}),nq.prototype.reset=function(){this.g[0]=1732584193,this.g[1]=4023233417,this.g[2]=2562383102,this.g[3]=271733878,this.i=this.h=0},nq.prototype.j=function(e,t){void 0===t&&(t=e.length);for(var i=t-this.blockSize,n=this.m,r=this.h,s=0;s<t;){if(0==r)for(;s<=i;)n$(this,e,s),s+=this.blockSize;if("string"==typeof e){for(;s<t;)if(n[r++]=e.charCodeAt(s++),r==this.blockSize){n$(this,n),r=0;break}}else for(;s<t;)if(n[r++]=e[s++],r==this.blockSize){n$(this,n),r=0;break}}this.h=r,this.i+=t},nq.prototype.l=function(){var e=Array((56>this.h?this.blockSize:2*this.blockSize)-this.h);e[0]=128;for(var t=1;t<e.length-8;++t)e[t]=0;var i=8*this.i;for(t=e.length-8;t<e.length;++t)e[t]=255&i,i/=256;for(this.j(e),e=Array(16),t=i=0;4>t;++t)for(var n=0;32>n;n+=8)e[i++]=this.g[t]>>>n&255;return e};var nK={};function nH(e){return -128<=e&&128>e?Object.prototype.hasOwnProperty.call(nK,e)?nK[e]:nK[e]=new nz([0|e],0>e?-1:0):new nz([0|e],0>e?-1:0)}function nG(e){if(isNaN(e)||!isFinite(e))return nW;if(0>e)return n0(nG(-e));for(var t=[],i=1,n=0;e>=i;n++)t[n]=e/i|0,i*=nQ;return new nz(t,0)}var nQ=4294967296,nW=nH(0),nY=nH(1),nX=nH(16777216);function nJ(e){if(0!=e.h)return!1;for(var t=0;t<e.g.length;t++)if(0!=e.g[t])return!1;return!0}function nZ(e){return -1==e.h}function n0(e){for(var t=e.g.length,i=[],n=0;n<t;n++)i[n]=~e.g[n];return new nz(i,~e.h).add(nY)}function n1(e,t){return e.add(n0(t))}function n2(e,t){for(;(65535&e[t])!=e[t];)e[t+1]+=e[t]>>>16,e[t]&=65535,t++}function n9(e,t){this.g=e,this.h=t}function n4(e,t){if(nJ(t))throw Error("division by zero");if(nJ(e))return new n9(nW,nW);if(nZ(e))return t=n4(n0(e),t),new n9(n0(t.g),n0(t.h));if(nZ(t))return t=n4(e,n0(t)),new n9(n0(t.g),t.h);if(30<e.g.length){if(nZ(e)||nZ(t))throw Error("slowDivide_ only works with positive integers.");for(var i=nY,n=t;0>=n.X(e);)i=n6(i),n=n6(n);var r=n5(i,1),s=n5(n,1);for(n=n5(n,2),i=n5(i,2);!nJ(n);){var a=s.add(n);0>=a.X(e)&&(r=r.add(i),s=a),n=n5(n,1),i=n5(i,1)}return t=n1(e,r.R(t)),new n9(r,t)}for(r=nW;0<=e.X(t);){for(n=48>=(n=Math.ceil(Math.log(i=Math.max(1,Math.floor(e.ea()/t.ea())))/Math.LN2))?1:Math.pow(2,n-48),a=(s=nG(i)).R(t);nZ(a)||0<a.X(e);)i-=n,a=(s=nG(i)).R(t);nJ(s)&&(s=nY),r=r.add(s),e=n1(e,a)}return new n9(r,e)}function n6(e){for(var t=e.g.length+1,i=[],n=0;n<t;n++)i[n]=e.D(n)<<1|e.D(n-1)>>>31;return new nz(i,e.h)}function n5(e,t){var i=t>>5;t%=32;for(var n=e.g.length-i,r=[],s=0;s<n;s++)r[s]=0<t?e.D(s+i)>>>t|e.D(s+i+1)<<32-t:e.D(s+i);return new nz(r,e.h)}(ej=nz.prototype).ea=function(){if(nZ(this))return-n0(this).ea();for(var e=0,t=1,i=0;i<this.g.length;i++){var n=this.D(i);e+=(0<=n?n:nQ+n)*t,t*=nQ}return e},ej.toString=function(e){if(2>(e=e||10)||36<e)throw Error("radix out of range: "+e);if(nJ(this))return"0";if(nZ(this))return"-"+n0(this).toString(e);for(var t=nG(Math.pow(e,6)),i=this,n="";;){var r=n4(i,t).g,s=((0<(i=n1(i,r.R(t))).g.length?i.g[0]:i.h)>>>0).toString(e);if(nJ(i=r))return s+n;for(;6>s.length;)s="0"+s;n=s+n}},ej.D=function(e){return 0>e?0:e<this.g.length?this.g[e]:this.h},ej.X=function(e){return nZ(e=n1(this,e))?-1:nJ(e)?0:1},ej.abs=function(){return nZ(this)?n0(this):this},ej.add=function(e){for(var t=Math.max(this.g.length,e.g.length),i=[],n=0,r=0;r<=t;r++){var s=n+(65535&this.D(r))+(65535&e.D(r)),a=(s>>>16)+(this.D(r)>>>16)+(e.D(r)>>>16);n=a>>>16,s&=65535,a&=65535,i[r]=a<<16|s}return new nz(i,-2147483648&i[i.length-1]?-1:0)},ej.R=function(e){if(nJ(this)||nJ(e))return nW;if(nZ(this))return nZ(e)?n0(this).R(n0(e)):n0(n0(this).R(e));if(nZ(e))return n0(this.R(n0(e)));if(0>this.X(nX)&&0>e.X(nX))return nG(this.ea()*e.ea());for(var t=this.g.length+e.g.length,i=[],n=0;n<2*t;n++)i[n]=0;for(n=0;n<this.g.length;n++)for(var r=0;r<e.g.length;r++){var s=this.D(n)>>>16,a=65535&this.D(n),o=e.D(r)>>>16,l=65535&e.D(r);i[2*n+2*r]+=a*l,n2(i,2*n+2*r),i[2*n+2*r+1]+=s*l,n2(i,2*n+2*r+1),i[2*n+2*r+1]+=a*o,n2(i,2*n+2*r+1),i[2*n+2*r+2]+=s*o,n2(i,2*n+2*r+2)}for(n=0;n<t;n++)i[n]=i[2*n+1]<<16|i[2*n];for(n=t;n<2*t;n++)i[n]=0;return new nz(i,0)},ej.gb=function(e){return n4(this,e).h},ej.and=function(e){for(var t=Math.max(this.g.length,e.g.length),i=[],n=0;n<t;n++)i[n]=this.D(n)&e.D(n);return new nz(i,this.h&e.h)},ej.or=function(e){for(var t=Math.max(this.g.length,e.g.length),i=[],n=0;n<t;n++)i[n]=this.D(n)|e.D(n);return new nz(i,this.h|e.h)},ej.xor=function(e){for(var t=Math.max(this.g.length,e.g.length),i=[],n=0;n<t;n++)i[n]=this.D(n)^e.D(n);return new nz(i,this.h^e.h)},nF.prototype.createWebChannel=nF.prototype.g,nV.prototype.send=nV.prototype.u,nV.prototype.open=nV.prototype.m,nV.prototype.close=nV.prototype.close,t8.NO_ERROR=0,t8.TIMEOUT=8,t8.HTTP_ERROR=6,ie.COMPLETE="complete",ir.EventType=is,is.OPEN="a",is.CLOSE="b",is.ERROR="c",is.MESSAGE="d",tP.prototype.listen=tP.prototype.O,nn.prototype.listenOnce=nn.prototype.P,nn.prototype.getLastError=nn.prototype.Sa,nn.prototype.getLastErrorCode=nn.prototype.Ia,nn.prototype.getStatus=nn.prototype.da,nn.prototype.getResponseJson=nn.prototype.Wa,nn.prototype.getResponseText=nn.prototype.ja,nn.prototype.send=nn.prototype.ha,nn.prototype.setWithCredentials=nn.prototype.Oa,nq.prototype.digest=nq.prototype.l,nq.prototype.reset=nq.prototype.reset,nq.prototype.update=nq.prototype.j,nz.prototype.add=nz.prototype.add,nz.prototype.multiply=nz.prototype.R,nz.prototype.modulo=nz.prototype.gb,nz.prototype.compare=nz.prototype.X,nz.prototype.toNumber=nz.prototype.ea,nz.prototype.toString=nz.prototype.toString,nz.prototype.getBits=nz.prototype.D,nz.fromNumber=nG,nz.fromString=function e(t,i){if(0==t.length)throw Error("number format error: empty string");if(2>(i=i||10)||36<i)throw Error("radix out of range: "+i);if("-"==t.charAt(0))return n0(e(t.substring(1),i));if(0<=t.indexOf("-"))throw Error('number format error: interior "-" character');for(var n=nG(Math.pow(i,8)),r=nW,s=0;s<t.length;s+=8){var a=Math.min(8,t.length-s),o=parseInt(t.substring(s,s+a),i);8>a?(a=nG(Math.pow(i,a)),r=r.R(a).add(nG(o))):r=(r=r.R(n)).add(nG(o))}return r};var n3=e$.createWebChannelTransport=function(){return new nF},n7=e$.getStatEventTarget=function(){return t2()},n8=e$.ErrorCode=t8,re=e$.EventType=ie,rt=e$.Event=t0,ri=e$.Stat={xb:0,Ab:1,Bb:2,Ub:3,Zb:4,Wb:5,Xb:6,Vb:7,Tb:8,Yb:9,PROXY:10,NOPROXY:11,Rb:12,Nb:13,Ob:14,Mb:15,Pb:16,Qb:17,tb:18,sb:19,ub:20};e$.FetchXmlHttpFactory=i5;var rn=e$.WebChannel=ir,rr=e$.XhrIo=nn,rs=e$.Md5=nq,ra=e$.Integer=nz;const ro="@firebase/firestore";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ru=new J("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ry={// Causes are copied from:
...
e.enqueueRetryable(()=>t(rl.FIRST_PARTY))}shutdown(){}invalidateToken(){}}class rI{constructor(e){this.value=e,this.type="AppCheck",this.headers=new Map,e&&e.length>0&&this.headers.set("x-firebase-appcheck",this.value)}}class rA{constructor(e){this.A=e,this.forceRefresh=!1,this.appCheck=null,this.R=null}start(e,t){let i=e=>{null!=e.error&&rd("FirebaseAppCheckTokenProvider",`Error getting App Check token; using placeholder token instead. Error: ${e.error.message}`);let i=e.token!==this.R;return this.R=e.token,rd("FirebaseAppCheckTokenProvider",`Received ${i?"new":"existing"} token.`),i?t(e.token):Promise.resolve()};this.o=t=>{e.enqueueRetryable(()=>i(t))};let n=e=>{rd("FirebaseAppCheckTokenProvider","AppCheck detected"),this.appCheck=e,this.appCheck.addTokenListener(this.o)};this.A.onInit(e=>n(e)),// a chance to register itself with the component framework.
setTimeout(()=>{if(!this.appCheck){let e=this.A.getImmediate({optional:!0});e?n(e):rd("FirebaseAppCheckTokenProvider","AppCheck not yet detected")}},0)}getToken(){let e=this.forceRefresh;return this.forceRefresh=!1,this.appCheck?this.appCheck.getToken(e).then(e=>e?("string"==typeof e.token||rg(),this.R=e.token,new rI(e.token)):null):Promise.resolve(null)}invalidateToken(){this.forceRefresh=!0}shutdown(){this.appCheck&&this.appCheck.removeTokenListener(this.o)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
t.push(...i.split("/").filter(e=>e.length>0))}return new rx(t)}static emptyPath(){return new rx([])}}const rO=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
 * A dot-separated path for navigating sub-objects within a document.
 * @internal
 */class rM extends rP{construct(e,t,i){return new rM(e,t,i)}/**
 ...
 * Promises.
 */class rj{constructor(e){// NOTE: next/catchCallback will always point to our own wrapper functions,
...
this.nextCallback(e)},e=>{this.isDone=!0,this.error=e,this.catchCallback&&this.catchCallback(e)})}catch(e){return this.next(void 0,e)}next(e,t){return this.callbackAttached&&rg(),this.callbackAttached=!0,this.isDone?this.error?this.wrapFailure(t,this.error):this.wrapSuccess(e,this.result):new rj((i,n)=>{this.nextCallback=t=>{this.wrapSuccess(e,t).next(i,n)},this.catchCallback=e=>{this.wrapFailure(t,e).next(i,n)}})}toPromise(){return new Promise((e,t)=>{this.next(e,t)})}wrapUserFunction(e){try{let t=e();return t instanceof rj?t:rj.resolve(t)}catch(e){return rj.reject(e)}}wrapSuccess(e,t){return e?this.wrapUserFunction(()=>e(t)):rj.resolve(t)}wrapFailure(e,t){return e?this.wrapUserFunction(()=>e(t)):rj.reject(t)}static resolve(e){return new rj((t,i)=>{t(e)})}static reject(e){return new rj((t,i)=>{i(e)})}static waitFor(// eslint-disable-next-line @typescript-eslint/no-explicit-any
e){return new rj((t,i)=>{let n=0,r=0,s=!1;e.forEach(e=>{++n,e.next(()=>{++r,s&&r===n&&t()},e=>i(e))}),s=!0,r===n&&t()})}/**
     * Given an array of predicate functions that asynchronously evaluate to a
     * boolean, implements a short-circuiting `or` between the results. Predicates
     * will be evaluated until one of them returns `true`, then stop. The final
     * result will be whether any of them returned `true`.
     */static or(e){let t=rj.resolve(!1);for(let i of e)t=t.next(e=>e?rj.resolve(e):i());return t}static forEach(e,t){let i=[];return e.forEach((e,n)=>{i.push(t.call(this,e,n))}),this.waitFor(i)}/**
     * Concurrently map all array elements through asynchronous function.
     */static mapArray(e,t){return new rj((i,n)=>{let r=e.length,s=Array(r),a=0;for(let o=0;o<r;o++){let l=o;t(e[l]).next(e=>{s[l]=e,++a===r&&i(s)},e=>n(e))}})}/**
     * An alternative to recursive PersistencePromise calls, that avoids
     * potential memory problems from unbounded chains of promises.
     *
     * The `action` will be called repeatedly while `condition` is true.
     */static doWhile(e,t){return new rj((i,n)=>{let r=()=>{!0===e()?t().next(()=>{r()},n):i()};r()})}}/** Verifies whether `e` is an IndexedDbTransactionError. */function rq(e){// Use name equality, as instanceof checks on errors don't work with errors
 ...
 */class r${constructor(e,t){this.previousValue=e,t&&(t.sequenceNumberHandler=e=>this.oe(e),this._e=e=>t.writeSequenceNumber(e))}oe(e){return this.previousValue=Math.max(e,this.previousValue),this.previousValue}next(){let e=++this.previousValue;return this._e&&this._e(e),e}}/** Returns whether the value represents -0. */function rz(e){// Detect if the value is -0.0. Based on polyfill from
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function rK(e){let t=0;for(let i in e)Object.prototype.hasOwnProperty.call(e,i)&&t++;return t}function rH(e,t){for(let i in e)Object.prototype.hasOwnProperty.call(e,i)&&t(i,e[i])}r$.ae=-1;/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * limitations under the License.
 */// Visible for testing
class sP{constructor(e,t=null,i=[],n=[],r=null,s=null,a=null){this.path=e,this.collectionGroup=t,this.orderBy=i,this.filters=n,this.limit=r,this.startAt=s,this.endAt=a,this.he=null}}/**
 ...
 * property.
 */function sx(e,t=null,i=[],n=[],r=null,s=null,a=null){return new sP(e,t,i,n,r,s,a)}function sO(e){if(null===e.he){let t=e.path.canonicalString();null!==e.collectionGroup&&(t+="|cg:"+e.collectionGroup),t+="|f:"+e.filters.map(e=>(function e(t){if(t instanceof sb)// the same description, such as the int 3 and the string "3". So we should
 ...
 */function sj(e){return e.Ie||(e.Ie=/**
 * Converts this `Query` instance to its corresponding `Target` representation,
 * for use within an aggregate query. Unlike targets for non-aggregate queries,
 * aggregate query targets do not contain normalized order-bys, they only
 * contain explicit order-bys.
 */function(e,t){if("F"/* LimitType.First */===e.limitType)return sx(e.path,e.collectionGroup,t,e.filters,e.limit,e.startAt,e.endAt);{// Flip the orderBy directions since we want the last results
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const sW=new rG(rF.comparator),sY=new rG(rF.comparator);function sX(...e){let t=sY;for(let i of e)t=t.insert(i.key,i);return t}function sJ(){return new sQ(e=>e.toString(),(e,t)=>e.isEqual(t))}new rG(rF.comparator);const sZ=new rY(rF.comparator);function s0(...e){let t=sZ;for(let i of e)t=t.add(i);return t}const s1=new rY(rN);/**
 * @license
 * Copyright 2018 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function(e,t){if(e.useProto3Json){if(isNaN(t))return{doubleValue:"NaN"};if(t===1/0)return{doubleValue:"Infinity"};if(t===-1/0)return{doubleValue:"-Infinity"}}return{doubleValue:rz(t)?"-0":t}}(e.serializer,s)}(e,s))}return n}/** A mutation that deletes the document at the given key. */class ad extends an{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2/* MutationType.Delete */,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ay=new ra([4294967295,4294967295],0);// Hash a string using md5 hashing algorithm.
 ...
 */class aC{constructor(/** The new document applies to all of these targets. */e,/** The new document is removed from all of these targets. */t,/** The key of the document for this change. */i,/**
     ...
     */n){this.ge=e,this.removedTargetIds=t,this.key=i,this.pe=n}}class aS{constructor(e,t){this.targetId=e,this.ye=t}}class aI{constructor(/** What kind of change occurred to the watch target. */e,/** The target IDs that were added/removed/set. */t,/**
...
n.Be(t),this.Ue=this.Ue.insert(t,this.ct(t).delete(e)),i&&(this.$e=this.$e.insert(t,i))}removeTarget(e){this.Ke.delete(e)}/**
     ...
     * specified target.
     */ut(e,t){return this.Qe.getRemoteKeysForTarget(e).has(t)}}function aN(){return new rG(rF.comparator)}function ak(){return new rG(rF.comparator)}const aL={asc:"ASCENDING",desc:"DESCENDING"},aR={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},aP={and:"AND",or:"OR"};/**
 ...
 */class ax{constructor(e,t){this.databaseId=e,this.useProto3Json=t}}/**
 ...
 */function aO(e,t){return e.useProto3Json||null==t?t:{value:t}}function aM(e){return e||rg(),rR.fromTimestamp(function(e){let t=r2(e);return new rL(t.seconds,t.nanos)}(e))}function aF(e){let t=rx.fromString(e);return az(t)||rg(),t}function aV(e,t){let i=aF(t);if(i.get(1)!==e.databaseId.projectId)throw new rv(ry.INVALID_ARGUMENT,"Tried to deserialize key from different project: "+i.get(1)+" vs "+e.databaseId.projectId);if(i.get(3)!==e.databaseId.database)throw new rv(ry.INVALID_ARGUMENT,"Tried to deserialize key from different database: "+i.get(3)+" vs "+e.databaseId.database);return new rF(aj(i))}function aU(e,t){var i;return i=e.databaseId,new rx(["projects",i.projectId,"databases",i.database]).child("documents").child(t).canonicalString()}function aB(e){return new rx(["projects",e.databaseId.projectId,"databases",e.databaseId.database]).canonicalString()}function aj(e){return e.length>4&&"documents"===e.get(4)||rg(),e.popFirst(5)}function aq(e){return{fieldPath:e.canonicalString()}}function a$(e){return rM.fromServerFormat(e.fieldPath)}function az(e){// Resource names have at least 4 components (project ID, database ID)
 ...
 */class aK{constructor(/** The target being listened to. */e,/**
     * The target ID to which the target corresponds; Assigned by the
     * LocalStore for user listens and by the SyncEngine for limbo watches.
     */t,/** The purpose of the target. */i,/**
     * The sequence number of the last transaction during which this target data
     * was modified.
     */n,/** The latest snapshot version seen for this target. */r=rR.min(),s=rR.min(),a=r0.EMPTY_BYTE_STRING,o=null){this.target=e,this.targetId=t,this.purpose=i,this.sequenceNumber=n,this.snapshotVersion=r,this.lastLimboFreeSnapshotVersion=s,this.resumeToken=a,this.expectedCount=o}/** Creates a new target data instance with an updated sequence number. */withSequenceNumber(e){return new aK(this.target,this.targetId,this.purpose,e,this.snapshotVersion,this.lastLimboFreeSnapshotVersion,this.resumeToken,this.expectedCount)}/**
     * Creates a new target data instance with an updated resume token and
     * snapshot version.
     */withResumeToken(e,t){return new aK(this.target,this.targetId,this.purpose,this.sequenceNumber,t,this.lastLimboFreeSnapshotVersion,e,/* expectedCount= */null)}/**
     * Creates a new target data instance with an updated expected count.
     */withExpectedCount(e){return new aK(this.target,this.targetId,this.purpose,this.sequenceNumber,this.snapshotVersion,this.lastLimboFreeSnapshotVersion,this.resumeToken,e)}/**
     * Creates a new target data instance with an updated last limbo free
     * snapshot version number.
     */withLastLimboFreeSnapshotVersion(e){return new aK(this.target,this.targetId,this.purpose,this.sequenceNumber,this.snapshotVersion,e,this.resumeToken,this.expectedCount)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class aQ{constructor(){this.an=new aW}addToCollectionParentIndex(e,t){return this.an.add(t),rj.resolve()}getCollectionParents(e,t){return rj.resolve(this.an.getEntries(t))}addFieldIndex(e,t){// Field indices are not supported with memory persistence.
return rj.resolve()}deleteFieldIndex(e,t){// Field indices are not supported with memory persistence.
return rj.resolve()}deleteAllFieldIndexes(e){// Field indices are not supported with memory persistence.
return rj.resolve()}createTargetIndexes(e,t){// Field indices are not supported with memory persistence.
return rj.resolve()}getDocumentsMatchingTarget(e,t){// Field indices are not supported with memory persistence.
return rj.resolve(null)}getIndexType(e,t){// Field indices are not supported with memory persistence.
return rj.resolve(0/* IndexType.NONE */)}getFieldIndexes(e,t){// Field indices are not supported with memory persistence.
return rj.resolve([])}getNextCollectionGroupToUpdate(e){// Field indices are not supported with memory persistence.
return rj.resolve(null)}getMinOffset(e,t){return rj.resolve(rV.min())}getMinOffsetFromCollectionGroup(e,t){return rj.resolve(rV.min())}updateCollectionGroup(e,t,i){// Field indices are not supported with memory persistence.
return rj.resolve()}updateIndexEntries(e,t){// Field indices are not supported with memory persistence.
return rj.resolve()}}/**
 * Internal implementation of the collection-parent index exposed by MemoryIndexManager.
 * Also used for in-memory caching by IndexedDbIndexManager and initial index population
 * in indexeddb_schema.ts
 */class aW{constructor(){this.index={}}// Returns false if the entry already existed.
add(e){let t=e.lastSegment(),i=e.popLast(),n=this.index[t]||new rY(rx.comparator),r=!n.has(i);return this.index[t]=n.add(i),r}has(e){let t=e.lastSegment(),i=e.popLast(),n=this.index[t];return n&&n.has(i)}getEntries(e){return(this.index[e]||new rY(rx.comparator)).toArray()}}new Uint8Array(0);class aY{constructor(// threshold. Passing `COLLECTION_DISABLED` here will cause collection to always be skipped.
...
this.changes=new sQ(e=>e.toString(),(e,t)=>e.isEqual(t)),this.changesApplied=!1}/**
     ...
     * cached.
     */getEntry(e,t){this.assertNotApplied();let i=this.changes.get(t);return void 0!==i?rj.resolve(i):this.getFromCache(e,t)}/**
...
// already saved.
for(;a.hasNext();){let n=a.getNext(),o=n.key,l=n.value,h=sJ();l.forEach(e=>{if(!r.has(e)){let n=ar(t.get(e),i.get(e));null!==n&&h.set(e,n),r=r.add(e)}}),s.push(this.documentOverlayCache.saveOverlays(e,o,h))}return rj.waitFor(s)}).next(()=>i)}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class a1{constructor(e){this.serializer=e,this.lr=new Map,this.hr=new Map}getBundleMetadata(e,t){return rj.resolve(this.lr.get(t))}saveBundleMetadata(e,t){return this.lr.set(t.id,{id:t.id,version:t.version,createTime:aM(t.createTime)}),rj.resolve()}getNamedQuery(e,t){return rj.resolve(this.hr.get(t))}saveNamedQuery(e,t){return this.hr.set(t.name,{name:t.name,query:/**
...
this.overlays=new rG(rF.comparator),this.Pr=new Map}getOverlay(e,t){return rj.resolve(this.overlays.get(t))}getOverlays(e,t){let i=sJ();return rj.forEach(t,t=>this.getOverlay(e,t).next(e=>{null!==e&&i.set(t,e)})).next(()=>i)}saveOverlays(e,t,i){return i.forEach((i,n)=>{this.It(e,t,n)}),rj.resolve()}removeOverlaysForBatchId(e,t,i){let n=this.Pr.get(i);return void 0!==n&&(n.forEach(e=>this.overlays=this.overlays.remove(e)),this.Pr.delete(i)),rj.resolve()}getOverlaysForCollection(e,t,i){let n=sJ(),r=t.length+1,s=new rF(t.child("")),a=this.overlays.getIteratorFrom(s);for(;a.hasNext();){let e=a.getNext().value,s=e.getKey();if(!t.isPrefixOf(s.path))break;// Documents from sub-collections
s.path.length===r&&e.largestBatchId>i&&n.set(e.getKey(),e)}return rj.resolve(n)}getOverlaysForCollectionGroup(e,t,i,n){let r=new rG((e,t)=>e-t),s=this.overlays.getIterator();for(;s.hasNext();){let e=s.getNext().value;if(e.getKey().getCollectionGroup()===t&&e.largestBatchId>i){let t=r.get(e.largestBatchId);null===t&&(t=sJ(),r=r.insert(e.largestBatchId,t)),t.set(e.getKey(),e)}}let a=sJ(),o=r.getIterator();for(;o.hasNext()&&(o.getNext().value.forEach((e,t)=>a.set(e,t)),!(a.size()>=n)););return rj.resolve(a)}It(e,t,i){// Remove the association of the overlay to its batch id.
...
this.Ir=new rY(a4.dr),this.Tr=new rY(a4.Er)}/** Returns true if the reference set contains no references. */isEmpty(){return this.Ir.isEmpty()}/** Adds a reference to the given document key for the given ID. */addReference(e,t){let i=new a4(e,t);this.Ir=this.Ir.add(i),this.Tr=this.Tr.add(i)}/** Add references to the given document keys for the given ID. */Ar(e,t){e.forEach(e=>this.addReference(e,t))}/**
     ...
     * removed.
     */mr(e){let t=new rF(new rx([])),i=new a4(t,e),n=new a4(t,e+1),r=[];return this.Tr.forEachInRange([i,n],e=>{this.Rr(e),r.push(e.key)}),r}gr(){this.Ir.forEach(e=>this.Rr(e))}Rr(e){this.Ir=this.Ir.delete(e),this.Tr=this.Tr.delete(e)}pr(e){let t=new rF(new rx([])),i=new a4(t,e),n=new a4(t,e+1),r=s0();return this.Tr.forEachInRange([i,n],e=>{r=r.add(e.key)}),r}containsKey(e){let t=new a4(e,0),i=this.Ir.firstAfterOrEqual(t);return null!==i&&e.isEqual(i.key)}}class a4{constructor(e,t){this.key=e,this.yr=t}/** Compare by key then by ID */static dr(e,t){return rF.comparator(e.key,t.key)||rN(e.yr,t.yr)}/** Compare by ID then by key */static Er(e,t){return rN(e.yr,t.yr)||rF.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
// start of the queue.
return rj.resolve(this.mutationQueue.length>n?this.mutationQueue[n]:null)}getHighestUnacknowledgedBatchId(){return rj.resolve(0===this.mutationQueue.length?-1:this.wr-1)}getAllMutationBatches(e){return rj.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){let i=new a4(t,0),n=new a4(t,Number.POSITIVE_INFINITY),r=[];return this.Sr.forEachInRange([i,n],e=>{let t=this.br(e.yr);r.push(t)}),rj.resolve(r)}getAllMutationBatchesAffectingDocumentKeys(e,t){let i=new rY(rN);return t.forEach(e=>{let t=new a4(e,0),n=new a4(e,Number.POSITIVE_INFINITY);this.Sr.forEachInRange([t,n],e=>{i=i.add(e.yr)})}),rj.resolve(this.Cr(i))}getAllMutationBatchesAffectingQuery(e,t){// Use the query path as a prefix for testing if a document matches the
// query.
...
// ancestor queries.
(t.length===n&&(a=a.add(e.yr)),!0)},s),rj.resolve(this.Cr(a))}Cr(e){// Construct an array of matching batches, sorted by batchID to ensure that
// multiple mutations affecting the same document key are applied in order.
let t=[];return e.forEach(e=>{let i=this.br(e);null!==i&&t.push(i)}),t}removeMutationBatch(e,t){0===this.vr(t.batchId,"removed")||rg(),this.mutationQueue.shift();let i=this.Sr;return rj.forEach(t.mutations,n=>{let r=new a4(n.key,t.batchId);return i=i.delete(r),this.referenceDelegate.markPotentiallyOrphaned(e,n.key)}).next(()=>{this.Sr=i})}xn(e){// No-op since the memory mutation queue does not maintain a separate cache.
}containsKey(e,t){let i=new a4(t,0),n=this.Sr.firstAfterOrEqual(i);return rj.resolve(t.isEqual(n&&n.key))}performConsistencyCheck(e){return this.mutationQueue.length,rj.resolve()}/**
 ...
 */class a3 extends aJ{constructor(e){super(),this.ur=e}applyChanges(e){let t=[];return this.changes.forEach((i,n)=>{n.isValidDocument()?t.push(this.ur.addEntry(e,n)):this.ur.removeEntry(i)}),rj.waitFor(t)}getFromCache(e,t){return this.ur.getEntry(e,t)}getAllFromCache(e,t){return this.ur.getEntries(e,t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class a7{constructor(e){this.persistence=e,/**
         ...
         * IDs.
         */this.Br=new a9,this.targetCount=0,this.Lr=aX.Bn()}forEachTarget(e,t){return this.Or.forEach((e,i)=>t(i)),rj.resolve()}getLastRemoteSnapshotVersion(e){return rj.resolve(this.lastRemoteSnapshotVersion)}getHighestSequenceNumber(e){return rj.resolve(this.Nr)}allocateTargetId(e){return this.highestTargetId=this.Lr.next(),rj.resolve(this.highestTargetId)}setTargetsMetadata(e,t,i){return i&&(this.lastRemoteSnapshotVersion=i),t>this.Nr&&(this.Nr=t),rj.resolve()}Qn(e){this.Or.set(e.target,e);let t=e.targetId;t>this.highestTargetId&&(this.Lr=new aX(t),this.highestTargetId=t),e.sequenceNumber>this.Nr&&(this.Nr=e.sequenceNumber)}addTargetData(e,t){return this.Qn(t),this.targetCount+=1,rj.resolve()}updateTargetData(e,t){return this.Qn(t),rj.resolve()}removeTargetData(e,t){return this.Or.delete(t.target),this.Br.mr(t.targetId),this.targetCount-=1,rj.resolve()}removeTargets(e,t,i){let n=0,r=[];return this.Or.forEach((s,a)=>{a.sequenceNumber<=t&&null===i.get(a.targetId)&&(this.Or.delete(s),r.push(this.removeMatchingKeysForTargetId(e,a.targetId)),n++)}),rj.waitFor(r).next(()=>n)}getTargetCount(e){return rj.resolve(this.targetCount)}getTargetData(e,t){let i=this.Or.get(t)||null;return rj.resolve(i)}addMatchingKeys(e,t,i){return this.Br.Ar(t,i),rj.resolve()}removeMatchingKeys(e,t,i){this.Br.Vr(t,i);let n=this.persistence.referenceDelegate,r=[];return n&&t.forEach(t=>{r.push(n.markPotentiallyOrphaned(e,t))}),rj.waitFor(r)}removeMatchingKeysForTargetId(e,t){return this.Br.mr(t),rj.resolve()}getMatchingKeysForTargetId(e,t){let i=this.Br.pr(t);return rj.resolve(i)}containsKey(e,t){return rj.resolve(this.Br.containsKey(t))}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
let r={result:null};return this.Hi(e,t).next(e=>{r.result=e}).next(()=>{if(!r.result)return this.Ji(e,t,n,i).next(e=>{r.result=e})}).next(()=>{if(r.result)return;let i=new on;return this.Yi(e,t,i).next(n=>{if(r.result=n,this.Wi)return this.Zi(e,t,i,n.size)})}).next(()=>r.result)}Zi(e,t,i,n){return i.documentReadCount<this.Gi?(rc()<=eB.DEBUG&&rd("QueryEngine","SDK will not create cache indexes for query:",sK(t),"since it only creates cache indexes for collection contains","more than or equal to",this.Gi,"documents"),rj.resolve()):(rc()<=eB.DEBUG&&rd("QueryEngine","Query:",sK(t),"scans",i.documentReadCount,"local documents and returns",n,"documents as results."),i.documentReadCount>this.zi*n?(rc()<=eB.DEBUG&&rd("QueryEngine","The SDK decides to create cache indexes for query:",sK(t),"as using cache indexes may help improve performance."),this.indexManager.createTargetIndexes(e,sj(t))):rj.resolve())}/**
     * Performs an indexed query that evaluates the query based on a collection's
     * persisted index values. Returns `null` if an index is not available.
     */Hi(e,t){if(sU(t))// key-based lookups. It is more efficient to scan all documents in a
// collection, rather than to perform individual lookups.
return rj.resolve(null);let i=sj(t);return this.indexManager.getIndexType(e,i).next(n=>0/* IndexType.NONE */===n?null:(null!==t.limit&&1/* IndexType.PARTIAL */===n&&(i=sj(// We cannot apply a limit for targets that are served using a partial
    ...
    t=sq(t,null,"F"/* LimitType.First */))),this.indexManager.getDocumentsMatchingTarget(e,i).next(n=>{let r=s0(...n);return this.ji.getDocuments(e,r).next(n=>this.indexManager.getMinOffset(e,i).next(i=>{let s=this.Xi(t,n);return this.es(t,s,r,i.readTime)?this.Hi(e,sq(t,null,"F"/* LimitType.First */)):this.ts(e,s,t,i)}))})))}/**
     * Performs a query based on the target's persisted query mapping. Returns
     * `null` if the mapping is not available or cannot be used.
     */Ji(e,t,i,n){return sU(t)||n.isEqual(rR.min())?rj.resolve(null):this.ji.getDocuments(e,i).next(r=>{let s=this.Xi(t,r);return this.es(t,s,i,n)?rj.resolve(null):(rc()<=eB.DEBUG&&rd("QueryEngine","Re-using previous result from %s to execute query: %s",n.toString(),sK(t)),this.ts(e,s,t,/**
...
let r="F"/* LimitType.First */===e.limitType?t.last():t.first();return!!r&&(r.hasPendingWrites||r.version.compareTo(n)>0)}Yi(e,t,i){return rc()<=eB.DEBUG&&rd("QueryEngine","Using full collection scan to execute query:",sK(t)),this.ji.getDocumentsMatchingQuery(e,t,rV.min(),i)}/**
...
async function ol(e,t,i){let n=e.rs.get(t);try{i||await e.persistence.runTransaction("Release target",i?"readwrite":"readwrite-primary",t=>e.persistence.referenceDelegate.removeTarget(t,n))}catch(e){if(!rq(e))throw e;// All `releaseTarget` does is record the final metadata state for the
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ov="WebChannelConnection";class ow extends /**
...
let r={structuredQuery:{}},s=t.path;null!==t.collectionGroup?(r.parent=aU(e,s),r.structuredQuery.from=[{collectionId:t.collectionGroup,allDescendants:!0}]):(r.parent=aU(e,s.popLast()),r.structuredQuery.from=[{collectionId:s.lastSegment()}]);let a=function(e){if(0!==e.length)return function e(t){return t instanceof sb?function(e){if("=="/* Operator.EQUAL */===e.op){if(su(e.value))return{unaryFilter:{field:aq(e.field),op:"IS_NAN"}};if(sh(e.value))return{unaryFilter:{field:aq(e.field),op:"IS_NULL"}}}else if("!="/* Operator.NOT_EQUAL */===e.op){if(su(e.value))return{unaryFilter:{field:aq(e.field),op:"IS_NOT_NAN"}};if(sh(e.value))return{unaryFilter:{field:aq(e.field),op:"IS_NOT_NULL"}}}return{fieldFilter:{field:aq(e.field),op:aR[e.op],value:e.value}}}(t):t instanceof s_?function(t){let i=t.getFilters().map(t=>e(t));return 1===i.length?i[0]:{compositeFilter:{op:aP[t.op],filters:i}}}(t):rg()}(s_.create(e,"and"/* CompositeOperator.AND */))}(t.filters);a&&(r.structuredQuery.where=a);let o=function(e){if(0!==e.length)return e.map(e=>({field:aq(e.field),direction:aL[e.dir]}))}(t.orderBy);o&&(r.structuredQuery.orderBy=o);let l=aO(e,t.limit);return null!==l&&(r.structuredQuery.limit=l),t.startAt&&(r.structuredQuery.startAt={before:(i=t.startAt).inclusive,values:i.position}),t.endAt&&(r.structuredQuery.endAt={before:!(n=t.endAt).inclusive,values:n.position}),r}(e,s)}).targetId=t.targetId,t.resumeToken.approximateByteSize()>0){r.resumeToken=(i=t.resumeToken,e.useProto3Json?i.toBase64():i.toUint8Array());let n=aO(e,t.expectedCount);null!==n&&(r.expectedCount=n)}else if(t.snapshotVersion.compareTo(rR.min())>0){// TODO(wuandy): Consider removing above check because it is most likely true.
 ...
 */class oS{constructor(e,t){this.asyncQueue=e,this.onlineStateHandler=t,/** The current OnlineState. */this.state="Unknown"/* OnlineState.Unknown */,/**
...
(e.v_.set(t.targetId,t),ox(e)?oP(e):oq(e).Yo()&&oL(e,t))}/**
 * Removes the listen from server. It is a no-op if the given target id is
 * not being listened to.
 */function ok(e,t){let i=oq(e);e.v_.delete(t),i.Yo()&&oR(e,t),0===e.v_.size&&(i.Yo()?i.e_():oO(e)&&// Revert to OnlineState.Unknown if the watch stream is not open and we
// have no listeners, since without any listens to send we cannot
// confirm if the stream is healthy and upgrade to OnlineState.Online.
e.O_.set("Unknown"/* OnlineState.Unknown */))}/**
 * We need to increment the the expected number of pending responses we're due
 * from watch so we wait for the ack to process any messages from this target.
 */function oL(e,t){if(e.N_.Le(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(rR.min())>0){let i=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(i)}oq(e).l_(t)}/**
 * We need to increment the expected number of pending responses we're due
 * from watch so we wait for the removal on the server before we process any
 * messages from this target.
 */function oR(e,t){e.N_.Le(t),oq(e).h_(t)}function oP(e){e.N_=new aD({getRemoteKeysForTarget:t=>e.remoteSyncer.getRemoteKeysForTarget(t),lt:t=>e.v_.get(t)||null,st:()=>e.datastore.serializer.databaseId}),oq(e).start(),e.O_.y_()}/**
 * Returns whether the watch stream should be started because it's necessary
 * and has not yet been started.
 */function ox(e){return oO(e)&&!oq(e).Jo()&&e.v_.size>0}function oO(e){return 0===e.F_.size}async function oM(e){e.v_.forEach((t,i)=>{oL(e,t)})}async function oF(e,t){e.N_=void 0,ox(e)?(e.O_.b_(t),oP(e)):// The online state is set to unknown because there is no active attempt
// at establishing a connection
e.O_.set("Unknown"/* OnlineState.Unknown */)}async function oV(e,t,i){if(e.O_.set("Online"/* OnlineState.Online */),t instanceof aI&&2/* WatchTargetChangeState.Removed */===t.state&&t.cause)// to raise events
try{await /** Handles an error on a target */async function(e,t){let i=t.cause;for(let n of t.targetIds)e.v_.has(n)&&(await e.remoteSyncer.rejectListen(n,i),e.v_.delete(n),e.N_.removeTarget(n))}(e,t)}catch(i){rd("RemoteStore","Failed to remove targets %s: %s ",t.targetIds.join(","),i),await oU(e,i)}else if(t instanceof aC?e.N_.Ge(t):t instanceof aS?e.N_.Xe(t):e.N_.He(t),!i.isEqual(rR.min()))try{let t=await oo(e.localStore);i.compareTo(t)>=0&&// We have received a target change with a global snapshot if the snapshot
...
let r=new aK(n.target,t,i,n.sequenceNumber);oL(e,r)}),e.remoteSyncer.applyRemoteEvent(i)}(e,i)}catch(t){rd("RemoteStore","Failed to raise snapshot:",t),await oU(e,t)}}/**
 ...
 * any retry attempt.
 */async function oU(e,t,i){if(!rq(t))throw t;e.F_.add(1/* OfflineCause.IndexedDbFailed */),await oD(e),e.O_.set("Offline"/* OnlineState.Offline */),i||// Use a simple read operation to determine if IndexedDB recovered.
 ...
 */async function oj(e,t){t?(e.F_.delete(2/* OfflineCause.IsSecondary */),await oA(e)):t||(e.F_.add(2/* OfflineCause.IsSecondary */),await oD(e),e.O_.set("Unknown"/* OnlineState.Unknown */))}/**
 ...
 */function oq(e){var t,i,n;return e.B_||// Create stream (but note that it is not started yet).
(e.B_=(t=e.datastore,i=e.asyncQueue,n={Io:oM.bind(null,e),Eo:oF.bind(null,e),c_:oV.bind(null,e)},t.V_(),new oT(i,t.connection,t.authCredentials,t.appCheckCredentials,t.serializer,n)),e.M_.push(async t=>{t?(e.B_.Xo(),ox(e)?oP(e):e.O_.set("Unknown"/* OnlineState.Unknown */)):(await e.B_.stop(),e.N_=void 0)})),e.B_}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function oz(e,t){if(rf("AsyncQueue",`${t}: ${e}`),rq(e))return new rv(ry.UNAVAILABLE,`${t}: ${e}`);throw e}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * the key.
 */class oK{/** The default ordering is by key if the comparator is omitted */constructor(e){// We are adding document key comparator to the end as it's the only
...
this.comparator=e?(t,i)=>e(t,i)||rF.comparator(t.key,i.key):(e,t)=>rF.comparator(e.key,t.key),this.keyedMap=sX(),this.sortedSet=new rG(this.comparator)}/**
     ...
     * comparator.
     */static emptySet(e){return new oK(e.comparator)}has(e){return null!=this.keyedMap.get(e)}get(e){return this.keyedMap.get(e)}first(){return this.sortedSet.minKey()}last(){return this.sortedSet.maxKey()}isEmpty(){return this.sortedSet.isEmpty()}/**
...
// Metadata->Added
// Removed->Metadata
rg():this.k_=this.k_.insert(t,e)}q_(){let e=[];return this.k_.inorderTraversal((t,i)=>{e.push(i)}),e}}class oG{constructor(e,t,i,n,r,s,a,o,l){this.query=e,this.docs=t,this.oldDocs=i,this.docChanges=n,this.mutatedKeys=r,this.fromCache=s,this.syncStateChanged=a,this.excludesMetadataChanges=o,this.hasCachedResults=l}/** Returns a view snapshot as if all documents in the snapshot were added. */static fromInitialDocuments(e,t,i,n,r){let s=[];return t.forEach(e=>{s.push({type:0/* ChangeType.Added */,doc:e})}),new oG(e,t,oK.emptySet(t),s,i,n,/* syncStateChanged= */!0,/* excludesMetadataChanges= */!1,r)}get hasPendingWrites(){return!this.mutatedKeys.isEmpty()}isEqual(e){if(!(this.fromCache===e.fromCache&&this.hasCachedResults===e.hasCachedResults&&this.syncStateChanged===e.syncStateChanged&&this.mutatedKeys.isEqual(e.mutatedKeys)&&s$(this.query,e.query)&&this.docs.isEqual(e.docs)&&this.oldDocs.isEqual(e.oldDocs)))return!1;let t=this.docChanges,i=e.docChanges;if(t.length!==i.length)return!1;for(let e=0;e<t.length;e++)if(t[e].type!==i[e].type||!t[e].doc.isEqual(i[e].doc))return!1;return!0}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */class o4{constructor(e,/** Documents included in the remote target */t){this.query=e,this.oa=t,this._a=null,this.hasCachedResults=!1,/**
         ...
         * filter mismatch).
         */this.current=!1,/** Documents in the view but not in the remote target */this.aa=s0(),/** Document Keys that have local changes */this.mutatedKeys=s0(),this.ua=sG(e),this.ca=new oK(this.ua)}/**
 ...
 * This is useful to implement optional features (like bundles) in free
 * functions, such that they are tree-shakeable.
 */class o3{constructor(e,t,i,n,r,s){this.localStore=e,this.remoteStore=t,this.eventManager=i,this.sharedClientState=n,this.currentUser=r,this.maxConcurrentLimboResolutions=s,this.fa={},this.ga=new sQ(e=>sz(e),s$),this.pa=new Map,/**
...
r=o.targetId,a.sharedClientState.addLocalQueryTarget(r),s=o.view.Va();else{let e=await (i=a.localStore,n=sj(t),i.persistence.runTransaction("Allocate target","readwrite",e=>{let t;return i.Kr.getTargetData(e,n).next(r=>r?// previous targetID.
    // TODO(mcg): freshen last accessed date?
    (t=r,rj.resolve(t)):i.Kr.allocateTargetId(e).next(r=>(t=new aK(n,r,"TargetPurposeListen"/* TargetPurpose.Listen */,e.currentSequenceNumber),i.Kr.addTargetData(e,t).next(()=>t))))}).then(e=>{// If Multi-Tab is enabled, the existing target data may be newer than
// the in-memory data
 ...
 */function lo(e){for(;e.ya.size>0&&e.wa.size<e.maxConcurrentLimboResolutions;){var t;let i=e.ya.values().next().value;e.ya.delete(i);let n=new rF(rx.fromString(i)),r=e.va.next();e.Sa.set(r,new o5(n)),e.wa=e.wa.insert(n,r),oN(e.remoteStore,new aK(sj((t=n.path,new sV(t))),r,"TargetPurposeLimboResolution"/* TargetPurpose.LimboResolution */,r$.ae))}}async function ll(e,t,i){let n=[],r=[],s=[];e.ga.isEmpty()||(e.ga.forEach((a,o)=>{s.push(e.Ma(o,t,i).then(t=>{// Update views if there are actual changes.
if(// secondary clients to update query state.
(t||i)&&e.isPrimaryClient&&e.sharedClientState.updateQueryState(o.targetId,(null==t?void 0:t.fromCache)?"not-current":"current"),t){n.push(t);let e=oi.$i(o.targetId,t);r.push(e)}}))}),await Promise.all(s),e.fa.c_(n),await async function(e,t){try{await e.persistence.runTransaction("notifyLocalViewChanges","readwrite",i=>rj.forEach(t,t=>rj.forEach(t.Qi,n=>e.persistence.referenceDelegate.addReference(i,t.targetId,n)).next(()=>rj.forEach(t.Ki,n=>e.persistence.referenceDelegate.removeReference(i,t.targetId,n)))))}catch(e){if(!rq(e))throw e;// If `notifyLocalViewChanges` fails, we did not advance the sequence
 ...
 */class lI{// This is the lite version of the Query class in the main SDK.
/** @hideconstructor protected */constructor(e,/**
     * If provided, the `FirestoreDataConverter` associated with this instance.
     */t,i){this.converter=t,this._query=i,/** The type of this Firestore reference. */this.type="query",this.firestore=e}withConverter(e){return new lI(this.firestore,e,this._query)}}/**
 ...
 */class lD extends lI{/** @hideconstructor */constructor(e,t,i){super(e,t,new sV(i)),this._path=i,/** The type of this Firestore reference. */this.type="collection"}/** The collection's identifier. */get id(){return this._query.path.lastSegment()}/**
...
let t=new rw;return this.au(()=>this.eu&&this.iu?Promise.resolve():(e().then(t.resolve,t.reject),t.promise)).then(()=>t.promise)}enqueueRetryable(e){this.enqueueAndForget(()=>(this.Xa.push(e),this.uu()))}/**
     ...
     */async uu(){if(0!==this.Xa.length){try{await this.Xa[0](),this.Xa.shift(),this.Ho.reset()}catch(e){if(!rq(e))throw e;// Failure will be handled by AsyncQueue
 ...
 */class lk extends lS{/** @hideconstructor */constructor(e,t,i,n){super(e,t,i,n),/**
 ...
 */const lO=RegExp("[~\\*/\\[\\]]");function lM(e,t,i,n,r){let s=n&&!n.isEmpty(),a=void 0!==r,o=`Function ${t}() called with invalid data`;i&&(o+=" (via `toFirestore()`)"),o+=". ";let l="";return(s||a)&&(l+=" (found",s&&(l+=` in field ${n}`),a&&(l+=` in document ${r}`),l+=")"),new rv(ry.INVALID_ARGUMENT,o+e+l)}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * evaluated.
 */function(e,t,i){if(t.search(lO)>=0)throw lM(`Invalid field path (${t}). Paths must not contain '~', '*', '/', '[', or ']'`,e,/* hasConverter= */!1,/* path= */void 0,i);try{return new lP(...t.split("."))._internalPath}catch(n){throw lM(`Invalid field path (${t}). Paths must not be empty, begin with '.', end with '.', or contain '..'`,e,/* hasConverter= */!1,/* path= */void 0,i)}}(e,t):t instanceof lP?t._internalPath:t._delegate._internalPath}class lB{convertValue(e,t="none"){switch(st(e)){case 0/* TypeOrder.NullValue */:return null;case 1/* TypeOrder.BooleanValue */:return e.booleanValue;case 2/* TypeOrder.NumberValue */:return r9(e.integerValue||e.doubleValue);case 3/* TypeOrder.TimestampValue */:return this.convertTimestamp(e.timestampValue);case 4/* TypeOrder.ServerTimestampValue */:return this.convertServerTimestamp(e,t);case 5/* TypeOrder.StringValue */:return e.stringValue;case 6/* TypeOrder.BlobValue */:return this.convertBytes(r4(e.bytesValue));case 7/* TypeOrder.RefValue */:return this.convertReference(e.referenceValue);case 8/* TypeOrder.GeoPointValue */:return this.convertGeoPoint(e.geoPointValue);case 9/* TypeOrder.ArrayValue */:return this.convertArray(e.arrayValue,t);case 10/* TypeOrder.ObjectValue */:return this.convertObject(e.mapValue,t);default:throw rg()}}convertObject(e,t){return this.convertObjectMap(e.fields,t)}/**
     * @internal
     */convertObjectMap(e,t="none"){let i={};return rH(e,(e,n)=>{i[e]=this.convertValue(n,t)}),i}convertGeoPoint(e){return new lx(r9(e.latitude),r9(e.longitude))}convertArray(e,t){return(e.values||[]).map(e=>this.convertValue(e,t))}convertServerTimestamp(e,t){switch(t){case"previous":let i=r5(e);return null==i?null:this.convertValue(i,t);case"estimate":return this.convertTimestamp(r3(e));default:return null}}convertTimestamp(e){let t=r2(e);return new rL(t.seconds,t.nanos)}convertDocumentKey(e,t){let i=rx.fromString(e);az(i)||rg();let n=new r8(i.get(1),i.get(3)),r=new rF(i.popFirst(5));return n.isEqual(t)||// TODO(b/64130202): Somehow support foreign references.
 ...
 */class lj{/** @hideconstructor */constructor(e,t){this.hasPendingWrites=e,this.fromCache=t}/**
 ...
 * access will return 'undefined'. You can use the `exists()` method to
 * explicitly verify a document's existence.
 */class lq extends lF{/** @hideconstructor protected */constructor(e,t,i,n,r,s){super(e,t,i,n,s),this._firestore=e,this._firestoreImpl=e,this.metadata=r}/**
 ...
 * properties.
 */class lz{/** @hideconstructor */constructor(e,t,i,n){this._firestore=e,this._userDataWriter=t,this._snapshot=n,this.metadata=new lj(n.hasPendingWrites,n.fromCache),this.query=i}/** An array of all the documents in the `QuerySnapshot`. */get docs(){let e=[];return this.forEach(t=>e.push(t)),e}/** The number of documents in the `QuerySnapshot`. */get size(){return this._snapshot.docs.size}/** True if there are no documents in the `QuerySnapshot`. */get empty(){return 0===this.size}/**
     * Enumerates all of the documents in the `QuerySnapshot`.
     *
     * @param callback - A callback to be called with a `QueryDocumentSnapshot` for
     * each document in the snapshot.
     * @param thisArg - The `this` binding for the callback.
     */forEach(e,t){this._snapshot.docs.forEach(i=>{e.call(t,new l$(this._firestore,this._userDataWriter,i.key,i,new lj(this._snapshot.mutatedKeys.has(i.key),this._snapshot.fromCache),this.query.converter))})}/**
 ...
 * Security Rules.
 */function(e,t,i,n={}){var r;let s=(e=lT(e,lS))._getSettings(),a=`${t}:${i}`;if("firestore.googleapis.com"!==s.host&&s.host!==a&&rm("Host has been set in both settings() and connectFirestoreEmulator(), emulator host will be used."),e._setSettings(Object.assign(Object.assign({},s),{host:a,ssl:!1})),n.mockUserToken){let t,i;if("string"==typeof n.mockUserToken)t=n.mockUserToken,i=rl.MOCK_USER;else{// Let createMockUserToken validate first (catches common mistakes like
 ...
 */function(e){e=lT(e,lI);let t=lT(e.firestore,lk),i=(t._firestoreClient||lL(t),t._firestoreClient.verifyNotTerminated(),t._firestoreClient),n=new lK(t);return(/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function(e,t,i){if(!i)throw new rv(ry.INVALID_ARGUMENT,`Function ${e}() cannot be called with an empty ${t}.`)}("collection","path",t),e instanceof lS){let n=rx.fromString(t,...i);return l_(n),new lD(e,/* converter= */null,n)}{if(!(e instanceof lA||e instanceof lD))throw new rv(ry.INVALID_ARGUMENT,"Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");let n=e._path.child(rx.fromString(t,...i));return l_(n),new lD(e.firestore,/* converter= */null,n)}}(lG,e));t.forEach(e=>{console.log(`${e.id}:`);let t=e.data();for(let e in t)console.log(`${e} => ${t[e]}`)})}}// const ref = collection(db, "usersData");
// const q = query(ref);
// const usersDataDb = [];
...
// },
{id:"1001",custId:"c001",userName:"Mattew Yampolski",userAddress:"2023, Cactus Road, Springdale, FL, 33761 USA",userPhone:"+1 898 9289289",userEmail:"matt.y@aerosupplyplus.aero",userActive:!0,userAdmin:!0,transDate:"20230815",transId:"jkjur-tewvn-00001"}],lY=[// {
//     id: "Customer ID",
...
// },
{id:"0032-0001-000",itemName:"Wheel Main Assy",itemCat:"component",itemImg:"",itemPN:"BS30-737NG-3254",itemSN:"various",itemPrice:18130,itemQty:50,itemCurrency:"$",itemCondition:"New",itemCertification:["EASA","FAA","CAAC"],itemLeadTime:"on stock",itemDescription:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ab debitis quos autem? Soluta ut aut ab debitis nulla vel voluptates molestias at. Porro recusandae impedit inventore quo sunt delectus cumque, repellat similique mollitia, officiis, esse saepe? Praesentium dolores corporis sapiente cupiditate, aliquid nulla? Nisi, doloremque cum inventore exercitationem nulla quasi labore recusandae rem sed ipsam magnam quos est accusantium sint adipisci voluptas reiciendis natus ut dicta.",transDate:"20230812",transId:"jkjur-tewvn-00003"},{id:"0032-0002-000",itemName:"Wheel Nose Assy",itemCat:"component",itemImg:"",itemPN:"BS30-737NG-3390",itemSN:"various",itemPrice:10680,itemQty:50,itemCurrency:"$",itemCondition:"New",itemCertification:["EASA","FAA","CAAC"],itemLeadTime:"On Stock",itemDescription:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ab debitis quos autem? Soluta ut aut ab debitis nulla vel voluptates molestias at. Porro recusandae impedit inventore quo sunt delectus cumque, repellat similique mollitia, officiis, esse saepe? Praesentium dolores corporis sapiente cupiditate, aliquid nulla? Nisi, doloremque cum inventore exercitationem nulla quasi labore recusandae rem sed ipsam magnam quos est accusantium sint adipisci voluptas reiciendis natus ut dicta.",transDate:"20230812",transId:"jkjur-tewvn-00004"},{id:"0032-0001-100",itemName:"Wheel Main Assy",itemCat:"component",itemImg:"",itemPN:"GY30-737NG-9001",itemSN:"various",itemPrice:18630,itemQty:1,itemCurrency:"$",itemCondition:"New",itemCertification:["EASA","FAA","CAAC"],itemLeadTime:"On Stock",itemDescription:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ab debitis quos autem? Soluta ut aut ab debitis nulla vel voluptates molestias at. Porro recusandae impedit inventore quo sunt delectus cumque, repellat similique mollitia, officiis, esse saepe? Praesentium dolores corporis sapiente cupiditate, aliquid nulla? Nisi, doloremque cum inventore exercitationem nulla quasi labore recusandae rem sed ipsam magnam quos est accusantium sint adipisci voluptas reiciendis natus ut dicta.",transDate:"20230825",transId:"jkjur-tewvn-00005"},{id:"0079-0001-000",itemName:"Filter Assy Oil",itemCat:"component",itemImg:"",itemPN:"123-98418-2752",itemSN:"various",itemPrice:12690,itemQty:5,itemCurrency:"$",itemCondition:"New",itemCertification:["EASA","FAA","CAAC"],itemLeadTime:"On Stock",itemDescription:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ab debitis quos autem? Soluta ut aut ab debitis nulla vel voluptates molestias at. Porro recusandae impedit inventore quo sunt delectus cumque, repellat similique mollitia, officiis, esse saepe? Praesentium dolores corporis sapiente cupiditate, aliquid nulla? Nisi, doloremque cum inventore exercitationem nulla quasi labore recusandae rem sed ipsam magnam quos est accusantium sint adipisci voluptas reiciendis natus ut dicta.",transDate:"20230815",transId:"jkjur-tewvn-00006"},{id:"0079-0002-000",itemName:"Filter Element",itemCat:"part",itemImg:"",itemPN:"123-98418-9999",itemSN:"various",itemPrice:650,itemQty:50,itemCurrency:"$",itemCondition:"New",itemCertification:["EASA","FAA","CAAC"],itemLeadTime:"On Stock",itemDescription:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ab debitis quos autem? Soluta ut aut ab debitis nulla vel voluptates molestias at. Porro recusandae impedit inventore quo sunt delectus cumque, repellat similique mollitia, officiis, esse saepe? Praesentium dolores corporis sapiente cupiditate, aliquid nulla? Nisi, doloremque cum inventore exercitationem nulla quasi labore recusandae rem sed ipsam magnam quos est accusantium sint adipisci voluptas reiciendis natus ut dicta.",transDate:"20230815",transId:"jkjur-tewvn-00007"},{id:"0025-0001-000",itemName:"Seat Block Assy",itemCat:"component",itemImg:"",itemPN:"SA7428-777-3000",itemSN:"various",itemPrice:27490,itemQty:500,itemCurrency:"$",itemCondition:"New",itemCertification:["EASA","FAA","CAAC","UK CAA"],itemLeadTime:"60 Days",itemDescription:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ab debitis quos autem? Soluta ut aut ab debitis nulla vel voluptates molestias at. Porro recusandae impedit inventore quo sunt delectus cumque, repellat similique mollitia, officiis, esse saepe? Praesentium dolores corporis sapiente cupiditate, aliquid nulla? Nisi, doloremque cum inventore exercitationem nulla quasi labore recusandae rem sed ipsam magnam quos est accusantium sint adipisci voluptas reiciendis natus ut dicta.",transDate:"20230816",transId:"jkjur-tewvn-00008"},{id:"1000-0001-000",itemName:"Handbook, Aviation Maintenance Technician - General",itemCat:"manual",itemImg:"",itemPN:"FAA-H-8083-30-ATB",itemSN:"not applicable",itemPrice:97,itemQty:50,itemCurrency:"$",itemCondition:"Serviceable",itemCertification:["FAA"],itemLeadTime:"On Stock",itemDescription:"Lorem ipsum dolor sit amet consectetur adipisicing elit. Deleniti ab debitis quos autem? Soluta ut aut ab debitis nulla vel voluptates molestias at. Porro recusandae impedit inventore quo sunt delectus cumque, repellat similique mollitia, officiis, esse saepe? Praesentium dolores corporis sapiente cupiditate, aliquid nulla? Nisi, doloremque cum inventore exercitationem nulla quasi labore recusandae rem sed ipsam magnam quos est accusantium sint adipisci voluptas reiciendis natus ut dicta.",transDate:"20230820",transId:"jkjur-tewvn-00009"}],lJ=[// {
//     userId: "User ID",
//     itemsId: "Order ID",
// },
{userId:"1001",cart:[{itemId:"",qty:""}],transDate:"20230830",transId:"jkjur-tewvn-00010"}],lZ=[// {
//     id: "Order ID",
...
// },
{id:"100001",orderCustId:"c001",orderUserId:"1001",orderDatePlaced:"20230828",orderDateReady:"20230828",orderDateCompleted:"20230829",orderBillTo:{custLegalName:"AeroSupplyPlus LLC",custBillToAddress:"2023, Cactus Road, Springdale, FL, 33761 USA",custContactName:"Mattew Yampolski",custPhone:"+1 898 9289289",custEmail:"supply@aerosupplyplus.aero"},orderPaymentMethod:"card",orderPaymentDeadline:"20230829",orderPaymentDone:"20230828",orderCart:[{itemId:"",itemPrice:"",qty:""}],orderPriceItems:1374982,orderPriceHandling:378,orderPriceTotal:1375360,orderCurrency:"$",transDate:"20230828",transId:"jkjur-tewvn-00011"},{id:"100002",orderCustId:"c001",orderUserId:"1001",orderDatePlaced:"20230828",orderDateReady:"20230828",orderDateCompleted:"20230829",orderBillTo:{custLegalName:"AeroSupplyPlus LLC",custBillToAddress:"2023, Cactus Road, Springdale, FL, 33761 USA",custContactName:"Mattew Yampolski",custPhone:"+1 898 9289289",custEmail:"supply@aerosupplyplus.aero"},orderPaymentMethod:"card",orderPaymentDeadline:"20230829",orderPaymentDone:"20230828",orderCart:[{itemId:"",itemPrice:"",qty:""}],orderPriceItems:1374982,orderPriceHandling:378,orderPriceTotal:1375360,orderCurrency:"$",transDate:"20230828",transId:"jkjur-tewvn-00012"},{id:"100003",orderCustId:"c001",orderUserId:"1001",orderDatePlaced:"20230828",orderDateReady:"20230828",orderDateCompleted:"20230829",orderBillTo:{custLegalName:"AeroSupplyPlus LLC",custBillToAddress:"2023, Cactus Road, Springdale, FL, 33761 USA",custContactName:"Mattew Yampolski",custPhone:"+1 898 9289289",custEmail:"supply@aerosupplyplus.aero"},orderPaymentMethod:"card",orderPaymentDeadline:"20230829",orderPaymentDone:"20230828",orderCart:[{itemId:"",itemPrice:"",qty:""}],orderPriceItems:1374982,orderPriceHandling:378,orderPriceTotal:1375360,orderCurrency:"$",transDate:"20230828",transId:"jkjur-tewvn-00013"}],l0="customersData",l1="productItems",l2="usersData",l9="ordersData",l4="cartsData",l6=(e,t)=>{idParts=e.split("_");// For reference, elemment ID:
// "DataElement.id = `${arrayName}_${object.id}_${key}`;"
let i=idParts[0],n=idParts[2],r=idParts[3];return{arrayName:i,objectId:n,key:r,value:t}};// Function monitors input changes and displays details in console:
document.addEventListener("input",function(e){if("INPUT"===e.target.tagName){let t=e.target.id,i=e.target.value,n=l6(t,i);console.log(n)}});const l5=new class{constructor(){this.adminView=new h,this.adminModel=new u,this.adminFirebase=new lQ}initializeAppMain=()=>{console.log("HELLO! INIT CARRIED OUT SUCCESFULLY"),this.adminView.checkModuleLinkage(),this.adminModel.checkModuleLinkage(),this.adminFirebase.checkModuleLinkage(),this.displayTables(),this.adminView.renderMenu(l0,l1,l2,l9,l4),this.adminFirebase.get(l2)};displayTables=()=>{this.adminView.clearContainerLeft(),this.adminView.renderTable(lW,l2),this.adminView.renderTable(lY,l0),this.adminView.renderTable(lJ,l4),this.adminView.renderTable(lZ,l9),this.adminView.renderTable(lX,l1)}};try{l5.initializeAppMain()}catch(e){console.error("An error occured duting app initialization:",e),alert("Something went wrong. Please contact the app admin or try again later.")}//# sourceMappingURL=index.7a23057f.js.map

//# sourceMappingURL=index.7a23057f.js.map
