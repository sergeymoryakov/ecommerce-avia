...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),o[e]=t),t}}),i("4G3qk").register(JSON.parse('{"ceDhw":"index.0b70f599.js","4M8Gf":"icon-add-order.d5dcde0a.png","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","kVJvh":"admin.20c8b860.js"}'));var a={};a=i("260Jh").getBundleURL("ceDhw")+i("4G3qk").resolve("4M8Gf");var c={};c=i("260Jh").getBundleURL("ceDhw")+i("4G3qk").resolve("kSZwU");class d{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
s.appendChild(m),d.appendChild(l),d.appendChild(s),o.appendChild(i),o.appendChild(a),o.appendChild(d),r.appendChild(n),r.appendChild(o),r};// Left Container - Render product items
...
i.appendChild(c),l.appendChild(s),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(_),l.appendChild(I),l.appendChild(E),y.appendChild(f),y.appendChild(b),d.appendChild(l),d.appendChild(y),o.appendChild(i),o.appendChild(d),P.appendChild(w),P.appendChild(v),r.appendChild(n),r.appendChild(o),r.appendChild(P),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
return r[0].itemPrice}}class L{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class _{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelUser is connected!")};getSessionIdCustomerByCustomerId=(e,t)=>{let r=t.filter(t=>t.custId===e);return r[0]}}var I=i("ljOiA");// Init database instance (dataBase):
