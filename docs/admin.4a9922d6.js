...
setNewOrderDetails=(e,t)=>{let n={userId:e.userId,userName:e.userName,userEmail:e.userEmail,userPhone:e.userPhone,custId:e.custId,custLegalName:e.custLegalName,custBillToAddress:e.custBillToAddress,custHandlingFee:e.custHandlingFee,paymentMethod:e.paymentMethod,priceItems:t.items,priceHandling:t.handling,priceTotal:t.total,orderCurrency:"$",orderId:this.generateOrderNumber(8),orderDate:(0,s.serverTimestamp)(),paymentDate:(0,s.serverTimestamp)(),docId:this.generateUniqueId()};return n}}}),i.register("fkNhc",function(t,n){e(t.exports,"initializeApp",function(){return i("MjY8E").initializeApp}),e(t.exports,"registerVersion",function(){return i("MjY8E").registerVersion}),/**
 * @license
...
if(null===t)return e.isNoDocument()?new tL(e.key,tT.none()):new tk(e.key,e.data,tT.none());{let n=e.data,r=ek.empty(),i=new et(B.comparator);for(let e of t.fields)if(!i.has(e)){let t=n.field(e);// If we are deleting a nested field, we take the immediate parent as
...
let n=td(e,t),r=tw(n)+tw(e.Te);return eb(n)&&eb(e.Te)?th(r):tu(e.serializer,r)}(e,s))}return r}/** A mutation that deletes the document at the given key. */class tL extends tC{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=2/* MutationType.Delete */,this.fieldTransforms=[]}getFieldMask(){return null}}class tM extends tC{constructor(e,t){super(),this.key=e,this.precondition=t,this.type=3/* MutationType.Verify */,this.fieldTransforms=[]}getFieldMask(){return null}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
o=t.has(r.key)?null:o;let a=tS(s,o);null!==a&&n.set(r.key,a),s.isValidDocument()||s.convertToNoDocument(P.min())}),n}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),ta())}isEqual(e){return this.batchId===e.batchId&&L(this.mutations,e.mutations,(e,t)=>tD(e,t))&&L(this.baseMutations,e.baseMutations,(e,t)=>tD(e,t))}}/** The result of applying a mutation batch to the backend. */class tF{constructor(e,t,n,/**
...
static createSynthesizedRemoteEventForCurrentChange(e,t,n){let r=new Map;return r.set(e,tG.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new tH(P.min(),r,new J(O),te,ta())}}/**
...
// client.
this.Ue.forEach((e,t)=>{let r=!0;t.forEachWhile(e=>{let t=this.et(e);return!t||"TargetPurposeLimboResolution"/* TargetPurpose.LimboResolution */===t.purpose||(r=!1,!1)}),r&&(n=n.add(e))}),this.$e.forEach((t,n)=>n.setReadTime(e));let r=new tH(e,t,this.We,this.$e,n);return this.$e=te,this.Ue=tZ(),this.We=new J(O),r}/**
...
r.Be(t),this.Ue=this.Ue.insert(t,this.ct(t).delete(e)),n&&(this.$e=this.$e.insert(t,n))}removeTarget(e){this.Ke.delete(e)}/**
     ...
     */Le(e){this.Je(e).Le()}Je(e){let t=this.Ke.get(e);return t||(t=new tY,this.Ke.set(e,t)),t}ct(e){let t=this.Ue.get(e);return t||(t=new et(O),this.Ue=this.Ue.insert(e,t)),t}/**
 ...
 */class nw{constructor(e,t,n,r){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=n,this.indexManager=r}/**
     ...
     * state for it.
     */getDocument(e,t){let n=null;return this.documentOverlayCache.getOverlay(e,t).next(r=>(n=r,this.remoteDocumentCache.getEntry(e,t))).next(e=>(null!==n&&tA(n.mutation,e,er.empty(),M.now()),e))}/**
...
r.has(t.key)&&(void 0===o||o.mutation instanceof tN)?i=i.insert(t.key,t):void 0!==o?(s.set(t.key,o.mutation.getFieldMask()),tA(o.mutation,t,o.mutation.getFieldMask(),M.now())):// Using EMPTY to indicate there is no overlay for the document.
...
let n=tn();return e.forEach((e,r)=>{let s=i.get(e);void 0!==s&&tA(s.mutation,r,er.empty(),M.now()),e3(t,r)&&(n=n.insert(e,r))}),n})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.Ir=new et(nT.dr),this.Tr=new et(nT.Er)}/** Returns true if the reference set contains no references. */isEmpty(){return this.Ir.isEmpty()}/** Adds a reference to the given document key for the given ID. */addReference(e,t){let n=new nT(e,t);this.Ir=this.Ir.add(n),this.Tr=this.Tr.add(n)}/** Add references to the given document keys for the given ID. */Ar(e,t){e.forEach(e=>this.addReference(e,t))}/**
     ...
     * removed.
     */mr(e){let t=new j(new U([])),n=new nT(t,e),r=new nT(t,e+1),i=[];return this.Tr.forEachInRange([n,r],e=>{this.Rr(e),i.push(e.key)}),i}gr(){this.Ir.forEach(e=>this.Rr(e))}Rr(e){this.Ir=this.Ir.delete(e),this.Tr=this.Tr.delete(e)}pr(e){let t=new j(new U([])),n=new nT(t,e),r=new nT(t,e+1),i=ta();return this.Tr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nT(e,0),n=this.Ir.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nT{constructor(e,t){this.key=e,this.yr=t}/** Compare by key then by ID */static dr(e,t){return j.comparator(e.key,t.key)||O(e.yr,t.yr)}/** Compare by ID then by key */static Er(e,t){return O(e.yr,t.yr)||j.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
// start of the queue.
return K.resolve(this.mutationQueue.length>r?this.mutationQueue[r]:null)}getHighestUnacknowledgedBatchId(){return K.resolve(0===this.mutationQueue.length?-1:this.wr-1)}getAllMutationBatches(e){return K.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){let n=new nT(t,0),r=new nT(t,Number.POSITIVE_INFINITY),i=[];return this.Sr.forEachInRange([n,r],e=>{let t=this.br(e.yr);i.push(t)}),K.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new et(O);return t.forEach(e=>{let t=new nT(e,0),r=new nT(e,Number.POSITIVE_INFINITY);this.Sr.forEachInRange([t,r],e=>{n=n.add(e.yr)})}),K.resolve(this.Cr(n))}getAllMutationBatchesAffectingQuery(e,t){// Use the query path as a prefix for testing if a document matches the
// query.
let n=t.path,r=n.length+1,i=n;j.isDocumentKey(i)||(i=i.child(""));let s=new nT(new j(i),0),o=new et(O);return this.Sr.forEachWhile(e=>{let t=e.key.path;return!!n.isPrefixOf(t)&&// Rows with document keys more than one segment longer than the query
 ...
 */class nO{constructor(){this.Ui=!1,this.Wi=!1,/**
...
// change.
async function nM(e,t){return await e.persistence.runTransaction("Handle user change","readonly",n=>{// Swap out the mutation queue, grabbing the pending mutation batches
// before and after.
 ...
 */function nP(e){return e.persistence.runTransaction("Get last remote snapshot version","readonly",t=>e.Kr.getLastRemoteSnapshotVersion(t))}/**
...
this.Ho.reset();let r=(t=e.writeResults,n=e.commitTime,t&&t.length>0?(void 0!==n||_(),t.map(e=>{let t;return(t=e.updateTime?t7(e.updateTime):t7(n)).isEqual(P.min())&&// The Firestore Emulator currently returns an update time of 0 for
...
let e={};e.database=ni(this.serializer),this.n_(e)}/** Sends a group of mutations to the Firestore backend to apply. */d_(e){let t={streamToken:this.lastStreamToken,writes:e.map(e=>(function(e,t){var n;let r;if(t instanceof tk)r={update:no(e,t.key,t.value)};else if(t instanceof tL)r={delete:nt(e,t.key)};else if(t instanceof tN)r={update:no(e,t.key,t.data),updateMask:function(e){let t=[];return e.fields.forEach(e=>t.push(e.canonicalString())),{fieldPaths:t}}(t.fieldMask)};else{if(!(t instanceof tM))return _();r={verify:nt(e,t.key)}}return t.fieldTransforms.length>0&&(r.updateTransforms=t.fieldTransforms.map(e=>(function(e,t){let n=t.transform;if(n instanceof tf)return{fieldPath:t.field.canonicalString(),setToServerValue:"REQUEST_TIME"};if(n instanceof tp)return{fieldPath:t.field.canonicalString(),appendMissingElements:{values:n.elements}};if(n instanceof tm)return{fieldPath:t.field.canonicalString(),removeAllFromArray:{values:n.elements}};if(n instanceof tv)return{fieldPath:t.field.canonicalString(),increment:n.Te};throw _()})(0,e))),t.precondition.isNone||(r.currentDocument=void 0!==(n=t.precondition).updateTime?{updateTime:t5(e,n.updateTime.toTimestamp())}:void 0!==n.exists?{exists:n.exists}:_()),r})(this.serializer,e))};this.n_(t)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 */function n7(e,t){if(e.N_.Le(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(P.min())>0){let n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}ry(e).l_(t)}/**
...
(n=()=>nP(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{m("RemoteStore","Retrying IndexedDB access"),await n(),e.F_.delete(1/* OfflineCause.IndexedDbFailed */),await n4(e)})}/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rx{constructor(e){this.key=e}}class rO{constructor(e){this.key=e}}/**
...
let t=[];return e.forEach(e=>{this.aa.has(e)||t.push(new rO(e))}),this.aa.forEach(n=>{e.has(n)||t.push(new rx(n))}),t}/**
 ...
 */class rM{constructor(/**
     ...
     * possible results.
     */n){this.query=e,this.targetId=t,this.view=n}}/** Tracks a limbo resolution. */class rP{constructor(e){this.key=e,/**
...
n.push(i)}),new er(n)}(t.value.mapValue),tT.exists(!0)))}return e.mutationQueue.addMutationBatch(o,i,s,t)}).next(t=>{r=t;let i=t.applyToLocalDocumentSet(n,l);return e.documentOverlayCache.saveOverlays(o,t.batchId,i)})}).then(()=>({batchId:r.batchId,changes:tr(n)}))}(i.localStore,t);i.sharedClientState.addPendingMutation(s.batchId),r=s.batchId,(e=i.Da[i.currentUser.toKey()])||(e=new J(O)),e=e.insert(r,n),i.Da[i.currentUser.toKey()]=e,await rZ(i,s.changes),await rl(i.remoteStore)}catch(t){// If we can't persist the mutation, we reject the user callback and
...
n=n.insert(i,eN.newNoDocument(i,P.min()));let r=ta().add(i),s=new tH(P.min(),/* targetChanges= */new Map,/* targetMismatches= */new J(O),n,r);await r$(e,s),// We only remove it from bookkeeping after we successfully applied the
 ...
 * classes.
 */class iR{constructor(e,t,n){this.databaseId=e,this.ignoreUndefinedProperties=t,this.serializer=n||nX(e)}/** Creates a new top-level parse context. */wu(e,t,n,r=!1){return new iN({Tu:e,methodName:t,yu:n,path:B.emptyPath(),Ru:!1,pu:r},this.databaseId,this.serializer,this.ignoreUndefinedProperties)}}function ix(e){let t=e._freezeSettings(),n=nX(e._databaseId);return new iR(e._databaseId,!!t.ignoreUndefinedProperties,n)}class iO extends iI{_toFieldTransform(e){if(2/* UserDataSource.MergeSet */!==e.Tu)throw 1/* UserDataSource.Update */===e.Tu?e.gu(`${this._methodName}() can only appear at the top level of your update data`):e.gu(`${this._methodName}() cannot be used with set() unless you pass {merge:true}`);// No transform to add for a delete, but we need to add it to our
// fieldMask so it gets deleted.
return e.fieldMask.push(e.path),null}isEqual(e){return e instanceof iO}}class iL extends iI{_toFieldTransform(e){return new tE(e.path,new tf)}isEqual(e){return e instanceof iL}}/**
 ...
 */function iM(e,t){if(iF(// from firestore-exp.
e=(0,u.getModularInstance)(e)))return iU("Unsupported field value:",t,e),iP(e,t);if(e instanceof iI)// in which case we do not want to include this field in our parsed data
...
n=(0,u.getModularInstance)(n);let r=o.mu(t);if(n instanceof iO)h.push(t);else{let e=iM(n,r);null!=e&&(h.push(t),c.set(t,e))}}let d=new er(h);return new iD(c,d,o.fieldTransforms)}(s,"updateDoc",e._key,t,n,r):/** Parse update data from an update() call. */function(e,t,n,r){let i=e.wu(1/* UserDataSource.Update */,t,n);iU("Data must be an object, but it was:",i,r);let s=[],o=ek.empty();X(r,(e,r)=>{let a=ij(t,e,n);// For Compat types, we have to "extract" the underlying types before
// performing validation.
r=(0,u.getModularInstance)(r);let l=i.mu(a);if(r instanceof iO)s.push(a);else{let e=iM(r,l);null!=e&&(s.push(a),o.set(a,e))}});let a=new er(s);return new iD(o,a,i.fieldTransforms)}(s,"updateDoc",e._key,t)).toMutation(e._key,tT.exists(!0))])}/**
 * Deletes the document referred to by the specified `DocumentReference`.
 *
 * @param reference - A reference to the document to delete.
 * @returns A Promise resolved once the document has been successfully
 * deleted from the backend (note that it won't resolve while you're offline).
 */function i2(e){return i9(il(e.firestore,iv),[new tL(e._key,tT.none())])}/**
...
//# sourceMappingURL=admin.4a9922d6.js.map
