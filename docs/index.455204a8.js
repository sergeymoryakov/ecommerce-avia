...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),o[e]=t),t}}),a("4G3qk").register(JSON.parse('{"ceDhw":"index.455204a8.js","4M8Gf":"icon-add-order.d5dcde0a.png","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","kVJvh":"admin.20c8b860.js"}'));var i={};i=a("260Jh").getBundleURL("ceDhw")+a("4G3qk").resolve("4M8Gf");var c={};c=a("260Jh").getBundleURL("ceDhw")+a("4G3qk").resolve("kSZwU");class d{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
a.appendChild(c),l.appendChild(s),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(_),l.appendChild(I),l.appendChild(E),y.appendChild(f),y.appendChild(b),d.appendChild(l),d.appendChild(y),o.appendChild(a),o.appendChild(d),P.appendChild(w),P.appendChild(v),r.appendChild(n),r.appendChild(o),r.appendChild(P),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
n.appendChild(o),c.appendChild(d),i.appendChild(c),l.appendChild(s),l.appendChild(m),i.appendChild(l),u.appendChild(p),u.appendChild(h),i.appendChild(u),C.appendChild(g),C.appendChild(L),i.appendChild(C),_.appendChild(I),_.appendChild(E),i.appendChild(_),b.appendChild(P),b.appendChild(w),b.appendChild(v),y.appendChild(f),y.appendChild(b),i.appendChild(y),a.appendChild(i),r.appendChild(n),r.appendChild(a),r};// Left Container - Create Cart Page
...
return t.appendChild(r),t}}class u{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewAdmin is connected!")}}class p{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewSuperadmin is connected!")}}var h=a("9zRuU");class C{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelProducts is connected!")}}class g{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ModelCart is connected!")}}class L{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class _{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelUser is connected!")};getSessionIdCustomerByCustomerId=(e,t)=>{let r=t.filter(t=>t.custId===e);return r[0]}}var I=a("ljOiA");// Init database instance (dataBase):
let E={},y="",f={},b={},P=[],w=[],v={},k=document.createElement("div");k.innerHTML="";let T=document.createElement("div");T.innerHTML="";let B=document.createElement("div");B.innerHTML="";// Init cross-ref Map: image - url
...
console.log("MODEL - [*** sessionIdCart ***]: ",e),console.log("MODEL - [*** sessionIdCartPrice ***]: ",t),console.log("MODEL - [*** dataBase.productItems ***]: ",E.productItems),console.log("MODEL - [*** sessionIdCustome ***]: ",b),e))o+=n.qty*this.getPriceByProductId(r,n.itemId);// TO-DO: CHECK, if it is required here. Delete for now:
...
let t=this.getProdIdFromElementId(e.id),r=this.getDocIdFromArrayByItemId(w,t);r?this.handleQtyChangeBtn(e,1):this.addProduct(t,y),this.renderCartAndOrdersSummary(w,P)};// "Go to Cart" button at right panel
