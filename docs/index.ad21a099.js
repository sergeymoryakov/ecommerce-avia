function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},i={},o=r.parcelRequire5d32;null==o&&((o=function(e){if(e in n)return n[e].exports;if(e in i){var t=i[e];delete i[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){i[e]=t},r.parcelRequire5d32=o),o.register("d5gZm",function(t,r){e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return i},function(e){return i=e});var n,i,o={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)o[t[r]]=e[t[r]]},i=function(e){var t=o[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),o("d5gZm").register(JSON.parse('{"bjFny":"index.ad21a099.js","3XKo6":"icon-add-order.d5dcde0a.png","jyKjU":"icon-cart.dd455062.png","5WNTT":"icon-order.5ea58f4f.png","7kASp":"admin.5777f4fe.js"}'));var c={};c=new URL(o("d5gZm").resolve("3XKo6"),import.meta.url).toString();var d={};d=new URL(o("d5gZm").resolve("jyKjU"),import.meta.url).toString();class a{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
o.appendChild(d),l.appendChild(s),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(_),l.appendChild(E),l.appendChild(I),y.appendChild(f),y.appendChild(v),a.appendChild(l),a.appendChild(y),i.appendChild(o),i.appendChild(a),w.appendChild(b),w.appendChild(k),r.appendChild(n),r.appendChild(i),r.appendChild(w),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
console.log(`ACTION NEEDED: DELETE PRODUCT WITH ID ${n.itemId} FROM CART.`)):(n.qty+=r,this.controller.handleViewOfPartQty(t,n.qty)));return e}}class L{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class _{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelUser is connected!")};getSessionIdCustomerByCustomerId=(e,t)=>{let r=t.filter(t=>t.custId===e);return r[0]}}var E=o("1ggDV");// Init database instance (dataBase):
let I={},y="",f={},v={},w={},b={},k={items:8e5,handling:8e3,total:808e3};// Init HTML variables:
...
this.renderCartAndOrdersSummary(b,w),this.attachEventListenrs()};// Get sessionIdCustomer data by customer's ID
...
handleGotoProductsBtn=()=>{this.renderProductItemsList(I.productItems),this.renderCartAndOrdersSummary(b,w)};// "Add to Cart" button at detailed product card (page)
...
this.modelCart.updateCartPriceVariable(b,k,I.productItems,v.custHandlingFee),this.renderCartSummary(b),this.renderCartSummaryWithPrice(b,k)};// "Proceed to checkout" button at right panel
...
console.log("Received command to display PRODUCT CARD with ID: ",e.id),console.log("Clicked inside product item");let t=this.getProdIdFromElementId(e.id),r=this.getProductObjectById(t);this.renderProductCard(r),this.renderCartAndOrdersSummary(b,w)};handleDisplayHistoricalOrder=e=>{console.log("Received command to display ORDER with ID: ",e.id)};handleQtyDeductBtn=(e,t)=>{console.log("Received command to deduct qty of product with ID: ",e.id);let r=this.getProdIdFromElementId(e.id);console.log("itemId: ",r),console.log("sessionIdCard: ",this.modelCart.changeQtyInCart(b,r,-1)),this.handleGotoCartBtn()};handleQtyAddBtn=(e,t)=>{console.log("Received command to add qty of product with ID: ",e.id);let r=this.getProdIdFromElementId(e.id);console.log("itemId: ",r),console.log("sessionIdCard: ",this.modelCart.changeQtyInCart(b,r,1)),this.handleGotoCartBtn()};handleButtonsClickLeft=(e,t)=>{let r=e.target;// "< Back to Products" button
