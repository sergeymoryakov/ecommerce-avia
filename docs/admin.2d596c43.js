...
setNewOrderDetails=(e,t)=>{let n=Date.now(),r={userId:e.userId,userName:e.userName,userEmail:e.userEmail,userPhone:e.userPhone,custId:e.custId,custLegalName:e.custLegalName,custBillToAddress:e.custBillToAddress,custHandlingFee:e.custHandlingFee,paymentMethod:e.paymentMethod,priceItems:t.priceItems,priceHandling:t.priceHandling,priceTotal:t.priceTotal,orderCurrency:"$",orderId:this.generateOrderNumber(8),orderDate:n,paymentDate:n,docId:this.generateUniqueId()};return r}}}),i.register("gKkQl",function(t,n){e(t.exports,"initializeApp",function(){return i("ix4Jr").initializeApp}),e(t.exports,"registerVersion",function(){return i("ix4Jr").registerVersion}),/**
 * @license
...
return(0,o.base64urlEncodeWithoutPadding)(JSON.stringify({version:2,heartbeats:e})).length}m(new r.Component("platform-logger",e=>new l(e),"PRIVATE"/* ComponentType.PRIVATE */)),m(new r.Component("heartbeat",e=>new x(e),"PRIVATE"/* ComponentType.PRIVATE */)),// Register `app` package.
 ...
 */function e(t,n){if(t===n)return!0;let r=Object.keys(t),i=Object.keys(n);for(let s of r){if(!i.includes(s))return!1;let r=t[s],o=n[s];if(N(r)&&N(o)){if(!e(r,o))return!1}else if(r!==o)return!1}for(let e of i)if(!r.includes(e))return!1;return!0})}),e(n.exports,"getModularInstance",function(){return x});/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function x(e){return e&&e._delegate?e._delegate:e}}),i.register("4TNnu",function(e,t){// shim for using process in browser
 ...
 */class ex{constructor(e,t){this.position=e,this.inclusive=t}}function eR(e,t,n){let r=0;for(let i=0;i<e.position.length;i++){let s=t[i],o=e.position[i];if(r=s.field.isKeyField()?j.comparator(j.fromName(o.referenceValue),n.key):ew(o,n.data.field(s.field)),"desc"/* Direction.DESCENDING */===s.dir&&(r*=-1),0!==r)break}return r}/**
...
if(null===t)return e.isNoDocument()?new tL(e.key,tb.none()):new tD(e.key,e.data,tb.none());{let n=e.data,r=ek.empty(),i=new et(B.comparator);for(let e of t.fields)if(!i.has(e)){let t=n.field(e);// If we are deleting a nested field, we take the immediate parent as
...
o=t.has(r.key)?null:o;let a=tC(s,o);null!==a&&n.set(r.key,a),s.isValidDocument()||s.convertToNoDocument(M.min())}),n}keys(){return this.mutations.reduce((e,t)=>e.add(t.key),ta())}isEqual(e){return this.batchId===e.batchId&&O(this.mutations,e.mutations,(e,t)=>tA(e,t))&&O(this.baseMutations,e.baseMutations,(e,t)=>tA(e,t))}}/** The result of applying a mutation batch to the backend. */class tM{constructor(e,t,n,/**
     ...
     */static from(e,t,n){e.mutations.length===n.length||_();let r=ts,i=e.mutations;for(let e=0;e<i.length;e++)r=r.insert(i[e].key,n[e].version);return new tM(e,t,n,r)}}/**
 * @license
 * Copyright 2022 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
static createSynthesizedRemoteEventForCurrentChange(e,t,n){let r=new Map;return r.set(e,tH.createSynthesizedTargetChangeForCurrentChange(e,t,n)),new tK(M.min(),r,new J(L),te,ta())}}/**
 ...
 */class nv{constructor(e,t,n,r){this.remoteDocumentCache=e,this.mutationQueue=t,this.documentOverlayCache=n,this.indexManager=r}/**
     ...
     * state for it.
     */getDocument(e,t){let n=null;return this.documentOverlayCache.getOverlay(e,t).next(r=>(n=r,this.remoteDocumentCache.getEntry(e,t))).next(e=>(null!==n&&tS(n.mutation,e,er.empty(),P.now()),e))}/**
...
r.has(t.key)&&(void 0===o||o.mutation instanceof tk)?i=i.insert(t.key,t):void 0!==o?(s.set(t.key,o.mutation.getFieldMask()),tS(o.mutation,t,o.mutation.getFieldMask(),P.now())):// Using EMPTY to indicate there is no overlay for the document.
...
let n=tn();return e.forEach((e,r)=>{let s=i.get(e);void 0!==s&&tS(s.mutation,r,er.empty(),P.now()),e3(t,r)&&(n=n.insert(e,r))}),n})}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
this.Ir=new et(nb.dr),this.Tr=new et(nb.Er)}/** Returns true if the reference set contains no references. */isEmpty(){return this.Ir.isEmpty()}/** Adds a reference to the given document key for the given ID. */addReference(e,t){let n=new nb(e,t);this.Ir=this.Ir.add(n),this.Tr=this.Tr.add(n)}/** Add references to the given document keys for the given ID. */Ar(e,t){e.forEach(e=>this.addReference(e,t))}/**
     ...
     * removed.
     */mr(e){let t=new j(new U([])),n=new nb(t,e),r=new nb(t,e+1),i=[];return this.Tr.forEachInRange([n,r],e=>{this.Rr(e),i.push(e.key)}),i}gr(){this.Ir.forEach(e=>this.Rr(e))}Rr(e){this.Ir=this.Ir.delete(e),this.Tr=this.Tr.delete(e)}pr(e){let t=new j(new U([])),n=new nb(t,e),r=new nb(t,e+1),i=ta();return this.Tr.forEachInRange([n,r],e=>{i=i.add(e.key)}),i}containsKey(e){let t=new nb(e,0),n=this.Ir.firstAfterOrEqual(t);return null!==n&&e.isEqual(n.key)}}class nb{constructor(e,t){this.key=e,this.yr=t}/** Compare by key then by ID */static dr(e,t){return j.comparator(e.key,t.key)||L(e.yr,t.yr)}/** Compare by ID then by key */static Er(e,t){return L(e.yr,t.yr)||j.comparator(e.key,t.key)}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
// start of the queue.
return K.resolve(this.mutationQueue.length>r?this.mutationQueue[r]:null)}getHighestUnacknowledgedBatchId(){return K.resolve(0===this.mutationQueue.length?-1:this.wr-1)}getAllMutationBatches(e){return K.resolve(this.mutationQueue.slice())}getAllMutationBatchesAffectingDocumentKey(e,t){let n=new nb(t,0),r=new nb(t,Number.POSITIVE_INFINITY),i=[];return this.Sr.forEachInRange([n,r],e=>{let t=this.br(e.yr);i.push(t)}),K.resolve(i)}getAllMutationBatchesAffectingDocumentKeys(e,t){let n=new et(L);return t.forEach(e=>{let t=new nb(e,0),r=new nb(e,Number.POSITIVE_INFINITY);this.Sr.forEachInRange([t,r],e=>{n=n.add(e.yr)})}),K.resolve(this.Cr(n))}getAllMutationBatchesAffectingQuery(e,t){// Use the query path as a prefix for testing if a document matches the
// query.
let n=t.path,r=n.length+1,i=n;j.isDocumentKey(i)||(i=i.child(""));let s=new nb(new j(i),0),o=new et(L);return this.Sr.forEachWhile(e=>{let t=e.key.path;return!!n.isPrefixOf(t)&&// Rows with document keys more than one segment longer than the query
...
async function nM(e,t,n){let r=e.rs.get(t);try{n||await e.persistence.runTransaction("Release target",n?"readwrite":"readwrite-primary",t=>e.persistence.referenceDelegate.removeTarget(t,r))}catch(e){if(!H(e))throw e;// All `releaseTarget` does is record the final metadata state for the
...
this.Ho.reset();let r=(t=e.writeResults,n=e.commitTime,t&&t.length>0?(void 0!==n||_(),t.map(e=>{let t;return(t=e.updateTime?t3(e.updateTime):t3(n)).isEqual(M.min())&&// The Firestore Emulator currently returns an update time of 0 for
 ...
 */function n3(e,t){if(e.N_.Le(t.targetId),t.resumeToken.approximateByteSize()>0||t.snapshotVersion.compareTo(M.min())>0){let n=e.remoteSyncer.getRemoteKeysForTarget(t.targetId).size;t=t.withExpectedCount(n)}rm(e).l_(t)}/**
...
(n=()=>nP(e.localStore)),e.asyncQueue.enqueueRetryable(async()=>{m("RemoteStore","Retrying IndexedDB access"),await n(),e.F_.delete(1/* OfflineCause.IndexedDbFailed */),await n9(e)})}/**
...
for(let n of e.C_)t.d_(n.mutations)}async function rd(e,t,n){let r=e.C_.shift(),i=tM.from(r,t,n);await ro(e,()=>e.remoteSyncer.applySuccessfulWrite(i)),// slot has freed up.
 ...
 * This is useful to implement optional features (like bundles) in free
 * functions, such that they are tree-shakeable.
 */class rM{constructor(e,t,n,r,i,s){this.localStore=e,this.remoteStore=t,this.eventManager=n,this.sharedClientState=r,this.currentUser=i,this.maxConcurrentLimboResolutions=s,this.fa={},this.ga=new e8(e=>e6(e),e4),this.pa=new Map,/**
...
n.push(i)}),new er(n)}(t.value.mapValue),tb.exists(!0)))}return e.mutationQueue.addMutationBatch(o,i,s,t)}).next(t=>{r=t;let i=t.applyToLocalDocumentSet(n,l);return e.documentOverlayCache.saveOverlays(o,t.batchId,i)})}).then(()=>({batchId:r.batchId,changes:tr(n)}))}(i.localStore,t);i.sharedClientState.addPendingMutation(s.batchId),r=s.batchId,(e=i.Da[i.currentUser.toKey()])||(e=new J(L)),e=e.insert(r,n),i.Da[i.currentUser.toKey()]=e,await rJ(i,s.changes),await ra(i.remoteStore)}catch(t){// If we can't persist the mutation, we reject the user callback and
 ...
 */function iL(e,t){if(iP(// from firestore-exp.
e=(0,u.getModularInstance)(e)))return iM("Unsupported field value:",t,e),iO(e,t);if(e instanceof iT)// in which case we do not want to include this field in our parsed data
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function k(e,t){return t}class N{constructor(e,t,n,r){this.server=e,this.local=t||e,this.writable=!!n,this.xform=r||k}}let x=null;/**
