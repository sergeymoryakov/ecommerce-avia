...
return r[e[t+0]]+r[e[t+1]]+r[e[t+2]]+r[e[t+3]]+"-"+r[e[t+4]]+r[e[t+5]]+"-"+r[e[t+6]]+r[e[t+7]]+"-"+r[e[t+8]]+r[e[t+9]]+"-"+r[e[t+10]]+r[e[t+11]]+r[e[t+12]]+r[e[t+13]]+r[e[t+14]]+r[e[t+15]]}}),i.register("ccUSO",function(t,n){e(t.exports,"default",function(){return s});var r=i("l3plK"),s=function(e){return"string"==typeof e&&(0,r.default).test(e)}}),i.register("l3plK",function(t,n){e(t.exports,"default",function(){return r});var r=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i}),i.register("ljOiA",function(t,n){e(t.exports,"dbCollectionNames",function(){return r});let r=["usersData","customersData","cartsData","ordersData","orderItemsData","productItems"]})}();//# sourceMappingURL=admin.4d7b58db.js.map

//# sourceMappingURL=admin.4d7b58db.js.map
