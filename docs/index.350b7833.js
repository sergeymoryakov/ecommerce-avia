function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},o={},i=r.parcelRequire5d32;null==i&&((i=function(e){if(e in n)return n[e].exports;if(e in o){var t=o[e];delete o[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var i=Error("Cannot find module '"+e+"'");throw i.code="MODULE_NOT_FOUND",i}).register=function(e,t){o[e]=t},r.parcelRequire5d32=i),i.register("d5gZm",function(t,r){e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return o},function(e){return o=e});var n,o,i={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)i[t[r]]=e[t[r]]},o=function(e){var t=i[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),i("d5gZm").register(JSON.parse('{"bjFny":"index.350b7833.js","3XKo6":"icon-add-order.d5dcde0a.png","jyKjU":"icon-cart.dd455062.png","5WNTT":"icon-order.5ea58f4f.png","1riji":"admin.b59ef8f1.js"}'));var d={};d=new URL(i("d5gZm").resolve("3XKo6"),import.meta.url).toString();var a={};a=new URL(i("d5gZm").resolve("jyKjU"),import.meta.url).toString();class c{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
checkModuleLinkage=()=>{console.log("HELLO, ViewProducts is connected!")};createProductItemCard=e=>{// Create elements
let r=document.createElement("div");r.classList="product-item",r.id=`product-card_${e.itemId}`;let n=document.createElement("img");n.classList="product-item__img",n.src=this.controller.getUrlByNameLocal(e.itemImg);let o=document.createElement("div");o.classList="product-item__content";let i=document.createElement("h3");i.classList="product-item__content_desc",i.textContent=e.itemName;let d=document.createElement("p");d.classList="product-item__content_part-number",d.textContent=e.itemPN;let c=document.createElement("div");c.classList="product-item__content_price-block";let l=document.createElement("h3");l.classList="product-item__content_price",l.textContent=`$${e.itemPrice}`;let s=document.createElement("button");s.classList="product-item__content_price-btn",s.id=`product-btn_${e.itemId}`;let m=document.createElement("img");return m.classList="product-item__content_price-btn-img",m.src=/*@__PURE__*/t(a),m.alt="Select",// Append elemens to respective parents
s.appendChild(m),c.appendChild(l),c.appendChild(s),o.appendChild(i),o.appendChild(d),o.appendChild(c),r.appendChild(n),r.appendChild(o),r};// Left Container - Render product items
...
i.appendChild(a),l.appendChild(s),l.appendChild(m),l.appendChild(u),l.appendChild(p),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(_),l.appendChild(I),l.appendChild(E),y.appendChild(f),y.appendChild(b),c.appendChild(l),c.appendChild(y),o.appendChild(i),o.appendChild(c),w.appendChild(P),w.appendChild(v),r.appendChild(n),r.appendChild(o),r.appendChild(w),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
let n={docId:this.controller.handleNewIdGeneration(),itemId:t,qty:1,userId:r};return console.log("a newCartElement: ",n),e.push(n),console.log("an updated [*** sessionIdCart ***]: ",e),e}}class L{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class _{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelUser is connected!")};getSessionIdCustomerByCustomerId=(e,t)=>{let r=t.filter(t=>t.custId===e);return r[0]}}var I=i("1ggDV");// Init database instance (dataBase):
let E={},y="",f={},b={},w=[],P=[],v={items:8e5,handling:8e3,total:808e3};// Init HTML variables:
...
y=E.usersData[0].userId),console.log("[*** sessionIdUser ***] initiated: ",// Assign to sessionIdUser a first element of the usersData[0]
f=E.usersData[0]),// Get sessionIdCustomer data by customer's ID
...
this.renderProductItemsList(E.productItems),// Get values to Sesstion Variables: 1-2
// 1. Get cart items by sesstion user ID:
P=this.getCartItemsByUserID(y),console.log(`Cart items [*** sessionIdCart ***] for User ID ${y}: `,P),// 2. Get orders list by user ID:
w=this.getOrdersByUserID(y),console.log(`Orders History [*** sessionIdOrders ***] for User ID ${y}: `,w),// Right Container - Render Cart Summary
this.renderCartAndOrdersSummary(P,w),this.attachEventListenrs()};// Generate unique ID
handleNewIdGeneration=()=>this.modelFirebase.generateUniqueId();// Get sessionIdCustomer data by customer's ID
getSessionIdCustomerData=()=>{b=this.modelUser.getSessionIdCustomerByCustomerId(f.custId,E.customersData)};// Clear container
clearContainerLeft=()=>{this.containerLeftNode.innerHTML=""};clearContainerRight=()=>{this.containerRightNode.innerHTML=""};askForImageUrlFromStorage=async e=>{let t=await this.modelFirebase.getLinkToImage(e).then(e=>e).catch(e=>{console.log("Error getting download URL: ",e)});console.log("imageURL: ",t)};deleteObjectFromArrayByDocId=(e,t)=>{let r=e.filter(e=>e.docId===t);return -1!==r?(e.splice(r,1),console.log("Deleted element/document with docId = ",t)):console.log("Not found element/document with docId = ",t),e};getUrlByNameLocal=e=>B.get(e);getCartItemsByUserID=e=>E.cartsData.filter(t=>t.userId===e);getOrdersByUserID=e=>E.ordersData.filter(t=>t.userId===e);getImageByProductId=e=>{let t=E.productItems.filter(t=>t.itemId===e);// TEST-TBS - REMOVE IN PROD
// console.log("productObject: ", productObject);
...
let t=E.productItems.filter(t=>t.itemId===e);// return object
return t[0]};getDocIdFromArrayByItemId=(e,t)=>{let r=e.filter(e=>e.itemId===t);return(// TEST-TBS - REMOVE FOR PROD
console.log("[*** filteredArray ***]: ",r),r[0].docId)};// Left Container - Render product items
...
handleGotoProductsBtn=()=>{this.renderProductItemsList(E.productItems),this.renderCartAndOrdersSummary(P,w)};// "Add to Cart" button at detailed product card (page)
handleAddToCartBtn=e=>{let t=this.getProdIdFromElementId(e.id);console.log(`TO-DO: Add product with ID ${t} to cart.`),P=this.modelCart.addProductToCart(P,t,y),this.renderCartAndOrdersSummary(P,w)};// "Go to Cart" button at right panel
handleGotoCartBtn=()=>{console.log("Received command to display CART."),// TEST-TBD
this.modelCart.updateCartPriceVariable(P,v,E.productItems,b.custHandlingFee),this.renderCartSummary(P),this.renderCartSummaryWithPrice(P,v)};// "Proceed to checkout" button at right panel
...
console.log("sessionIdCart: ",t=this.modelCart.changeQtyInCart(t,n,r)),v=this.modelCart.updateCartPriceVariable(t,v,E.productItems,b.custHandlingFee)};handleViewOfPartQty=(e,t)=>{// TEST-TBS REMOVE IN PROD
