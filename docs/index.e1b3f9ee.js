function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},a={},o=r.parcelRequire5d32;null==o&&((o=function(e){if(e in n)return n[e].exports;if(e in a){var t=a[e];delete a[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){a[e]=t},r.parcelRequire5d32=o),o.register("d5gZm",function(t,r){e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var n,a,o={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)o[t[r]]=e[t[r]]},a=function(e){var t=o[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),o("d5gZm").register(JSON.parse('{"bjFny":"index.e1b3f9ee.js","3XKo6":"icon-add-order.d5dcde0a.png","jyKjU":"icon-cart.dd455062.png","5WNTT":"icon-order.5ea58f4f.png","1riji":"admin.2d596c43.js"}'));var d={};d=new URL(o("d5gZm").resolve("3XKo6"),import.meta.url).toString();var i={};i=new URL(o("d5gZm").resolve("jyKjU"),import.meta.url).toString();class l{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
let r=document.createElement("button");return r.classList.add("update-btn"),r.setAttribute("id","updatePaymentMethodBtn"),r.innerText="Update",t.appendChild(r),t}}var u=o("keq33");class h{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelProducts is connected!")}}class C{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ModelCart is connected!")}}class g{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class L{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelUser is connected!")};getSessionIdCustomerByCustomerId=(e,t)=>{let r=t.filter(t=>t.custId===e);return r[0]}}var E=o("1ggDV");// Init database instance (dataBase):
let y={},I="",P={},b={},_=[],T=[],f={},v={};// let newOrderDetails = {
//     // userId: "1001",
...
// };
// Init HTML variables:
const w=document.createElement("div");w.innerHTML="";const O=document.createElement("div");O.innerHTML="";const B=document.createElement("div");B.innerHTML="";// Init cross-ref Map: image - url
...
T=this.getCartItemsByUserID(I),console.log(`[*** sessionIdCartItems ***] for User ID ${I}: `,T),// 2. Set "sessionIdOrders" by sesstion's userId (sessionIdNumber):
_=this.getOrdersByUserID(I),console.log(`[*** sessionIdOrders ***] for User ID ${I}: `,_),// 3. Set "sessionIdCartDetails":
v=this.getSessionIdCartDetails(),console.log(`[*** sessionIdCartDetails ***] for User ID ${I}: `,v),// Left Container - Render product items
...
getSessionIdCustomerData=()=>b=this.modelUser.getSessionIdCustomerByCustomerId(P.custId,y.customersData);// Set "sessionIdCartDetails":
getSessionIdCartDetails=()=>{let e={userId:P.userId,userName:P.userName,userEmail:P.userEmail,userPhone:P.userPhone,custId:b.custId,custLegalName:b.custLegalName,custBillToAddress:b.custBillToAddress,custHandlingFee:b.custHandlingFee,paymentMethod:b.paymentMethod};return e};// Reset Session Cart Items (when order placed)
...
console.log("Received command to call for Price Variable update"),this.updateCartPriceVariable(T,f,y.productItems,b.custHandlingFee)};// MIGHT BE A PART OF MODEL:
...
e.appendChild(this.viewOrders.createPaymentMethodContentBlock(v,!0,E.paymentMethods));let t=this.viewOrders.createCheckOutCartWrapper(),r=document.createElement("div");for(let e of(r.classList="checkout-cart-items",T)){let t=this.getProductObjectById(e.itemId);// Third argument ("checkout-cart-item") is a classList to pass to 'div' element
...
renderCheckOutPricePanel=()=>{this.clearContainerRight(),this.containerRightNode.appendChild(this.viewOrders.createOrderSummaryPriceBlock(f,!0))};// Right Container - Render Order Price Panel
...
let t=this.getProdIdFromElementId(e.id),r=this.getDocIdFromArrayByItemId(T,t);r?this.handleQtyChangeBtn(e,1):this.addProduct(t,I),this.renderCartAndOrdersSummary(T,_)};// "Go to Cart" button at right panel or checkout panel
handleGotoCartBtn=()=>{// TEST-TBS REMOVE IN PROD
console.log("Received command to display CART."),this.updateCartPriceVariable(T,f,y.productItems,b.custHandlingFee),this.renderCartSummary(T),this.renderCartSummaryWithPrice(T,f)};// Handle Order Placement
handleOrderPlacement=async()=>{if(// TEST-TBS REMOVE IN PROD
console.log("Received command to PLACE ORDER (HANDLER CONNECTED)."),0===f.priceTotal){this.activatePopupMessage(E.errorEmptyCart);return}// 1.A. Prepare newOrderDetails to pass to Firestore
let e=JSON.parse(JSON.stringify(this.modelFirebase.setNewOrderDetails(v,f)));// TEST-TBS REMOVE IN PROD
...
this.handleViewOfTotalPrceInCart(f.priceTotal)};// Update product QTY in CART in 2 locations: price and selector
...
console.log("Got comand to ACTIVATE POPUP"),this.popupContentNode.innerHTML="";let e=this.viewPopup.createPopupUpdateAddress(v);this.popupContentNode.appendChild(e),this.togglePopup()};activatePopupUpdatePaymentMethod=()=>{// Clear Popup Content
