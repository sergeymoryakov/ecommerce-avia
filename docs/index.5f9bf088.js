...
c.appendChild(d),a.appendChild(s),a.appendChild(m),a.appendChild(u),a.appendChild(p),a.appendChild(h),a.appendChild(g),a.appendChild(L),a.appendChild(C),a.appendChild(_),a.appendChild(E),a.appendChild(I),f.appendChild(k),f.appendChild(w),l.appendChild(a),l.appendChild(f),o.appendChild(c),o.appendChild(l),v.appendChild(b),v.appendChild(y),r.appendChild(n),r.appendChild(o),r.appendChild(v),console.log("productCardMain: ",r),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
let I={},f="",k={},w={};// Init HTML variables:
...
console.log("cartSummaryNoTotal: ",b),console.log("ordersHistorySummary: ",y),r.appendChild(b),r.appendChild(y),this.clearContainerRight(),this.containerRightNode.appendChild(r)};renderProductCard=e=>{let t=this.viewProducts.createDetailedProductCard(e);this.clearContainerLeft(),this.containerLeftNode.appendChild(t)};handleButtonsClickLeft=e=>{let t=e.target;t.classList.contains("goto-products-btn")&&this.renderProductItemsList(I.productItems);// Add to cart button (from inside the detailed card)
