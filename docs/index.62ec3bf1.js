...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),n[e]=t),t}}),i("4G3qk").register(JSON.parse('{"ceDhw":"index.62ec3bf1.js","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","g125u":"admin.a26f408d.js"}'));// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
i("6m2hf");var a={};a=i("260Jh").getBundleURL("ceDhw")+i("4G3qk").resolve("8HtV0");class l{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ViewCart is connected!")};// Right Container - Create Cart Title
...
createGoToCartButton=()=>{let e=document.createElement("div");e.classList="cart-goto-btn-wrapper";let o=document.createElement("button");o.classList="cart-goto-btn";let r=document.createElement("img");r.src=/*@__PURE__*/t(a),r.alt="Select";let n=document.createElement("span");return n.innerText=" Cart",// Append elemens to respective parents
...
console.log("Action: Getdata from database (Firebase) and keep in dataBase{}."),k.dbCollectionNames))w[e]=await this.modelFirebase.get(e);for(let e of(// Create Image Links Map:
...
this.viewProducts.renderProductItems(w.productItems),// Get values to Sesstion Variables: 1-2
// 1. Get cart items by sesstion user ID:
I=this.getCartItemsByUserID(C),console.log(`Cart items (sessionIdCart) for User ID ${C}: `,I),// 2. Get orders list by user ID:
