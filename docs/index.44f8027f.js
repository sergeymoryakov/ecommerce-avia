...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),c[e]=t),t}}),i("4G3qk").register(JSON.parse('{"ceDhw":"index.44f8027f.js","4M8Gf":"icon-add-order.d5dcde0a.png","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","baUMc":"admin.ed3ff856.js"}'));var o={};o=i("260Jh").getBundleURL("ceDhw")+i("4G3qk").resolve("4M8Gf");var d={};d=i("260Jh").getBundleURL("ceDhw")+i("4G3qk").resolve("kSZwU");class a{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
I.src=/*@__PURE__*/t(o),I.alt="Select";let w=document.createElement("span");w.innerText=" Add to Cart";let b=document.createElement("div");b.classList="product-card__bottom-wrapper";let k=document.createElement("h3");k.classList="product-card__description",k.textContent="Product Description";let y=document.createElement("p");return y.classList="product-card__description-text",y.textContent=e.itemDescription,// TO-DO STARTED
i.appendChild(d),l.appendChild(s),l.appendChild(m),l.appendChild(p),l.appendChild(u),l.appendChild(h),l.appendChild(C),l.appendChild(L),l.appendChild(g),l.appendChild(_),l.appendChild(E),l.appendChild(f),v.appendChild(I),v.appendChild(w),a.appendChild(l),a.appendChild(v),c.appendChild(i),c.appendChild(a),b.appendChild(k),b.appendChild(y),n.appendChild(r),n.appendChild(c),n.appendChild(b),console.log("productCardMain: ",n),n}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
...
let f={},v="",I={},w={},b=document.createElement("div");b.innerHTML="";let k=document.createElement("div");k.innerHTML="";let y=document.createElement("div");y.innerHTML="";// Init cross-ref Map: image - url
...
w=this.getOrdersByUserID(v),console.log(`Orders History (sessionIdOrders) for User ID ${v}: `,w),// Right Container - Render Cart Summary
...
renderCartAndOrdersSummary=(e,t)=>{let n=document.createElement("div");n.innerHTML="",k.appendChild(this.viewCart.createNewCartSummaryNoTotal(e)),y.appendChild(this.viewOrders.createOrdersHistorySummary(t)),// TEST-TBS - REMOVE IN PROD
console.log("cartSummaryNoTotal: ",k),console.log("ordersHistorySummary: ",y),n.appendChild(k),n.appendChild(y),this.clearContainerRight(),this.containerRightNode.appendChild(n)};renderProductCard=e=>{let t=this.viewProducts.createDetailedProductCard(e);this.clearContainerLeft(),this.containerLeftNode.appendChild(t)};handleButtonsClickLeft=e=>{let t=e.target;t.classList.contains("goto-products-btn")&&this.renderProductItemsList(f.productItems);// Add to cart button (from inside the detailed card)
