...
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),o[e]=t),t}}),a("4G3qk").register(JSON.parse('{"ceDhw":"index.75fd5edb.js","4M8Gf":"icon-add-order.d5dcde0a.png","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","kVJvh":"admin.4d7b58db.js"}'));var i={};i=a("260Jh").getBundleURL("ceDhw")+a("4G3qk").resolve("4M8Gf");var c={};c=a("260Jh").getBundleURL("ceDhw")+a("4G3qk").resolve("kSZwU");class d{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
let y={},E="",f={},b={},P=[],w=[],T={items:8e5,handling:8e3,total:808e3},k=document.createElement("div");k.innerHTML="";let D=document.createElement("div");D.innerHTML="";let v=document.createElement("div");v.innerHTML="";// Init cross-ref Map: image - url
