!function(){function e(e,t,r,n){Object.defineProperty(e,t,{get:r,set:n,enumerable:!0,configurable:!0})}function t(e){return e&&e.__esModule?e.default:e}var r="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},n={},a={},o=r.parcelRequire5d32;null==o&&((o=function(e){if(e in n)return n[e].exports;if(e in a){var t=a[e];delete a[e];var r={id:e,exports:{}};return n[e]=r,t.call(r.exports,r,r.exports),r.exports}var o=Error("Cannot find module '"+e+"'");throw o.code="MODULE_NOT_FOUND",o}).register=function(e,t){a[e]=t},r.parcelRequire5d32=o),o.register("4G3qk",function(t,r){e(t.exports,"register",function(){return n},function(e){return n=e}),e(t.exports,"resolve",function(){return a},function(e){return a=e});var n,a,o={};n=function(e){for(var t=Object.keys(e),r=0;r<t.length;r++)o[t[r]]=e[t[r]]},a=function(e){var t=o[e];if(null==t)throw Error("Could not resolve bundle with id "+e);return t}}),o.register("260Jh",function(t,r){e(t.exports,"getBundleURL",function(){return n},function(e){return n=e});var n,a={};n=function(e){var t=a[e];return t||(t=function(){try{throw Error()}catch(t){var e=(""+t.stack).match(/(https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/[^)\n]+/g);if(e)// Use the 3rd one, which will be a runtime in the original bundle.
return(""+e[2]).replace(/^((?:https?|file|ftp|(chrome|moz|safari-web)-extension):\/\/.+)\/[^/]+$/,"$1")+"/"}return"/"}(),a[e]=t),t}}),o("4G3qk").register(JSON.parse('{"ceDhw":"index.c03f2b24.js","4M8Gf":"icon-add-order.d5dcde0a.png","kSZwU":"icon-cart.dd455062.png","8HtV0":"icon-order.5ea58f4f.png","kVJvh":"admin.ae13eaf9.js"}'));var d={};d=o("260Jh").getBundleURL("ceDhw")+o("4G3qk").resolve("4M8Gf");var i={};i=o("260Jh").getBundleURL("ceDhw")+o("4G3qk").resolve("kSZwU");class c{constructor(e){this.controller=e}// FOR TEST AND TBS - REMOVE FOR PROD
...
o.appendChild(i),l.appendChild(s),l.appendChild(p),l.appendChild(m),l.appendChild(u),l.appendChild(h),l.appendChild(C),l.appendChild(g),l.appendChild(L),l.appendChild(E),l.appendChild(y),l.appendChild(I),P.appendChild(f),P.appendChild(b),c.appendChild(l),c.appendChild(P),a.appendChild(o),a.appendChild(c),_.appendChild(T),_.appendChild(w),r.appendChild(n),r.appendChild(a),r.appendChild(_),r}}// import iconAddOrder from "../../other_assets/icon-add-order.png";
// import iconCart from "../../other_assets/icon-cart.png";
// import iconCc from "../../other_assets/icon-cc.png";
var l={};l=o("260Jh").getBundleURL("ceDhw")+o("4G3qk").resolve("8HtV0");class s{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ViewCart is connected!")};// Right Container - Create Cart Title
...
createUpdateButtonBlock=()=>{let e=document.createElement("div");e.classList="update-btn-wrapper";let t=document.createElement("button");return t.classList="update-btn",t.innerText="Update",e.appendChild(t),e};createPopupUpdateAddress=()=>{// Create the main wrapper div
...
let r=document.createElement("button");return r.classList.add("update-btn"),r.setAttribute("id","updatePaymentMethodBtn"),r.innerText="Update",t.appendChild(r),t}}class m{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewAdmin is connected!")};createPopupMessage=e=>{// Create main wrapper div
let t=document.createElement("div");t.classList.add("popup-welcome-wrapper"),// const messageArray = [
//     "This is TEST",
...
let r=document.createElement("button");return r.classList.add("update-btn"),r.setAttribute("id","agreeBtn"),r.innerText="I Agree",t.appendChild(r),t}}class u{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ViewSuperadmin is connected!")}}var h=o("9zRuU");class C{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelProducts is connected!")}}class g{constructor(e){this.controller=e}checkModuleLinkage=()=>{console.log("HELLO, ModelCart is connected!")}}class L{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelOrders is connected!")}}class E{constructor(){}checkModuleLinkage=()=>{console.log("HELLO, ModelUser is connected!")};getSessionIdCustomerByCustomerId=(e,t)=>{let r=t.filter(t=>t.custId===e);return r[0]}}var y=o("ljOiA");// Init database instance (dataBase):
let I={},P="",f={},b={},_=[],T=[],w={},v={},O=document.createElement("div");O.innerHTML="";let k=document.createElement("div");k.innerHTML="";let B=document.createElement("div");B.innerHTML="";// Init cross-ref Map: image - url
let D=new Map,A=new class{constructor(){this.viewProducts=new c(this),this.viewCart=new s(this),this.viewOrders=new p(this),this.viewAdmin=new m,this.viewSuperadmin=new u,this.modelFirebase=new h.ModelFirebase,this.modelProducts=new C,this.modelCart=new g(this),this.modelOrders=new L,this.modelUser=new E,this.bodyNode=document.querySelector("body"),this.containerLeftNode=document.getElementById("containerLeft"),this.containerRightNode=document.getElementById("containerRight"),this.containerPupupNode=document.getElementById("containerPupup"),this.popupContentNode=document.getElementById("popupContent")}initializeAppMain=async()=>{for(let e of(// TEST AND TBS - REMOVE IN PRODUCTION
console.log("HELLO! INIT CARRIED OUT SUCCESFULLY"),this.viewProducts.checkModuleLinkage(),this.viewCart.checkModuleLinkage(),this.viewOrders.checkModuleLinkage(),this.viewAdmin.checkModuleLinkage(),this.viewSuperadmin.checkModuleLinkage(),this.modelFirebase.checkModuleLinkage(),this.modelProducts.checkModuleLinkage(),this.modelCart.checkModuleLinkage(),this.modelOrders.checkModuleLinkage(),this.modelUser.checkModuleLinkage(),// RUN DISCLAIMER FIRST
this.activatePopupWelcomeDisclaimer(),// Get data from database (Firebase) and keep in local dataBase{}
...
f=I.usersData[0]),console.log("[*** sessionIdCustomer ***] initiated: ",// Assign to sessionIdCustomer an object/document associated with sesstionIdUser (by userId)
...
T=this.getCartItemsByUserID(P),console.log(`[*** sessionIdCartItems ***] for User ID ${P}: `,T),// 2. Set "sessionIdOrders" by sesstion's userId (sessionIdNumber):
_=this.getOrdersByUserID(P),console.log(`[*** sessionIdOrders ***] for User ID ${P}: `,_),// 3. Set "sessionIdCartDetails":
v=this.getSessionIdCartDetails(),console.log(`[*** sessionIdCartDetails ***] for User ID ${P}: `,v),// ALERT - POPOUP DISCLAIMER
...
this.renderCartAndOrdersSummary(T,_),this.attachEventListenrs();// TEST-TBS ONLY:
...
getSessionIdCustomerData=()=>b=this.modelUser.getSessionIdCustomerByCustomerId(f.custId,I.customersData);// Set "sessionIdCartDetails":
getSessionIdCartDetails=()=>{let e={userId:f.userId,userName:f.userName,userEmail:f.userEmail,userPhone:f.userPhone,custId:b.custId,custLegalName:b.custLegalName,custBillToAddress:b.custBillToAddress,custHandlingFee:b.custHandlingFee,paymentMethod:b.paymentMethod};return e};// Reset Session Cart Items (when order placed)
resetSessionIdCartItems=()=>{T=[]};// Revert back from map an image URL by image name
...
this.updateCartPriceVariable(T,w,I.productItems,b.custHandlingFee)};// MIGHT BE A PART OF MODEL:
...
e.appendChild(this.viewOrders.createPaymentMethodContentBlock(v,!0,y.paymentMethods));let t=this.viewOrders.createCheckOutCartWrapper(),r=document.createElement("div");for(let e of(r.classList="checkout-cart-items",T)){let t=this.getProductObjectById(e.itemId);// Third argument ("checkout-cart-item") is a classList to pass to 'div' element
...
this.renderCartAndOrdersSummary(T,_)};// "Add to Cart" button at detailed product card (page)
...
let t=this.getProdIdFromElementId(e.id),r=this.getDocIdFromArrayByItemId(T,t);r?this.handleQtyChangeBtn(e,1):this.addProduct(t,P),this.renderCartAndOrdersSummary(T,_)};// "Go to Cart" button at right panel or checkout panel
handleGotoCartBtn=()=>{// TEST-TBS REMOVE IN PROD
console.log("Received command to display CART."),this.updateCartPriceVariable(T,w,I.productItems,b.custHandlingFee),this.renderCartSummary(T),this.renderCartSummaryWithPrice(T,w)};// Handle Order Placement
...
for(let e in T){console.log("[*** sessionIdCartItems[cartItem].docId ***] to delete from cartsData: ",T[e].docId);try{this.handleDeleteDocFromFirestore("cartsData",T[e].docId)}catch(e){console.error("Error deleting sessionIdCartItems from Firestore: ",e)}}// 3.B. Reset sessionIdCartItems
...
let a=T.filter(e=>e.itemId!==r);n.qty+t>0?(this.updateProduct(a,n,t),this.updateCartDOM(r,n)):(this.deleteProduct(a,n),this.handleGotoCartBtn())};// Update payment method if new one is selected by User
...
console.log("Got comand to ACTIVATE WELCOME DISCLAIMER"),this.popupContentNode.innerHTML="";let e=this.viewAdmin.createPopupMessage(y.welcomeDisclaimer);this.popupContentNode.appendChild(e),// this.popupContentNode.innerHTML =
//     this.viewOrders.createPopupUpdateAddress();
this.togglePopup()};activatePopupMessage=e=>{// Clear Popup Content
console.log("Got comand to ACTIVATE CUSTOM MESSAGE"),this.popupContentNode.innerHTML="";let t=this.viewAdmin.createPopupMessage(e);this.popupContentNode.appendChild(t),// this.popupContentNode.innerHTML =
//     this.viewOrders.createPopupUpdateAddress();
this.togglePopup()};activatePopupUpdateAddress=()=>{// Clear Popup Content
console.log("Got comand to ACTIVATE POPUP"),this.popupContentNode.innerHTML="";let e=this.viewOrders.createPopupUpdateAddress();this.popupContentNode.appendChild(e),// this.popupContentNode.innerHTML =
//     this.viewOrders.createPopupUpdateAddress();
this.togglePopup()};activatePopupUpdatePaymentMethod=()=>{// Clear Popup Content
console.log("Got comand to ACTIVATE POPUP"),this.popupContentNode.innerHTML="",this.popupContentNode.appendChild(this.viewOrders.createPopupUpdatePaymentMethod(y.paymentMethods)),this.togglePopup()};togglePopup=()=>{this.bodyNode.classList.toggle("body-fixed"),this.containerPupupNode.classList.toggle("popup-container-open")};// Function to handle radio button selection in POPUP SECTION
