let e,t;var n,r,i,s,a,o,l,h,u,c,d="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{},f={},p={},g=d.parcelRequire5d32;null==g&&((g=function(e){if(e in f)return f[e].exports;if(e in p){var t=p[e];delete p[e];var n={id:e,exports:{}};return f[e]=n,t.call(n.exports,n,n.exports),n.exports}var r=Error("Cannot find module '"+e+"'");throw r.code="MODULE_NOT_FOUND",r}).register=function(e,t){p[e]=t},d.parcelRequire5d32=g),new URL(g("d5gZm").resolve("3XKo6"),import.meta.url).toString();var m={};m=new URL(g("d5gZm").resolve("jyKjU"),import.meta.url).toString(),new URL(g("d5gZm").resolve("bssM1"),import.meta.url).toString(),new URL(g("d5gZm").resolve("5WNTT"),import.meta.url).toString();class y{constructor(e){this.controller=e,this.containerLeftNode=document.getElementById("containerLeft"),this.containerRightNode=document.getElementById("containerRight")}// FOR TEST AND TBS - REMOVE FOR PROD
 ...
 */const U=function(e){let t=x(e);return P.encodeByteArray(t,!0)},V=function(e){// Use base64url encoding and remove padding in the end (dot characters).
...
setLogLevel(e){this._logLevel="string"==typeof e?eo[e]:e}get logHandler(){return this._logHandler}set logHandler(e){if("function"!=typeof e)throw TypeError("Value assigned to `logHandler` must be a function");this._logHandler=e}get userLogHandler(){return this._userLogHandler}set userLogHandler(e){this._userLogHandler=e}/**
     ...
     */debug(...e){this._userLogHandler&&this._userLogHandler(this,e2.DEBUG,...e),this._logHandler(this,e2.DEBUG,...e)}log(...e){this._userLogHandler&&this._userLogHandler(this,e2.VERBOSE,...e),this._logHandler(this,e2.VERBOSE,...e)}info(...e){this._userLogHandler&&this._userLogHandler(this,e2.INFO,...e),this._logHandler(this,e2.INFO,...e)}warn(...e){this._userLogHandler&&this._userLogHandler(this,e2.WARN,...e),this._logHandler(this,e2.WARN,...e)}error(...e){this._userLogHandler&&this._userLogHandler(this,e2.ERROR,...e),this._logHandler(this,e2.ERROR,...e)}}const ed=(e,t)=>t.some(t=>e instanceof t),ef=new WeakMap,ep=new WeakMap,eg=new WeakMap,em=new WeakMap,ey=new WeakMap;let ev={get(e,t,n){if(e instanceof IDBTransaction){// Special handling for transaction.done.
 ...
 *
 * @internal
 */function ex(e,t){let n=e.container.getProvider("heartbeat").getImmediate({optional:!0});return n&&n.triggerHeartbeat(),e.container.getProvider(t)}const eM=new Y("app","Firebase",{"no-app":"No Firebase App '{$appName}' has been created - call initializeApp() first","bad-app-name":"Illegal App name: '{$appName}","duplicate-app":"Firebase App named '{$appName}' already exists with different options or config","app-deleted":"Firebase App named '{$appName}' already deleted","no-options":"Need to provide options, when not being deployed to hosting via source.","invalid-app-argument":"firebase.{$appName}() takes either no argument or a Firebase App instance.","invalid-log-argument":"First argument to `onLog` must be null or a function.","idb-open":"Error thrown when opening IndexedDB. Original error: {$originalErrorMessage}.","idb-get":"Error thrown when reading from IndexedDB. Original error: {$originalErrorMessage}.","idb-set":"Error thrown when writing to IndexedDB. Original error: {$originalErrorMessage}.","idb-delete":"Error thrown when deleting from IndexedDB. Original error: {$originalErrorMessage}."});/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iS=new ec("@firebase/firestore");// Helper methods are needed because variables can't be exported as read/write
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const iO={// Causes are copied from:
...
t.push(...n.split("/").filter(e=>e.length>0))}return new iX(t)}static emptyPath(){return new iX([])}}const iY=/^[_a-zA-Z][_a-zA-Z0-9]*$/;/**
 ...
 */function(e){let t="";for(let n=0;n<e.length;++n)t+=String.fromCharCode(e[n]);return t}(e);return new so(t)}[Symbol.iterator](){let e=0;return{next:()=>e<this.binaryString.length?{value:this.binaryString.charCodeAt(e++),done:!1}:{value:void 0,done:!0}}}toBase64(){return btoa(this.binaryString)}toUint8Array(){return function(e){let t=new Uint8Array(e.length);for(let n=0;n<e.length;n++)t[n]=e.charCodeAt(n);return t}(this.binaryString)}approximateByteSize(){return 2*this.binaryString.length}compareTo(e){return iK(this.binaryString,e.binaryString)}isEqual(e){return this.binaryString===e.binaryString}}so.EMPTY_BYTE_STRING=new so("");const sl=new RegExp(/^\d{4}-\d\d-\d\dT\d\d:\d\d:\d\d(?:\.(\d+))?Z$/);/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const a$=new ib([4294967295,4294967295],0);// Hash a string using md5 hashing algorithm.
...
r.Be(t),this.Ue=this.Ue.insert(t,this.ct(t).delete(e)),n&&(this.$e=this.$e.insert(t,n))}removeTarget(e){this.Ke.delete(e)}/**
     ...
     * specified target.
     */ut(e,t){return this.Qe.getRemoteKeysForTarget(e).has(t)}}function a0(){return new se(iZ.comparator)}function a1(){return new se(iZ.comparator)}const a2={asc:"ASCENDING",desc:"DESCENDING"},a9={"<":"LESS_THAN","<=":"LESS_THAN_OR_EQUAL",">":"GREATER_THAN",">=":"GREATER_THAN_OR_EQUAL","==":"EQUAL","!=":"NOT_EQUAL","array-contains":"ARRAY_CONTAINS",in:"IN","not-in":"NOT_IN","array-contains-any":"ARRAY_CONTAINS_ANY"},a4={and:"AND",or:"OR"};/**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const oQ="WebChannelConnection";class oW extends /**
 ...
 */const hX="firebasestorage.googleapis.com",hY="storageBucket";/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
...
s.getPromise().then(()=>this._requests.delete(s),()=>this._requests.delete(s)),s}}async makeRequestWithTokens(e,t){let[n,r]=await Promise.all([this._getAuthToken(),this._getAppCheckToken()]);return this._makeRequest(e,t,n,r).getPromise()}}const up="@firebase/storage",ug="0.11.2",um="storage";function uy(e,t){return function(e,t){if(!(t&&/^[A-Za-z]+:\/\//.test(t)))return(/**
...
console.log("Action: Create Image Links Map imageLinksMap{}:"),uA.productItems)){let t=await this.modelFirebase.getLinkToImage(e.itemImg).then(e=>e).catch(e=>{console.log("Error getting download URL: ",e)});// FOR TEST AND TBS - REMOVE IN PROD:
// console.log("imageURL: ", imageURL);
uk.set(e.itemImg,t)}// FOR TEST AND TBS - REMOVE IN PROD:
...
// TEST & TBS ITEMS
};askForImageUrlFromStorage=async e=>{let t=await this.modelFirebase.getLinkToImage(e).then(e=>e).catch(e=>{console.log("Error getting download URL: ",e)});console.log("imageURL: ",t)};getUrlByNameLocal=e=>uk.get(e)};try{uD.initializeAppMain()}catch(e){console.error("An error occured duting app initialization:",e),alert("Something went wrong. Please contact the app admin or try again later.")}//# sourceMappingURL=index.b33825a0.js.map

//# sourceMappingURL=index.b33825a0.js.map
